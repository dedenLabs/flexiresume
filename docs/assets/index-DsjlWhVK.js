...
`,be=d.div`
  ...
  cursor: pointer;
  z-index: 1100;  
`,xe=({imageUrl:r,onClose:t})=>e.jsxs(ge,{onClick:t,children:[e.jsx(fe,{src:r,onClick:e=>e.stopPropagation()}),e.jsx(be,{onClick:t,children:e.jsx(ue,{size:30,color:"white"})})]}),ke=o.createContext(void 0),we=({children:t})=>{const[a,i]=o.useState(!1),[s,n]=o.useState(""),c=e=>{n(e),i(!0)};return window.$handleImageClick=c,e.jsxs(ke.Provider,{value:{handleImageClick:c},children:[t,a&&e.jsx(r.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:e.jsx(xe,{imageUrl:s,onClose:()=>{i(!1)}})})]})},ve=d.div`
  max-width: 800px;
  padding: 40px 20px;
  background: #fff;
  border-radius: 8px;
