const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Data-MnwPlZla.js","./mermaid-core-CxzdCigi.js","./react-vendor-DQmNySUk.js","./d3-charts-C9eKmPJg.js","./Data-Dqkay2RE.js","./utils-CEXnc-BX.js","./cytoscape-3nCDfVzk.js","./FlexiResume-C6rQmAF0.js","./framer-motion-CXdLbqfN.js","./vendor-B9-6CCQX.js","./react-icons-mdDy3BM0.js","./react-markdown-BR0DeiX9.js"])))=>i.map(i=>d[i]);
import{j as e,m as r}from"./framer-motion-CXdLbqfN.js";import{b as t,r as o,R as i}from"./react-vendor-DQmNySUk.js";import{_ as a,aD as s}from"./mermaid-core-CxzdCigi.js";import{m as n,r as c,f as l,d,u as p,N as h,a as m,B as u,R as g,b as f,c as b}from"./vendor-B9-6CCQX.js";import{G as x}from"./react-icons-mdDy3BM0.js";import"./d3-charts-C9eKmPJg.js";var w;!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&r(e)}).observe(document,{childList:!0,subtree:!0})}function r(e){if(e.ep)return;e.ep=!0;const r=function(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?r.credentials="include":"anonymous"===e.crossOrigin?r.credentials="omit":r.credentials="same-origin",r}(e);fetch(e.href,r)}}();var k=t;w=k.createRoot,k.hydrateRoot;const v=new class{data={};tabs=[];skillMap=[];skills=[];collapsedMap=new Map;constructor(){n(this);const e=this.collapsedMap.set;this.collapsedMap.set=function(r,t){V("Store",t,r),e.call(this,r,t)}}},y="zh";let D=y;const C=new Map,j=[],P=()=>D,$=e=>{D!==e&&(D=e,j.forEach(r=>r(e)))},S=async e=>{if(C.has(e))return C.get(e);try{let r;if("zh"===e)r=await a(()=>import("./Data-MnwPlZla.js"),__vite__mapDeps([0,1,2,3]),import.meta.url);else{if("en"!==e)throw new Error(`Unsupported language: ${e}`);r=await a(()=>import("./Data-Dqkay2RE.js"),__vite__mapDeps([4,1,2,3]),import.meta.url)}const t=r.default;return C.set(e,t),t}catch(r){if(e!==y)return S(y);throw r}},L=async()=>S(D),T=()=>{const e=navigator.language.toLowerCase();return e.startsWith("zh")?"zh":e.startsWith("en")?"en":y};(()=>{try{const e=localStorage.getItem("flexiresume-language");D=!e||"zh"!==e&&"en"!==e?T():e}catch(e){D=T()}})();var z={};const E={cdn:{enabled:!0,baseUrls:["https://cdn.jsdelivr.net/gh/dedenLabs/flexiresume-static/","https://flexi-77796.web.app/","https://dedenlabs.github.io/flexiresume-static/"],healthCheck:{timeout:5e3,testPath:"favicon.ico",enabled:!0},sortingStrategy:{mode:"speed",enabled:!0,speedWeight:.7,availabilityWeight:.3}},api:{baseUrl:"undefined"!=typeof process&&z?.REACT_APP_API_BASE_URL||"",timeout:1e4,version:"v1"},theme:{defaultTheme:"auto",enableTransitions:!0,transitionDuration:300},performance:{enableLazyLoading:!0,lazyLoadingThreshold:100,enablePreloading:!0,preloadResources:["/images/avatar.webp","/images/background.webp"],preloadLibraries:{mermaid:!0,svgPanZoom:!0,katex:!1,cytoscape:!1}},app:{name:"FlexiResume",version:"undefined"!=typeof process&&z?.REACT_APP_VERSION||"1.0.0",buildTime:"undefined"!=typeof process&&z?.REACT_APP_BUILD_TIME||(new Date).toISOString(),isDevelopment:!1},debug:{enabled:!1,showPerformanceMonitor:!1,verboseLogging:!1}},_=()=>E.cdn,M=()=>E.debug.enabled;class I{static instance;healthResults=new Map;isChecking=!1;checkPromise=null;constructor(){}static getInstance(){return I.instance||(I.instance=new I),I.instance}async checkSingleCDN(e,r,t){const o=Date.now(),i=o;try{const s=e.endsWith("/")?`${e}${r}`:`${e}/${r}`;M();const n=new AbortController,c=setTimeout(()=>n.abort(),t);try{const r=await fetch(s,{method:"HEAD",signal:n.signal,cache:"no-cache",mode:"cors"});clearTimeout(c);const t=Date.now()-o,a={url:e,available:r.ok,responseTime:t,timestamp:i};return r.ok||(a.error=`HTTP ${r.status}: ${r.statusText}`),M(),a}catch(a){throw clearTimeout(c),a}}catch(s){return{url:e,available:!1,responseTime:Date.now()-o,error:s instanceof Error?s.message:"Unknown error",timestamp:i}}}async checkAllCDNs(e={}){if(this.isChecking&&this.checkPromise)return this.checkPromise;this.isChecking=!0;const r=_(),{timeout:t=r.healthCheck.timeout,testPath:o=r.healthCheck.testPath,concurrent:i=!0,maxConcurrency:a=3}=e;this.checkPromise=this.performHealthCheck(r.baseUrls,o,t,i,a);try{const e=await this.checkPromise;return e.forEach(e=>{this.healthResults.set(e.url,e)}),this.reorderCDNUrls(e),M(),e}finally{this.isChecking=!1,this.checkPromise=null}}async performHealthCheck(e,r,t,o,i){if(o){const o=[];for(let a=0;a<e.length;a+=i){const s=e.slice(a,a+i).map(e=>this.checkSingleCDN(e,r,t)),n=await Promise.all(s);o.push(...n)}return o}{const o=[];for(const i of e){const e=await this.checkSingleCDN(i,r,t);o.push(e)}return o}}reorderCDNUrls(e){const r=_().sortingStrategy;if(!r.enabled)return;let t;if("availability"===r.mode){const r=e.filter(e=>e.available).sort((e,r)=>e.responseTime-r.responseTime),o=e.filter(e=>!e.available);t=[...r.map(e=>e.url),...o.map(e=>e.url)]}else{if("speed"!==r.mode)return;{const o=e.filter(e=>e.available).sort((e,t)=>{const o=1/e.responseTime*r.speedWeight+(e.available?1:0)*r.availabilityWeight;return 1/t.responseTime*r.speedWeight+(t.available?1:0)*r.availabilityWeight-o}),i=e.filter(e=>!e.available);t=[...o.map(e=>e.url),...i.map(e=>e.url)]}}var o;o={baseUrls:t},Object.assign(E.cdn,o)}getHealthResults(){return Array.from(this.healthResults.values())}getAvailableCDNs(){return Array.from(this.healthResults.values()).filter(e=>e.available).sort((e,r)=>e.responseTime-r.responseTime).map(e=>e.url)}isCDNAvailable(e){const r=this.healthResults.get(e);return!!r&&r.available}clearCache(){this.healthResults.clear()}getBestCDN(){const e=this.getAvailableCDNs();return e.length>0?e[0]:null}getAllResults(){return Array.from(this.healthResults.values())}}const R=I.getInstance();class A{static instance;urlCache=new Map;isInitialized=!1;initPromise=null;constructor(){}static getInstance(){return A.instance||(A.instance=new A),A.instance}async initialize(){if(!this.isInitialized){if(this.initPromise)return this.initPromise;this.initPromise=this.performInitialization(),await this.initPromise}}async performInitialization(){const e=_();if(e.enabled)if(e.healthCheck.enabled)try{M(),await R.checkAllCDNs(),M()}catch(r){}finally{this.isInitialized=!0,this.initPromise=null}else this.isInitialized=!0;else this.isInitialized=!0}getResourceUrl(e,r={}){const{enableFallback:t=!0,localBasePath:o="",cacheUrls:i=!0}=r;if(i&&this.urlCache.has(e))return this.urlCache.get(e);const a=_();if(!a.enabled){const r=this.buildLocalUrl(e,o);return i&&this.urlCache.set(e,r),r}const s=R.getBestCDN();if(s){const r=this.buildCDNUrl(s,e);return i&&this.urlCache.set(e,r),r}if(R.getAllResults().length===a.baseUrls.length){if(t){const r=this.buildLocalUrl(e,o);return i&&this.urlCache.set(e,r),r}}else if(a.baseUrls.length>0){const r=a.baseUrls[0];return this.buildCDNUrl(r,e)}if(t){const r=this.buildLocalUrl(e,o);return i&&this.urlCache.set(e,r),r}throw new Error(`[CDN Manager] No CDN available and fallback is disabled for resource: ${e}`)}buildCDNUrl(e,r){return`${e.endsWith("/")?e.slice(0,-1):e}/${r.startsWith("/")?r.slice(1):r}`}buildLocalUrl(e,r){if(r)return`${r.endsWith("/")?r.slice(0,-1):r}/${e.startsWith("/")?e.slice(1):e}`;let t="";if("undefined"!=typeof window)try{const e=window.location.pathname.split("/").filter(e=>e);if(e.length>0&&(!window.location.port||"5173"!==window.location.port&&"5174"!==window.location.port&&"3000"!==window.location.port)&&e.length>=1){const r=e.slice(0,-1);r.length>0&&(t="/"+r.join("/")+"/")}}catch(i){}const o=t+(e.startsWith("/")?e.slice(1):e);if("undefined"!=typeof window){const{protocol:e,hostname:r,port:t}=window.location;return`${e}//${r}${t&&"80"!==t&&"443"!==t?`:${t}`:""}${o}`}return o}async preloadResources(e,r={}){const t=e.map(async e=>{try{const t=this.getResourceUrl(e,r),o=document.createElement("link");o.rel="preload",o.href=t;const i=e.split(".").pop()?.toLowerCase();switch(i){case"jpg":case"jpeg":case"png":case"webp":case"svg":o.as="image";break;case"css":o.as="style";break;case"js":o.as="script";break;case"woff":case"woff2":o.as="font",o.crossOrigin="anonymous";break;default:o.as="fetch",o.crossOrigin="anonymous"}document.head.appendChild(o),M()}catch(t){}});await Promise.allSettled(t)}getCDNHealthStatus(){return R.getHealthResults()}async refreshCDNHealth(){return R.clearCache(),this.clearUrlCache(),await R.checkAllCDNs()}clearUrlCache(){this.urlCache.clear()}isReady(){return this.isInitialized}getCacheStats(){return{size:this.urlCache.size,keys:Array.from(this.urlCache.keys())}}}const F=A.getInstance();let N=null,O=!1,U=null;function W(e){return s("app:"+e)}(async()=>{O||N||(O=!0,U=(async()=>{try{N=await L()}catch(e){}finally{O=!1}})())})();const V=s("app:折叠");function B(e,...r){return r.forEach(r=>{Object.keys(r).forEach(t=>{const o=e[t],i=r[t];Array.isArray(o)&&Array.isArray(i)?e[t]=Array.from(new Set([...o,...i])):e[t]="object"==typeof o&&"object"==typeof i?B({...o},i):i})}),e}async function H(e){v.collapsedMap.clear();const r=await L(),[t,o]=await Promise.all([r.loadPositionData(e),r.loadSkillsData()]),i=B({},t,r.expected_positions[e]),a=B({},r,i,{skill_level:o});v.data=a;const s=(a?.skill_level?.list||[]).sort((e,r)=>e.length-r.length);v.skills=s;const n={};s.forEach(([e,r])=>{n[e.toLocaleLowerCase()]=[e,r]}),v.skillMap=n}function Y(e){const[r,t]=o.useState(Math.min(e,document.body.getBoundingClientRect().width));return o.useEffect(()=>{const r=()=>{t(Math.min(e,document.body.getBoundingClientRect().width))};return window.addEventListener("resize",r),()=>{window.removeEventListener("resize",r)}},[]),r}function q(e,r){return e.replace(/\$\{([\w.]+)\}/g,(e,t)=>{const o=t.split(".");let i=r;for(const r of o)if(i=i?i[r]:void 0,void 0===i)return e;return i})}function Z(e,r){const t=new Date,o=t.getFullYear(),i=t.getMonth()+1;function a(e){if(!/^\d+/.test(e))return[o,i];const r=[".","/","-"];let t,a;for(const o of r)if(e.includes(o)){[t,a]=e.split(o).map(Number);break}return t&&a||([t,a]=e.match(/\d+/g).map(Number)),[t,a]}const[s,n]=a(e),[c,l]=a(r);let d=c-s,p=l-n;p<0&&(d-=1,p+=12);let h="";return d>0&&(h+=`${d}年`),p>0&&(h+=`${p}个月`),h||"0个月"}function J(e,r){const[t,i]=o.useState({}),a=e=>{const t={};for(let o=0;o<r;o++)t[o]=e;setTimeout(()=>i(t),0)};return function(e,r){o.useEffect(()=>{v.collapsedMap.has(e)||v.collapsedMap.set(e,!1);const t=c(()=>v.collapsedMap.get(e),e=>{r(e)});return()=>{t()}},[e])}(e,a),{collapsedItems:t,toggleCollapse:(e,r)=>{i({...t,[e]:r??!t[e]})},setCollapsedAllItems:a}}function G(e,r=0){const t=(N||{header_info:{cdn_static_assets_dirs:["images"]}}).header_info.cdn_static_assets_dirs||["images"];if(!e)return e;const o=t.map(e=>`^\\/?${e}\\/`).join("|");if(!new RegExp(o).test(e))return e;try{return F.getResourceUrl(e,{enableFallback:!0,localBasePath:"",cacheUrls:!0})}catch(i){return e}}window.stopOtherVideos=function(e){document.querySelectorAll(".remark-video").forEach(r=>{r!==e.target&&r.pause()})};const X="920px",K=l`
  /* CSS变量定义 - 浅色主题 */
  :root {
...
`,me=()=>{const r=v.data,t=v.tabs,{isDark:i}=ce(),a=p();return o.useEffect(()=>{if(!t.length)return void(document.title=r?.header_info?.position||"My Resume");const e=function(e){const r=v.data,t=v.tabs,o=e.pathname,i=t.find(([,e])=>e===o);return i?i[0]:r?.header_info?.position||""}(a),o=Object.assign({},r?.header_info,{position:e}),i=function(e,r){if(!r)return r?.position||"My Resume";const t=e.replace(/{(position|name|age|location)}/g,(e,t)=>r[t]||""),o=t.replace(/[-\s]+/g," ").trim();return o&&"-"!==o&&"--"!==o&&"---"!==o?t:r?.position||r?.name||"My Resume"}(r?.header_info?.resume_name_format||"{position}-{name}-{age}-{location}",o),s=i&&i.trim()?i:e||r?.header_info?.position||"My Resume";document.title=s},[a,r,t.length]),t.length?e.jsx(pe,{"data-testid":"navigation-tabs",isDark:i,children:t.map(([r,t],o)=>e.jsx(he,{className:"no-link-icon",to:t,isDark:i,children:r},t))}):null};function ue(e){return x({attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0z"},child:[]},{tag:"path",attr:{d:"M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"},child:[]}]})(e)}const ge=d.div`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
...
`,be=d.div`
  ...
  cursor: pointer;
  z-index: 1100;  
`,xe=({imageUrl:r,onClose:t})=>e.jsxs(ge,{onClick:t,children:[e.jsx(fe,{src:r,onClick:e=>e.stopPropagation()}),e.jsx(be,{onClick:t,children:e.jsx(ue,{size:30,color:"white"})})]}),we=o.createContext(void 0),ke=({children:t})=>{const[i,a]=o.useState(!1),[s,n]=o.useState(""),c=e=>{n(e),a(!0)};return window.$handleImageClick=c,e.jsxs(we.Provider,{value:{handleImageClick:c},children:[t,i&&e.jsx(r.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:e.jsx(xe,{imageUrl:s,onClose:()=>{a(!1)}})})]})},ve=d.div`
  max-width: 800px;
  padding: 40px 20px;
  background: #fff;
  border-radius: 8px;
...
`,er=d.div.withConfig({shouldForwardProp:e=>"isActive"!==e})`
  ...
  ${e=>e.isActive&&"\n    width: 100px;\n    height: 100px;\n  "}
`,rr=({className:r,showTooltip:t=!0})=>{const{mode:o,toggleMode:a,isDark:s}=ce(),{t:n}=Fe(),[c,l]=i.useState(!1),[d,p]=i.useState(!1),h=s?n.common.lightMode:n.common.darkMode;return e.jsxs(Ze,{className:r,onMouseEnter:()=>l(!0),onMouseLeave:()=>l(!1),children:[e.jsxs(Je,{isDark:s,onClick:()=>{p(!0),setTimeout(()=>p(!1),600),a()},title:h,"aria-label":h,children:[e.jsx(er,{isActive:d}),e.jsx(Ge,{isVisible:!s,children:e.jsx(Xe,{})}),e.jsx(Ge,{isVisible:s,children:e.jsx(Ke,{})})]}),t&&e.jsx(Qe,{isDark:s,isVisible:c,children:h})]})},tr=d.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  position: fixed;
  bottom: 20px;
  right: 20px;
  display: flex;
...
`;const ir=d.div.withConfig({shouldForwardProp:e=>"isCollapsed"!==e&&"isDark"!==e})`
  position: fixed;
  bottom: 20px;
  right: 20px;
  z-index: 1000;
...
`,ar=d.button.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 48px;
...
`,cr=d.span.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  ...
  font-weight: 500;
  color: ${e=>e.isDark?"#e2e8f0":"#2c3e50"};
`,lr=({className:r,collapsible:t=!1,defaultCollapsed:o=!1})=>{const{isDark:a}=ce(),{t:s}=Fe(),[n,c]=i.useState(o);return t?e.jsxs(ir,{isCollapsed:n,isDark:a,className:r,children:[e.jsx(ar,{isDark:a,onClick:()=>c(!n),title:s.common.controlPanel,"aria-label":s.common.controlPanel,children:n?"⚙️":"✕"}),!n&&e.jsxs(sr,{isDark:a,children:[e.jsxs(nr,{children:[e.jsx(cr,{isDark:a,children:s.common.theme}),e.jsx(rr,{showTooltip:!1})]}),e.jsx(or,{isDark:a}),e.jsxs(nr,{children:[e.jsx(cr,{isDark:a,children:s.common.language}),e.jsx(qe,{})]})]})]}):e.jsxs(tr,{isDark:a,className:r,children:[e.jsx(rr,{}),e.jsx(or,{isDark:a}),e.jsx(qe,{})]})},dr=new class{libraries=new Map;preloadPromises=new Map;constructor(){this.initializeLibraryStates()}initializeLibraryStates(){["mermaid","svgPanZoom","katex","cytoscape"].forEach(e=>{this.libraries.set(e,{loading:!1,loaded:!1,error:null,module:null})})}async startPreloading(){const e=[];e.push(this.preloadMermaid()),e.push(this.preloadSvgPanZoom()),Promise.allSettled(e).then(e=>{})}async preloadMermaid(){return this.preloadLibrary("mermaid",()=>a(()=>import("./mermaid-core-CxzdCigi.js").then(e=>e.b7),__vite__mapDeps([1,2,3]),import.meta.url))}async preloadSvgPanZoom(){return this.preloadLibrary("svgPanZoom",()=>a(()=>import("./utils-CEXnc-BX.js").then(e=>e.s),__vite__mapDeps([5,2]),import.meta.url))}async preloadKatex(){return this.preloadLibrary("katex",()=>a(()=>import("./katex-DuUXD-vJ.js"),[],import.meta.url))}async preloadCytoscape(){return this.preloadLibrary("cytoscape",()=>a(()=>import("./cytoscape-3nCDfVzk.js").then(e=>e.b),__vite__mapDeps([6,2]),import.meta.url))}async preloadLibrary(e,r){const t=this.libraries.get(e);if(!t||t.loaded||t.loading)return;if(this.preloadPromises.has(e))return this.preloadPromises.get(e);t.loading=!0,t.error=null,performance.now();const o=r().then(e=>(performance.now(),t.loaded=!0,t.loading=!1,t.module=e,e)).catch(e=>{throw t.loading=!1,t.error=e.message,e}).finally(()=>{this.preloadPromises.delete(e)});return this.preloadPromises.set(e,o),o}async getLibrary(e){const r=this.libraries.get(e);if(!r)throw new Error(`Unknown library: ${e}`);if(r.loaded&&r.module)return r.module;if(r.loading&&this.preloadPromises.has(e))return this.preloadPromises.get(e);switch(e){case"mermaid":return this.preloadMermaid();case"svgPanZoom":return this.preloadSvgPanZoom();case"katex":return this.preloadKatex();case"cytoscape":return this.preloadCytoscape();default:throw new Error(`Unknown library: ${e}`)}}getLibraryState(e){return this.libraries.get(e)||null}getAllLibraryStates(){return new Map(this.libraries)}cleanup(){this.libraries.clear(),this.preloadPromises.clear()}},pr=o.lazy(()=>a(()=>import("./FlexiResume-C6rQmAF0.js"),__vite__mapDeps([7,8,2,9,1,3,10,5,11]),import.meta.url)),hr=()=>{const[r,t]=o.useState(null),[i,a]=o.useState([]),[s,n]=o.useState("/"),[c,l]=o.useState(!0),[d,p]=o.useState("checking"),h=async()=>{try{p("checking");const e=E,r=[];e.cdn.enabled&&e.cdn.healthCheck.enabled&&r.push(F.initialize()),r.push(dr.startPreloading()),await Promise.allSettled(r),e.performance.enablePreloading&&e.performance.preloadResources.length>0&&F.preloadResources(e.performance.preloadResources).catch(e=>{}),p("ready")}catch(e){p("error")}},m=async()=>{try{l(!0);const e=await L();t(e),await(async()=>{try{N=await L()}catch(e){}})();const r=(e=>Object.keys(e.expected_positions).filter(r=>!e.expected_positions[r].hidden).map(r=>[e.expected_positions[r].header_info?.position,"/"+r,!!e.expected_positions[r].is_home_page,!!e.expected_positions[r].is_home_page]))(e);a(r),n((e=>e.find(([,,e])=>e)?.[1]||"/")(r)),v.tabs=r}catch(e){}finally{l(!1)}};return o.useEffect(()=>{var e;return(async()=>{await Promise.all([h(),m()])})(),e=()=>{m()},j.push(e),()=>{const r=j.indexOf(e);r>-1&&j.splice(r,1)}},[]),function(){const e=()=>{document.querySelectorAll(".lazy-video").forEach(e=>{const r=e.getBoundingClientRect();r.top<window.innerHeight+200&&r.bottom>0&&(e=>{const r=JSON.parse(e.dataset.sources),t=_().baseUrls.slice(0,3);let o="";t.forEach((e,t)=>{const i=r.original.startsWith("/")?`${e.endsWith("/")?e.slice(0,-1):e}${r.original}`:`${e.endsWith("/")?e:e+"/"}${r.original}`;o+=`<source src="${i}" type="video/mp4">\n        `});let i=r.original;if("undefined"!=typeof window)try{const e=window.location.pathname.split("/").filter(e=>e);if((!window.location.port||"5173"!==window.location.port&&"5174"!==window.location.port&&"3000"!==window.location.port)&&e.length>=1){const t=e.slice(0,-1);t.length>0&&(i="/"+t.join("/")+"/"+(r.original.startsWith("/")?r.original.slice(1):r.original))}}catch(s){}o+=`<source src="${i}" type="video/mp4">`,e.innerHTML=o,e.classList.remove("lazy-video"),e.removeAttribute("data-sources");const a=e.parentNode.querySelector(".loading-indicator");a?.remove()})(e)})};let r;window.addEventListener("scroll",()=>{r&&clearTimeout(r),r=setTimeout(e,100)}),window.addEventListener("resize",e),window.addEventListener("mouseup",()=>setTimeout(e,0)),e()}(),c||!r?e.jsx(ne,{children:e.jsx(Ae,{children:e.jsxs(Pe,{children:[e.jsx(K,{}),e.jsx(lr,{collapsible:!0}),e.jsxs("div",{style:{position:"fixed",top:"20px",right:"20px",background:"rgba(0,0,0,0.8)",color:"white",padding:"8px 12px",borderRadius:"4px",fontSize:"12px",zIndex:9999},children:["checking"===d&&"🔄 检测CDN...","ready"===d&&"✅ CDN就绪","error"===d&&"⚠️ CDN检测失败"]}),e.jsx(Me,{})]})})}):e.jsx(ne,{children:e.jsx(Ae,{children:e.jsx(Pe,{children:e.jsxs(ke,{children:[e.jsx(K,{}),e.jsx(lr,{collapsible:!0}),e.jsxs(u,{basename:r.header_info.route_base_name,children:[e.jsx(me,{})," ",e.jsxs(g,{children:[i.map(([r,t],i)=>e.jsx(f,{path:t,element:e.jsx(Pe,{children:e.jsx(o.Suspense,{fallback:e.jsx(Me,{}),children:e.jsx(pr,{path:t})})})},i)),i.map(([r,t],o)=>{const i=t+".html";return e.jsx(f,{path:i,element:e.jsx(b,{to:t,replace:!0})},`html-${o}`)}),e.jsx(f,{path:"/",element:e.jsx(b,{to:s})})]})]})]})})})})};w(document.getElementById("root")).render(e.jsx(o.StrictMode,{children:e.jsx(hr,{})}));export{Me as S,q as a,dr as b,w as c,J as d,Z as e,v as f,W as g,re as h,ie as i,H as j,te as k,V as l,oe as m,G as r,ce as u,Y as w};
