...
`,Be=d.div`
  ...
  flex-wrap: wrap;
  justify-content: center;
`,We=d.button.withConfig({shouldForwardProp:e=>"isDark"!==e&&"variant"!==e})`
  padding: 10px 20px;
  border: none;
  border-radius: 6px;
  font-size: 14px;
...
`,Ge=d.details.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  margin-top: 24px;
  max-width: 600px;
  text-align: left;
...
`,Ke=d.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  margin-top: 16px;
  padding: 8px 12px;
  ...
  font-size: 12px;
  color: ${e=>e.isDark?"var(--color-text-secondary)":"#666"};
`;class Ve extends a.Component{networkStatusUnsubscribe;constructor(e){super(e),this.state={hasError:!1,retryCount:0,isRetrying:!1}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,t){const r=function(e){const t=e.message.toLowerCase();return t.includes("network")||t.includes("fetch")||t.includes("timeout")||"TypeError"===e.name&&t.includes("failed to fetch")?"network":t.includes("chunk")||t.includes("loading")||t.includes("import")?"chunk":"runtime"}(e),a=Re(),i={type:r,message:e.message,stack:e.stack,componentStack:t.componentStack,timestamp:Date.now(),userAgent:navigator.userAgent,url:window.location.href,networkStatus:a,retryCount:this.state.retryCount};var n;this.setState({error:e,errorInfo:t,errorDetails:i}),this.props.onError?.(i),N()&&(Me("EnhancedErrorBoundary caught an error:",e,t),Me("Error details:",i)),this.networkStatusUnsubscribe=(n=e=>{e.isOnline&&this.state.hasError&&Me("Network recovered, user can retry")},Te.add(n),n(Fe),()=>{Te.delete(n)})}componentWillUnmount(){this.networkStatusUnsubscribe?.()}handleRetry=async()=>{const e=this.props.maxRetries||3;this.state.retryCount>=e||(this.setState({isRetrying:!0}),await new Promise(e=>setTimeout(e,1e3)),this.setState({hasError:!1,error:void 0,errorInfo:void 0,errorDetails:void 0,retryCount:this.state.retryCount+1,isRetrying:!1}))};handleReload=()=>{window.location.reload()};render(){if(this.state.hasError){if(this.props.fallback)return this.props.fallback;const{level:t="component",showErrorDetails:r=!1}=this.props,{errorDetails:a,retryCount:i,isRetrying:n}=this.state,o=this.props.maxRetries||3,s=Re(),c=a?.type||"unknown",l=function(e,t){if(!t)return"网络连接已断开，请检查您的网络连接后重试。";switch(e){case"network":return"网络请求失败，请检查网络连接或稍后重试。";case"chunk":return"页面资源加载失败，可能是网络问题，请尝试刷新页面。";case"runtime":return"页面运行时出现错误，请尝试刷新页面或联系技术支持。";default:return"页面遇到了一些问题，请尝试刷新页面或稍后再试。"}}(c,s.isOnline);return e.jsxs(Ne,{level:t,isDark:this.props.isDark,children:[e.jsx(Oe,{level:t,children:"network"===c?"🌐":"chunk"===c?"📦":"runtime"===c?"⚠️":"❌"}),e.jsx(Ae,{isDark:this.props.isDark,children:"network"===c?this.props.t?.common?.networkError||"网络连接问题":"chunk"===c?this.props.t?.common?.resourceLoadError||"资源加载失败":"runtime"===c?this.props.t?.common?.runtimeError||"运行时错误":this.props.t?.common?.pageLoadError||"页面加载出错了"}),e.jsxs(Ue,{isDark:this.props.isDark,children:[l,i>0&&e.jsxs(e.Fragment,{children:[e.jsx("br",{}),"已重试 ",i," 次"]})]}),e.jsxs(Be,{children:[e.jsx(We,{variant:"primary",isDark:this.props.isDark,onClick:this.handleRetry,disabled:n||i>=o,children:n?this.props.t?.common?.retrying||"重试中...":i>=o?this.props.t?.common?.maxRetriesReached||"已达最大重试次数":this.props.t?.common?.reload||"重新加载"}),e.jsx(We,{variant:"secondary",isDark:this.props.isDark,onClick:this.handleReload,children:"刷新页面"})]}),!s.isOnline&&e.jsx(Ke,{isDark:this.props.isDark,children:"🔴 网络连接已断开"}),r&&a&&e.jsxs(Ge,{isDark:this.props.isDark,children:[e.jsx("summary",{children:"错误详情 (开发模式)"}),e.jsxs("pre",{children:["错误类型: ",a.type,"\n","错误消息: ",a.message,"\n","时间戳: ",new Date(a.timestamp).toLocaleString(),"\n","网络状态: ",JSON.stringify(a.networkStatus,null,2),a.stack&&`\n\n堆栈跟踪:\n${a.stack}`,a.componentStack&&`\n\n组件堆栈:\n${a.componentStack}`]})]})]})}return this.props.children}}const He=t=>{const{isDark:r}=be(),{t:a}=Ie();return e.jsx(Ve,{...t,isDark:r,t:a,showErrorDetails:t.showErrorDetails??!1})},Ye=u`
  0% {
...
`,jt=d.span`
  font-weight: 500;
`,Pt=d.div.withConfig({shouldForwardProp:e=>"isOpen"!==e&&"isDark"!==e})`
  position: absolute;
  bottom: 100%;
  right: 0;
  margin-bottom: 4px;
  ...
  transform: ${e=>e.isOpen?"translateY(0)":"translateY(10px)"};
  transition: all 0.3s ease;
`,Et=d.button.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  display: flex;
  align-items: center;
  gap: 8px;
  width: 100%;
...
`,$t=({className:t})=>{const{isDark:r}=be(),{t:n}=Ie(),[o,s]=a.useState(!1),[c,l]=a.useState(!1);i.useEffect(()=>{const e=e=>{e.target.closest("[data-pdf-downloader]")||s(!1)};if(o)return document.addEventListener("click",e),()=>document.removeEventListener("click",e)},[o]),a.useEffect(()=>{const e=e=>{if(e.ctrlKey&&"p"===e.key){wt("检测到Ctrl+P快捷键，激活标准打印样式"),vt.activatePrintStyle("standard");const e=()=>{wt("打印对话框关闭，清理打印样式"),vt.deactivatePrintStyle(),window.removeEventListener("afterprint",e)};window.addEventListener("afterprint",e),setTimeout(()=>{vt.isStyleActivated()&&(wt("备用清理：5秒后自动清理打印样式"),vt.deactivatePrintStyle())},5e3)}};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[]);const d=async e=>{if(!c){l(!0),s(!1);try{wt(`开始生成${"color"===e?"彩色":"grayscale"===e?"黑白":"原版"}PDF`),"original"===e?(vt.activatePrintStyle("original"),wt("原版模式：保持在线显示样式")):(vt.activatePrintStyle("standard"),wt(`${e}模式：激活标准打印样式`));const t=document.body.cloneNode(!0);['[data-testid="control-panel"]',"[data-pdf-downloader]",".control-panel",".floating-panel"].forEach(e=>{t.querySelectorAll(e).forEach(e=>e.remove())}),wt("准备在当前页面打印，不创建新窗口");const r="temp-pdf-print-style";let a=document.getElementById(r);a&&a.remove();const i=document.createElement("style");i.id=r,i.type="text/css";const n="original"===e?'\n          @media print {\n            /* 基础打印设置 */\n            @page {\n              size: A4;\n              margin: 1cm;\n              background: var(--color-card);\n              /* 隐藏页眉页脚 */\n              @top-left { content: none; }\n              @top-center { content: none; }\n              @top-right { content: none; }\n              @bottom-left { content: none; }\n              @bottom-center { content: none; }\n              @bottom-right { content: none; }\n            }\n\n            /* 强制保持所有原有颜色和样式 - 最高优先级 */\n            * {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保HTML根元素保持主题 */\n            html {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保body保持背景色 */\n            body {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 深色模式特殊处理 */\n            [data-theme="dark"] {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            [data-theme="dark"] body {\n              background-color: var(--color-background) !important;\n              color: var(--color-text-primary) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            } \n\n            /* 确保深色模式的背景伪元素正确显示 */\n            [data-theme="dark"] body::before {\n              content: "" !important;\n              position: fixed !important;\n              top: 0 !important;\n              left: 0 !important;\n              width: 100% !important;\n              height: 100% !important;\n              background-color: var(--color-background) !important;\n              z-index: -1 !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 保持所有元素的原有样式 */\n            [data-theme="dark"] * {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保resume-content保持深色背景 - 最高优先级 */\n            [data-theme="dark"] [data-testid="resume-content"] {\n              background: var(--color-card) !important;\n              background-color: #2d3748 !important;\n              color: var(--color-text-primary) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 只隐藏不需要的元素，不改变任何颜色和样式 */\n            .no-print,\n            .print-hide,\n            .control-panel,\n            .floating-controls,\n            nav,\n            .navigation,\n            .tabs,\n            .tab-container,\n            button:not(.skill-item):not([class*="skill"]),\n            [data-testid="control-panel"],\n            [data-testid="development-notice"],\n            [data-pdf-downloader],\n            .pdf-downloader,\n            .control-button,\n            .floating-button,\n            [class*="control"]:not(.skill-item),\n            [class*="floating"]:not(.skill-item),\n            [class*="button"]:not(.skill-item),\n            .fixed,\n            .absolute {\n              display: none !important;\n            }\n\n            /* 确保技能标签正常显示 */\n            .skill-item,\n            [class*="skill"],\n            [class*="Skill"],\n            span[title*="了解"],\n            span[title*="熟练"],\n            span[title*="精通"] {\n              display: inline-flex !important;\n              visibility: visible !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n          }\n        ':`\n          @media print {\n            /* 确保激活全局打印样式 */\n            body.print-mode-active {\n              /* 页面设置 */\n              @page {\n                size: A4;\n                margin: 1cm;\n              }\n\n              /* 重置根元素和body */\n              html, body {\n                width: 100% !important;\n                height: auto !important;\n                margin: 0 !important;\n                padding: 20px !important;\n                background: white !important;\n                background-image: none !important;\n                overflow: visible !important;\n                font-size: 12pt !important;\n                line-height: 1.4 !important;\n                color: black !important;\n              }\n\n              /* 隐藏深色模式背景伪元素 */\n              [data-theme="dark"] body::before {\n                display: none !important;\n              }\n\n              /* 根元素打印优化 */\n              #root {\n                display: block !important;\n                width: 100% !important;\n                max-width: none !important;\n                margin: 0 !important;\n                padding: 0 !important;\n                background: white !important;\n                overflow: visible !important;\n              }\n\n              /* 隐藏不需要打印的元素 - 扩展选择器 */\n              .no-print,\n              .print-hide,\n              button:not(.skill-item):not([class*="skill"]),\n              .control-panel,\n              .floating-controls,\n              .floating-button,\n              .control-button,\n              nav,\n              .navigation,\n              .tabs,\n              .tab-container,\n              [data-testid="control-panel"],\n              [data-testid="development-notice"],\n              [data-pdf-downloader],\n              .pdf-downloader,\n              [class*="control"]:not(.skill-item):not(.category-item),\n              [class*="floating"]:not(.skill-item):not(.category-item),\n              [class*="button"]:not(.skill-item):not(.category-item),\n              [class*="Panel"],\n              [class*="Switcher"],\n              [class*="Downloader"],\n              .fixed,\n              .absolute {\n                display: none !important;\n                visibility: hidden !important;\n              }\n\n              /* 确保所有文本颜色为黑色，但保留技能标签样式 */\n              * {\n                color: black !important;\n                background: transparent !important;\n                box-shadow: none !important;\n                text-shadow: none !important;\n                -webkit-print-color-adjust: exact !important;\n                color-adjust: exact !important;\n                print-color-adjust: exact !important;\n              }\n\n              /* 保留技能标签的样式和颜色 */\n              .skill-item,\n              [class*="skill"],\n              [class*="Skill"],\n              span[title*="了解"],\n              span[title*="熟练"],\n              span[title*="精通"] {\n                background: initial !important;\n                color: initial !important;\n                -webkit-print-color-adjust: exact !important;\n                color-adjust: exact !important;\n                print-color-adjust: exact !important;\n              }\n\n              /* 技能标签内的文字保持渐变色 */\n              .skill-item span,\n              [class*="skill"] span,\n              [class*="Skill"] span {\n                background-clip: text !important;\n                -webkit-background-clip: text !important;\n                color: transparent !important;\n                background-image: inherit !important;\n                -webkit-print-color-adjust: exact !important;\n                color-adjust: exact !important;\n                print-color-adjust: exact !important;\n              }\n\n              /* 链接样式 */\n              a {\n                color: black !important;\n                text-decoration: underline !important;\n              }\n\n              /* 分页控制 */\n              .page-break-before {\n                page-break-before: always;\n              }\n\n              .page-break-after {\n                page-break-after: always;\n              }\n\n              .page-break-inside-avoid {\n                page-break-inside: avoid;\n              }\n\n              /* 黑白模式特殊处理 */\n              ${"grayscale"===e?"\n                * {\n                  filter: grayscale(100%) !important;\n                  -webkit-filter: grayscale(100%) !important;\n                }\n              ":""}\n            }\n\n            /* 调试信息 */\n            .pdf-debug-info {\n              position: fixed;\n              top: 10px;\n              right: 10px;\n              background: rgba(255,255,255,0.9) !important;\n              color: blue !important;\n              padding: 5px !important;\n              border: 2px solid blue !important;\n              z-index: 9999 !important;\n              font-size: 14px !important;\n              font-weight: bold !important;\n            }\n          }\n        `;i.textContent=n,document.head.appendChild(i),await new Promise(e=>setTimeout(e,300));const o="color"===e?"彩色版":"grayscale"===e?"黑白版":"原版";wt(`开始打印${o}`),window.print(),setTimeout(()=>{const e=document.getElementById(r);e&&e.remove(),wt("已清理临时打印样式")},1e3),wt(`${o}PDF生成完成`)}catch(t){wt("PDF生成失败:",t),alert(`${n.common?.pdfGenerationFailed||"PDF generation failed"}: ${t instanceof Error?t.message:n.common?.unknownError||"Unknown error"}`)}finally{vt.deactivatePrintStyle(),l(!1),wt("PDF生成流程结束，已清理打印样式")}}};return e.jsxs(yt,{className:t,"data-testid":"pdf-downloader","data-pdf-downloader":!0,children:[e.jsxs(Dt,{isDark:r,onClick:()=>s(!o),disabled:c,title:n.common?.downloadPDF||"Download PDF","aria-label":n.common?.downloadPDF||"Download PDF",children:[e.jsx(Ct,{children:c?e.jsx(St,{}):"📄"}),e.jsx(jt,{children:c?n.common?.generating||"Generating...":"PDF"}),!c&&e.jsx("span",{style:{transform:o?"rotate(0deg)":"rotate(180deg)",transition:"transform 0.3s ease",fontSize:"12px"},children:"▲"})]}),e.jsxs(Pt,{isOpen:o&&!c,isDark:r,children:[e.jsxs(Et,{isDark:r,onClick:()=>d("original"),disabled:c,children:[e.jsx("span",{children:"📱"}),e.jsx("span",{children:n.common?.originalPDF||"Original PDF"})]}),e.jsxs(Et,{isDark:r,onClick:()=>d("color"),disabled:c,children:[e.jsx("span",{children:"🎨"}),e.jsx("span",{children:n.common?.colorPDF||"Color PDF"})]}),e.jsxs(Et,{isDark:r,onClick:()=>d("grayscale"),disabled:c,children:[e.jsx("span",{children:"⚫"}),e.jsx("span",{children:n.common?.grayscalePDF||"Grayscale PDF"})]})]})]})},Lt=d.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  position: fixed;
  bottom: 20px;
  right: 20px;
  display: flex;
...
`,_t=d.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  width: 1px;
  height: 24px;
...
`;const zt=d.div.withConfig({shouldForwardProp:e=>"isCollapsed"!==e&&"isDark"!==e})`
  position: fixed;
  bottom: 20px;
  right: 20px;
  z-index: 1000;
...
`,Ft=d.div`
  ...
  gap: 12px;
`,Rt=d.span.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  font-size: 14px;
  font-weight: 500;
  color: ${e=>e.isDark?"#e2e8f0":"#2c3e50"};
`,Mt=({className:t,collapsible:r=!1,defaultCollapsed:a=!1})=>{const{isDark:n}=be(),{t:o}=Ie(),s=((e=768)=>{const[t,r]=i.useState(()=>"undefined"==typeof window||window.innerWidth>e);return i.useEffect(()=>{let t;const a=()=>{clearTimeout(t),t=setTimeout(()=>{r(window.innerWidth>e)},100)};return window.addEventListener("resize",a),a(),()=>{window.removeEventListener("resize",a),clearTimeout(t)}},[e]),t})(768),c=i.useMemo(()=>!1!==a?a:!s,[s,a]),[l,d]=i.useState(c),[p,h]=i.useState(!1);i.useEffect(()=>{p||d(c)},[c,p]);return r?e.jsxs(zt,{isCollapsed:l,isDark:n,className:t,"data-testid":"control-panel",children:[e.jsx(It,{isDark:n,onClick:()=>{h(!0),d(!l)},title:o.common.controlPanel,"aria-label":o.common.controlPanel,children:l?"⚙️":"✕"}),!l&&e.jsxs(Tt,{isDark:n,children:[e.jsxs(Ft,{children:[e.jsx(Rt,{isDark:n,children:o.common.theme}),e.jsx(xt,{showTooltip:!1})]}),e.jsx(_t,{isDark:n}),e.jsxs(Ft,{children:[e.jsx(Rt,{isDark:n,children:o.common.language}),e.jsx(dt,{})]}),e.jsx(_t,{isDark:n}),e.jsxs(Ft,{children:[e.jsx(Rt,{isDark:n,children:o.common.downloadPDF}),e.jsx($t,{})]})]})]}):e.jsxs(Lt,{isDark:n,className:t,"data-testid":"control-panel",children:[e.jsx(xt,{}),e.jsx(_t,{isDark:n}),e.jsx(dt,{}),e.jsx(_t,{isDark:n}),e.jsx($t,{})]})},Nt=()=>null,Ot=n("app:preloader"),At=new class{libraries=new Map;preloadPromises=new Map;constructor(){this.initializeLibraryStates()}initializeLibraryStates(){["mermaid","svgPanZoom","katex","cytoscape"].forEach(e=>{this.libraries.set(e,{loading:!1,loaded:!1,error:null,module:null})})}async startPreloading(){const e=R(),{preloadLibraries:t}=e.performance;N()&&Ot("[LibraryPreloader] 开始预加载库:",t);const r=[];t.mermaid&&r.push(this.preloadMermaid()),t.svgPanZoom&&r.push(this.preloadSvgPanZoom()),t.katex&&r.push(this.preloadKatex()),t.cytoscape&&r.push(this.preloadCytoscape()),Promise.allSettled(r).then(e=>{if(N()){const t=e.filter(e=>"fulfilled"===e.status).length,r=e.filter(e=>"rejected"===e.status).length;Ot(`[LibraryPreloader] 预加载完成: ${t}个成功, ${r}个失败`)}})}async preloadMermaid(){return this.preloadLibrary("mermaid",()=>o(()=>import("./mermaid-core-4prbhXRL.js").then(e=>e.b8),__vite__mapDeps([1,2,3]),import.meta.url))}async preloadSvgPanZoom(){return this.preloadLibrary("svgPanZoom",()=>o(()=>import("./utils-CEXnc-BX.js").then(e=>e.s),__vite__mapDeps([5,2]),import.meta.url))}async preloadKatex(){return this.preloadLibrary("katex",()=>o(()=>import("./katex-DuUXD-vJ.js"),[],import.meta.url))}async preloadCytoscape(){return this.preloadLibrary("cytoscape",()=>o(()=>import("./cytoscape-3nCDfVzk.js").then(e=>e.b),__vite__mapDeps([6,2]),import.meta.url))}async preloadLibrary(e,t){const r=this.libraries.get(e);if(!r||r.loaded||r.loading)return;if(this.preloadPromises.has(e))return this.preloadPromises.get(e);r.loading=!0,r.error=null;const a=performance.now(),i=t().then(t=>{const i=performance.now()-a;return r.loaded=!0,r.loading=!1,r.module=t,N()&&Ot(`[LibraryPreloader] ${e} 预加载成功 (${i.toFixed(2)}ms)`),t}).catch(e=>{throw r.loading=!1,r.error=e.message,N(),e}).finally(()=>{this.preloadPromises.delete(e)});return this.preloadPromises.set(e,i),i}async getLibrary(e){const t=this.libraries.get(e);if(!t)throw new Error(`Unknown library: ${e}`);if(t.loaded&&t.module)return t.module;if(t.loading&&this.preloadPromises.has(e))return this.preloadPromises.get(e);switch(e){case"mermaid":return this.preloadMermaid();case"svgPanZoom":return this.preloadSvgPanZoom();case"katex":return this.preloadKatex();case"cytoscape":return this.preloadCytoscape();default:throw new Error(`Unknown library: ${e}`)}}getLibraryState(e){return this.libraries.get(e)||null}getAllLibraryStates(){return new Map(this.libraries)}cleanup(){this.libraries.clear(),this.preloadPromises.clear()}},Ut=n("app:analytics-config"),Bt={baidu:{enabled:!1,siteId:"",domain:"",autoTrack:!0,debug:!1},google:{enabled:!1,measurementId:"",debug:!1,customDimensions:{},customMetrics:{},useFirebase:!0,dynamicLoading:!0},elk:{enabled:!1,endpoint:"http://localhost:5000",batchSize:10,flushInterval:5e3,debug:!1},enablePerformanceMonitoring:!0,enableErrorTracking:!0,enableUserBehaviorTracking:!0};class Wt{static instance;config;constructor(){this.config=this.loadConfig()}static getInstance(){return Wt.instance||(Wt.instance=new Wt),Wt.instance}loadConfig(){const e={...Bt};e.baidu={enabled:!0,siteId:"",domain:"deden.web.app",autoTrack:!0,debug:!1},e.google={enabled:!1,measurementId:"G-7LG0G58765",debug:!1,customDimensions:{},customMetrics:{},useFirebase:!1,dynamicLoading:!0},e.elk={enabled:!1,endpoint:"http://localhost:5001",batchSize:parseInt("10"),flushInterval:parseInt("5000"),debug:!1};try{const t=localStorage.getItem("analytics_config");if(t){const r=JSON.parse(t);Object.assign(e,r)}}catch(t){Ut("Failed to load user analytics config: %O",t)}return e}getConfig(){return{...this.config}}getBaiduConfig(){return{...this.config.baidu}}getGoogleConfig(){return{...this.config.google}}getELKConfig(){return{...this.config.elk}}updateConfig(e){this.config={...this.config,...e};try{localStorage.setItem("analytics_config",JSON.stringify(this.config))}catch(t){Ut("Failed to save analytics config: %O",t)}}setBaiduEnabled(e){this.config.baidu.enabled=e,this.updateConfig({baidu:this.config.baidu})}setGoogleEnabled(e){this.config.google.enabled=e,this.updateConfig({google:this.config.google})}setELKEnabled(e){this.config.elk.enabled=e,this.updateConfig({elk:this.config.elk})}isAnyAnalyticsEnabled(){return this.config.baidu.enabled||this.config.google.enabled||this.config.elk.enabled}getConfigSummary(){return{baiduEnabled:this.config.baidu.enabled,googleEnabled:this.config.google.enabled,elkEnabled:this.config.elk.enabled,performanceMonitoring:this.config.enablePerformanceMonitoring,errorTracking:this.config.enableErrorTracking,userBehaviorTracking:this.config.enableUserBehaviorTracking}}}const Gt=Wt.getInstance();class Kt{static instance;isInitialized=!1;siteId="fd188b066e21a8e15d579e5f0b7633a9";constructor(){}static getInstance(){return Kt.instance||(Kt.instance=new Kt),Kt.instance}async initialize(){const e=Gt.getBaiduConfig();if(e.enabled&&!this.isInitialized)try{window._hmt=window._hmt||[];const t=document.createElement("script");t.src=`https://hm.baidu.com/hm.js?${this.siteId}`,t.async=!0;const r=document.getElementsByTagName("script")[0];r&&r.parentNode?r.parentNode.insertBefore(t,r):document.head.appendChild(t),this.isInitialized=!0,e.debug,e.autoTrack&&this.trackPageView()}catch(t){}}trackPageView(e,t){if(!this.isReady())return;const r=e||location.pathname+location.search;window._hmt.push(["_trackPageview",r]),Gt.getBaiduConfig().debug}trackEvent(e){if(!this.isReady())return;const{category:t,action:r,label:a,value:i}=e;if(!t||!r)return;const n=["_trackEvent",t,r];a&&n.push(a),void 0!==i&&n.push(i),window._hmt.push(n),Gt.getBaiduConfig().debug}trackSkillClick(e,t){this.trackEvent({category:"skill",action:"click",label:e,value:1})}trackProjectView(e,t){this.trackEvent({category:"project",action:"view",label:e,value:1})}trackContactClick(e){this.trackEvent({category:"contact",action:"click",label:e,value:1})}trackLanguageSwitch(e,t){this.trackEvent({category:"language",action:"switch",label:`${e}_to_${t}`,value:1})}trackThemeSwitch(e,t){this.trackEvent({category:"theme",action:"switch",label:`${e}_to_${t}`,value:1})}trackDownload(e,t){this.trackEvent({category:"download",action:"click",label:t||e,value:1})}trackError(e,t){this.trackEvent({category:"error",action:e,label:t,value:1})}setCustomVar(e,t,r,a=3){this.isReady()&&(e<1||e>5||(window._hmt.push(["_setCustomVar",e,t,r,a]),Gt.getBaiduConfig().debug))}isReady(){const e=Gt.getBaiduConfig();return this.isInitialized&&e.enabled?!!window._hmt:(e.debug,!1)}getStatus(){const e=Gt.getBaiduConfig();return{initialized:this.isInitialized,enabled:e.enabled,siteId:this.siteId.substring(0,8)+"..."}}}const Vt=Kt.getInstance();"undefined"!=typeof window&&setTimeout(()=>{Vt.initialize()},1e3);class Ht{static instance;firebaseSDK=null;analytics=null;app=null;isLoading=!1;isLoaded=!1;loadPromise=null;constructor(){}static getInstance(){return Ht.instance||(Ht.instance=new Ht),Ht.instance}async loadFirebaseSDK(){try{if("undefined"==typeof window)return null;if(this.firebaseSDK)return this.firebaseSDK;const e=document.createElement("script");e.type="module",e.innerHTML="\n        import { initializeApp } from 'https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js';\n        import { \n          getAnalytics, \n          isSupported, \n          logEvent, \n          setUserProperties, \n          setUserId,\n          setCurrentScreen \n        } from 'https://www.gstatic.com/firebasejs/10.7.1/firebase-analytics.js';\n        \n        window.__firebaseSDK = {\n          initializeApp,\n          getAnalytics,\n          isSupported,\n          logEvent,\n          setUserProperties,\n          setUserId,\n          setCurrentScreen\n        };\n        \n        window.dispatchEvent(new CustomEvent('firebaseSDKLoaded'));\n      ";const t=new Promise(t=>{const r=()=>{window.removeEventListener("firebaseSDKLoaded",r);const e=window.__firebaseSDK;e?(this.firebaseSDK=e,t(e)):t(null)};window.addEventListener("firebaseSDKLoaded",r),e.addEventListener("error",()=>{t(null)}),setTimeout(()=>{window.removeEventListener("firebaseSDKLoaded",r),t(null)},1e4)});return document.head.appendChild(e),await t}catch(e){return null}}getFirebaseConfig(){const e=Gt.getGoogleConfig();if(!e.enabled)return null;const t={apiKey:"",authDomain:"",projectId:"",storageBucket:"",messagingSenderId:"",appId:"",measurementId:e.measurementId||"G-7LG0G58765"};return t.apiKey&&t.projectId&&t.measurementId?t:null}async initialize(){if(this.isLoading&&this.loadPromise)return await this.loadPromise;if(this.isLoaded&&this.analytics)return!0;this.isLoading=!0,this.loadPromise=this._doInitialize();const e=await this.loadPromise;return this.isLoading=!1,this.isLoaded=e,e}async _doInitialize(){try{const e=this.getFirebaseConfig();if(!e)return!1;const t=await this.loadFirebaseSDK();return!!t&&(!!(await t.isSupported())&&(this.app=t.initializeApp(e),this.analytics=t.getAnalytics(this.app),!0))}catch(e){return!1}}async logEvent(e,t){if(await this.initialize())try{this.firebaseSDK&&this.analytics&&(this.firebaseSDK.logEvent(this.analytics,e,t),Gt.getGoogleConfig().debug)}catch(r){}}async setUserProperties(e){if(await this.initialize())try{this.firebaseSDK&&this.analytics&&(this.firebaseSDK.setUserProperties(this.analytics,e),Gt.getGoogleConfig().debug)}catch(t){}}async setUserId(e){if(await this.initialize())try{this.firebaseSDK&&this.analytics&&(this.firebaseSDK.setUserId(this.analytics,e),Gt.getGoogleConfig().debug)}catch(t){}}async setCurrentScreen(e){if(await this.initialize())try{this.firebaseSDK&&this.analytics&&(this.firebaseSDK.setCurrentScreen(this.analytics,e),Gt.getGoogleConfig().debug)}catch(t){}}getStatus(){const e=this.getFirebaseConfig();return{isLoaded:this.isLoaded,isLoading:this.isLoading,hasAnalytics:!!this.analytics,hasApp:!!this.app,configValid:!!e}}reset(){this.firebaseSDK=null,this.analytics=null,this.app=null,this.isLoading=!1,this.isLoaded=!1,this.loadPromise=null,"undefined"!=typeof window&&delete window.__firebaseSDK}}const Yt=Ht.getInstance();class Jt{static instance;isInitialized=!1;analytics=null;measurementId="";constructor(){}static getInstance(){return Jt.instance||(Jt.instance=new Jt),Jt.instance}async initialize(){const e=Gt.getGoogleConfig();if(e.enabled&&e.measurementId&&!this.isInitialized){this.measurementId=e.measurementId;try{if(await this.initializeWithFirebase())return this.isInitialized=!0,void e.debug;if(await this.initializeWithGtag())return this.isInitialized=!0,void e.debug;throw new Error("Failed to initialize with any method")}catch(t){}}}async initializeWithFirebase(){try{return!!(await Yt.initialize())&&(this.analytics={},!0)}catch(e){return!1}}async initializeWithGtag(){try{window.dataLayer=window.dataLayer||[],window.gtag=function(){window.dataLayer.push(arguments)},window.gtag("js",new Date),window.gtag("config",this.measurementId,{debug_mode:Gt.getGoogleConfig().debug});const e=document.createElement("script");return e.async=!0,e.src=`https://www.googletagmanager.com/gtag/js?id=${this.measurementId}`,new Promise(t=>{e.onload=()=>t(!0),e.onerror=()=>t(!1),document.head.appendChild(e)})}catch(e){return!1}}trackPageView(e){if(!this.isReady())return;const t=Gt.getGoogleConfig(),r={page_title:e?.page_title||document.title,page_location:e?.page_location||window.location.href,page_path:e?.page_path||window.location.pathname,...e};try{this.analytics?import("firebase/analytics").then(({logEvent:e})=>{e(this.analytics,"page_view",r)}).catch(e=>{}):window.gtag&&window.gtag("event","page_view",r),t.debug}catch(a){}}trackEvent(e){if(!this.isReady())return;const t=Gt.getGoogleConfig(),{action:r,category:a,label:i,value:n,custom_parameters:o}=e;if(!r)return;const s={event_category:a||"engagement",event_label:i,value:n,...o};Object.keys(s).forEach(e=>{void 0===s[e]&&delete s[e]});try{this.analytics?Yt.logEvent(r,s).catch(e=>{}):window.gtag&&window.gtag("event",r,s),t.debug}catch(c){}}trackSkillClick(e,t){this.trackEvent({action:"skill_click",category:"user_interaction",label:e,custom_parameters:{skill_category:t,interaction_type:"click"}})}trackProjectView(e,t){this.trackEvent({action:"project_view",category:"content",label:e,custom_parameters:{project_type:t,content_type:"project"}})}trackContactClick(e,t){this.trackEvent({action:"contact_click",category:"user_interaction",label:e,custom_parameters:{contact_method:e,contact_value:t}})}trackLanguageSwitch(e,t){this.trackEvent({action:"language_change",category:"user_preference",label:`${e}_to_${t}`,custom_parameters:{previous_language:e,new_language:t}})}trackThemeSwitch(e,t){this.trackEvent({action:"theme_change",category:"user_preference",label:`${e}_to_${t}`,custom_parameters:{previous_theme:e,new_theme:t}})}trackDownload(e,t){this.trackEvent({action:"file_download",category:"engagement",label:t||e,custom_parameters:{file_type:e,file_name:t}})}trackError(e,t,r=!1){this.trackEvent({action:"exception",category:"error",label:e,custom_parameters:{description:t,fatal:r}})}setUserProperty(e,t){if(!this.isReady())return;const r=Gt.getGoogleConfig();try{this.analytics?Yt.setUserProperties({[e]:t}).catch(e=>{}):window.gtag&&window.gtag("config",this.measurementId,{user_properties:{[e]:t}}),r.debug}catch(a){}}isReady(){const e=Gt.getGoogleConfig();return this.isInitialized&&e.enabled?!(!this.analytics&&!window.gtag):(e.debug,!1)}getStatus(){const e=Gt.getGoogleConfig();let t="none";this.analytics?t="firebase":window.gtag&&(t="gtag");const r={initialized:this.isInitialized,enabled:e.enabled,measurementId:this.measurementId.substring(0,8)+"...",method:t};return"firebase"===t&&(r.firebaseLoader=Yt.getStatus()),r}}const qt=Jt.getInstance(),Qt=n("app:elk");class Zt{static instance;eventQueue=[];flushTimer=null;sessionId;constructor(){this.sessionId=this.generateSessionId(),this.setupAutoFlush(),this.setupPageUnloadHandler()}static getInstance(){return Zt.instance||(Zt.instance=new Zt),Zt.instance}generateSessionId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}setupAutoFlush(){const e=Gt.getELKConfig();e.enabled&&(this.flushTimer=setInterval(()=>{this.flushEvents()},e.flushInterval||5e3))}setupPageUnloadHandler(){window.addEventListener("beforeunload",()=>{this.flushEvents(!0)})}createBaseEvent(e,t){return{timestamp:(new Date).toISOString(),event_type:e,page:window.location.pathname,source:"flexiresume",user_agent:navigator.userAgent,referrer:document.referrer,data:{session_id:this.sessionId,...t}}}addEvent(e){const t=Gt.getELKConfig();t.enabled?(this.eventQueue.push(e),this.eventQueue.length>=(t.batchSize||10)&&this.flushEvents(),t.debug&&Qt("Event added to queue: %O",e)):t.debug&&Qt("Disabled, event not added: %O",e)}async flushEvents(e=!1){const t=Gt.getELKConfig();if(!t.enabled||0===this.eventQueue.length)return;const r=[...this.eventQueue];this.eventQueue=[];try{const a={events:r,source:"flexiresume",timestamp:(new Date).toISOString()};if(e&&navigator.sendBeacon)navigator.sendBeacon(t.endpoint,JSON.stringify(a));else{const e=await fetch(t.endpoint,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});e.ok?t.debug&&Qt("Events sent successfully: %d",r.length):(Qt("Failed to send events: %s",e.statusText),r.length<(t.batchSize||10)&&this.eventQueue.unshift(...r))}}catch(a){Qt("Error sending events: %O",a),r.length<(t.batchSize||10)&&this.eventQueue.unshift(...r)}}trackPageView(e,t){const r=this.createBaseEvent("page_view",{title:e||document.title,url:t||window.location.href,timestamp:Date.now()});this.addEvent(r)}trackUserInteraction(e,t,r,a){const i=this.createBaseEvent("user_interaction",{action:e,element:t,element_text:r,value:a,timestamp:Date.now()});this.addEvent(i)}trackPerformance(e,t,r,a){const i=this.createBaseEvent("performance",{metric_name:e,metric_value:t,metric_unit:r,additional_data:a,timestamp:Date.now()});this.addEvent(i)}trackError(e,t,r,a,i="medium"){const n=this.createBaseEvent("error",{error_type:e,error_message:t,error_stack:r,component:a,severity:i,timestamp:Date.now()});this.addEvent(n)}trackSkillClick(e,t){this.trackUserInteraction("skill_click","skill_tag",e,t)}trackProjectView(e,t){this.trackUserInteraction("project_view","project_card",e,t)}trackContactClick(e,t){this.trackUserInteraction("contact_click","contact_info",e,t)}trackLanguageSwitch(e,t){this.trackUserInteraction("language_switch","language_toggle",`${e}_to_${t}`)}trackThemeSwitch(e,t){this.trackUserInteraction("theme_switch","theme_toggle",`${e}_to_${t}`)}trackDownload(e,t){this.trackUserInteraction("download","download_button",e,t)}getStatus(){const e=Gt.getELKConfig();return{enabled:e.enabled,sessionId:this.sessionId,queueSize:this.eventQueue.length,endpoint:e.endpoint}}setEnabled(e){Gt.setELKEnabled(e),e?this.setupAutoFlush():(this.flushTimer&&(clearInterval(this.flushTimer),this.flushTimer=null),this.eventQueue=[])}}const Xt=Zt.getInstance();"undefined"!=typeof window&&(window.addEventListener("load",()=>{const e=performance.getEntriesByType("navigation")[0];e&&(Xt.trackPerformance("page_load_time",e.loadEventEnd-e.loadEventStart,"ms"),Xt.trackPerformance("dom_content_loaded",e.domContentLoadedEventEnd-e.domContentLoadedEventStart,"ms"),Xt.trackPerformance("first_contentful_paint",performance.getEntriesByType("paint")[1]?.startTime||0,"ms"))}),window.addEventListener("error",e=>{Xt.trackError("javascript_error",e.message,e.error?.stack,void 0,"high")}),window.addEventListener("unhandledrejection",e=>{Xt.trackError("unhandled_promise_rejection",e.reason?.message||"Unhandled promise rejection",e.reason?.stack,void 0,"high")}));const er=n("app:main"),tr=a.lazy(()=>o(()=>import("./FlexiResume-Dk1byadE.js"),__vite__mapDeps([7,8,2,9,1,3,10,5,11]),import.meta.url)),rr=()=>{const[t,r]=a.useState(null),[i,n]=a.useState([]),[o,s]=a.useState([]),[c,l]=a.useState("/"),[d,p]=a.useState(!0),[h,u]=a.useState("checking"),x=async()=>{try{u("checking");const e=R(),t=[];e.cdn.enabled&&e.cdn.healthCheck.enabled&&(er("Initializing CDN health check..."),t.push(K.initialize())),er("Starting library preloading..."),t.push(At.startPreloading()),await Promise.allSettled(t),e.performance.enablePreloading&&e.performance.preloadResources.length>0&&K.preloadResources(e.performance.preloadResources).catch(e=>{er("Resource preloading failed: %O",e)}),u("ready")}catch(e){er("CDN initialization failed: %O",e),u("error")}},w=async()=>{try{p(!0);const e=await L();r(e),await(async()=>{try{Y=await L()}catch(e){V("Failed to update data cache: %O",e)}})();const t=(e=>Object.keys(e.expected_positions).filter(t=>!e.expected_positions[t].hidden).map(t=>[e.expected_positions[t].header_info?.position,"/"+t,!!e.expected_positions[t].is_home_page,!!e.expected_positions[t].is_home_page]))(e),a=(e=>Object.keys(e.expected_positions).map(t=>({key:t,title:e.expected_positions[t].header_info?.position||t,path:"/"+t,isHomePage:!!e.expected_positions[t].is_home_page,hidden:!!e.expected_positions[t].hidden})))(e);n(t),s(a),l((e=>e.find(([,,e])=>e)?.[1]||"/")(t)),v.tabs=t}catch(e){er("Failed to load language data: %O",e)}finally{p(!1)}},k=async()=>{try{er("Initializing analytics..."),await Vt.initialize(),await qt.initialize();const e=Vt.getStatus(),t=qt.getStatus(),r=Xt.getStatus();er("Analytics status: %O",{baidu:e,google:t,elk:r,config:Gt.getConfigSummary()}),Xt.trackPageView("App Initialized",window.location.href)}catch(e){er("Analytics initialization failed: %O",e)}};return a.useEffect(()=>{var e;return(async()=>{await Promise.all([x(),w(),k()])})(),e=()=>{w()},P.push(e),()=>{const t=P.indexOf(e);t>-1&&P.splice(t,1)}},[]),function(){const e=()=>{document.querySelectorAll(".lazy-video").forEach(e=>{const t=e.getBoundingClientRect();t.top<window.innerHeight+200&&t.bottom>0&&(e=>{const t=JSON.parse(e.dataset.sources),r=M().baseUrls.slice(0,3);let a="";r.forEach((e,r)=>{const i=t.original.startsWith("/")?`${e.endsWith("/")?e.slice(0,-1):e}${t.original}`:`${e.endsWith("/")?e:e+"/"}${t.original}`;a+=`<source src="${i}" type="video/mp4">\n        `});let i=t.original;try{i=K.getResourceUrl(t.original,{enableFallback:!0,localBasePath:"",cacheUrls:!1})}catch(o){H("Failed to build local fallback URL: %O",o)}a+=`<source src="${t.original}" type="video/mp4">`,e.innerHTML=a,e.classList.remove("lazy-video"),e.removeAttribute("data-sources");const n=e.parentNode.querySelector(".loading-indicator");n?.remove()})(e)})};let t;window.addEventListener("scroll",()=>{t&&clearTimeout(t),t=setTimeout(e,100)}),window.addEventListener("resize",e),window.addEventListener("mouseup",()=>setTimeout(e,0)),e()}(),d||!t?e.jsx(fe,{children:e.jsx(ze,{children:e.jsxs(He,{level:"page",maxRetries:3,children:[e.jsx(se,{}),e.jsx(Mt,{collapsible:!0}),e.jsxs("div",{style:{position:"fixed",top:"20px",right:"20px",background:"rgba(0,0,0,0.8)",color:"white",padding:"8px 12px",borderRadius:"4px",fontSize:"12px",zIndex:9999},children:["checking"===h&&"🔄 检测CDN...","ready"===h&&"✅ CDN就绪","error"===h&&"⚠️ CDN检测失败"]}),e.jsx(tt,{})]})})}):e.jsx(fe,{children:e.jsx(ze,{children:e.jsx(He,{level:"page",maxRetries:3,children:e.jsxs($e,{children:[e.jsx(se,{}),e.jsx(Nt,{}),e.jsx(Mt,{collapsible:!0}),e.jsxs(m,{basename:t.header_info.route_base_name,children:[e.jsx(ye,{})," ",e.jsxs(g,{children:[o.map((t,r)=>e.jsx(f,{path:t.path,element:e.jsx(He,{level:"section",maxRetries:2,children:e.jsx(a.Suspense,{fallback:e.jsx(tt,{}),children:e.jsx(tr,{path:t.path})})})},r)),o.map((t,r)=>{const a=t.path+".html";return e.jsx(f,{path:a,element:e.jsx(b,{to:t.path,replace:!0})},`html-${r}`)}),e.jsx(f,{path:"/",element:e.jsx(b,{to:c})})]})]})]})})})})};w(document.getElementById("root")).render(e.jsx(a.StrictMode,{children:e.jsx(rr,{})}));export{tt as S,re as a,At as b,w as c,ie as d,ae as e,v as f,Q as g,de as h,ue as i,ee as j,pe as k,Z as l,he as m,ne as r,be as u,te as w};
