...
`,Xe=m(g).withConfig({shouldForwardProp:e=>"isDark"!==e})`
  /* 基础样式 */
  text-decoration: none;
...
`,nt=({imageUrl:t,onClose:i})=>e.jsxs(it,{onClick:i,children:[e.jsx(at,{src:t,onClick:e=>e.stopPropagation()}),e.jsx(rt,{onClick:i,children:e.jsx(tt,{size:30,color:"white"})})]}),ot=a.createContext(void 0),st=({children:i})=>{const[n,o]=a.useState(!1),[s,l]=a.useState(""),c=e=>{l(e),o(!0)};return r.useEffect(()=>{window.$handleImageClick=c;const e=e=>{const t=e.target;let i=null;if("IMG"===t.tagName?i=t:t.closest("img")&&(i=t.closest("img")),i&&i.classList.contains("clickable-image")){const t=i.getAttribute("data-image-url");t&&(c(t),e.preventDefault(),e.stopPropagation())}};return document.addEventListener("click",e,!0),()=>{delete window.$handleImageClick,document.removeEventListener("click",e,!0)}},[]),e.jsxs(ot.Provider,{value:{handleImageClick:c},children:[i,n&&e.jsx(e.Fragment,{children:e.jsx(t.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",zIndex:999999,pointerEvents:"auto"},children:e.jsx(nt,{imageUrl:s,onClose:()=>{o(!1)}})})})]})},lt={zh:{common:{loading:"加载中...",error:"加载失败",retry:"重试",contact:"联系我",download:"下载简历",print:"打印简历",share:"分享",switchLanguage:"切换语言",switchTheme:"切换主题",lightMode:"浅色模式",darkMode:"深色模式",controlPanel:"控制面板",theme:"主题",language:"语言",downloadPDF:"下载PDF",originalPDF:"原版PDF",colorPDF:"彩色PDF",grayscalePDF:"黑白PDF",generating:"生成中...",pdfGenerationFailed:"PDF生成失败",unknownError:"未知错误",buildGuide:"构建指南",close:"关闭提示",reset:"重置",networkError:"网络连接问题",resourceLoadError:"资源加载失败",runtimeError:"运行时错误",pageLoadError:"页面加载出错了",retrying:"重试中...",maxRetriesReached:"已达最大重试次数",reload:"重新加载",developmentMode:"开发环境模式 (npm run dev)",developmentDescription:"如需完整功能测试，建议使用 npm run build 构建后预览。",buildGuideButton:"📖 构建指南",resetButton:"🔄 重置",buildGuideAlert:"📖 构建指南已输出到控制台\n💡 请打开浏览器控制台查看详细信息",resetAlert:"已重置",developmentTips:"📍 当前模式: 开发环境 (npm run dev)\n🔧 特性说明:\n  • 热重载 (HMR) 已启用\n⚠️  注意事项:\n  • Mermaid图表可能需要手动刷新\n💡 建议:\n  • 如需完整功能测试，请使用: npm run build\n  • 生产环境预览: npm run preview",developmentEnvironment:"🚀 FlexiResume 开发环境",font:"字体",music:"音乐",renderFailed:"渲染失败",mindmapLoading:"脑图加载中...",mindmapRenderFailed:"脑图渲染失败",imageLoading:"📷 加载中...",imageLoadFailed:"🖼️ 图片加载失败",imageErrorHandlerInitialized:"图片错误处理器已初始化",imageErrorHandlerDestroyed:"图片错误处理器已销毁",imageLoadSuccess:"图片加载成功",imageRetryLocal:"尝试本地回退",localFallbackFailed:"本地回退失败",imageFinalLoadFailed:"图片最终加载失败",mindmapViewer:"脑图查看器",clickToEnlarge:"点击放大查看",renderingChart:"正在渲染图表...",wheelZoom:"滚轮缩放",dragPan:"拖拽平移",escClose:"ESC关闭",mindmapExpanded:"脑图已展开 • 任意位置点击关闭"},resume:{personalInfo:"个人信息",personalStrengths:"个人优势",skills:"技能清单",employmentHistory:"工作经历",projectExperience:"项目经历",educationHistory:"教育背景",personalInfluence:"个人影响力",careerPlanning:"职业规划",openSourceProjects:"开源项目"},profile:{position:"求职意向",expectedSalary:"期望薪资",status:"工作状态",phone:"联系电话",email:"邮箱地址",location:"所在地区",experience:"工作经验",education:"学历"},time:{present:"至今",years:"年",months:"个月"},skillLevel:{familiar:"了解",proficient:"熟练",expert:"精通",undefined:"未定义",familiarDescription:"了解{skill}，正在进行技术预研或学习阶段",proficientDescription:"熟练使用{skill}，有实际项目开发经验",expertDescription:"精通{skill}，有丰富的实战经验，能解决复杂问题",undefinedDescription:"{skill}，技能等级未定义"}},en:{common:{loading:"Loading...",error:"Load Failed",retry:"Retry",contact:"Contact Me",download:"Download Resume",print:"Print Resume",share:"Share",switchLanguage:"Switch Language",switchTheme:"Switch Theme",lightMode:"Light Mode",darkMode:"Dark Mode",controlPanel:"Control Panel",theme:"Theme",language:"Language",downloadPDF:"Download PDF",originalPDF:"Original PDF",colorPDF:"Color PDF",grayscalePDF:"Grayscale PDF",generating:"Generating...",pdfGenerationFailed:"PDF generation failed",unknownError:"Unknown error",buildGuide:"Build Guide",close:"Close",reset:"Reset",networkError:"Network Connection Issue",resourceLoadError:"Resource Load Failed",runtimeError:"Runtime Error",pageLoadError:"Page Load Error",retrying:"Retrying...",maxRetriesReached:"Max retries reached",reload:"Reload",developmentMode:"Development Mode (npm run dev)",developmentDescription:"For complete functionality testing, please use npm run build to build and preview.",buildGuideButton:"📖 Build Guide",resetButton:"🔄 Reset",buildGuideAlert:"📖 Build guide has been output to console\n💡 Please open browser console for detailed information",resetAlert:"Reset completed",developmentTips:"📍 Current mode: Development (npm run dev)\n🔧 Features:\n  • Hot Module Replacement (HMR) enabled\n⚠️  Notes:\n  • Mermaid charts may need manual refresh\n💡 Recommendations:\n  • For complete functionality testing, use: npm run build\n  • Production preview: npm run preview",developmentEnvironment:"🚀 FlexiResume Development Environment",font:"Font",music:"Music",renderFailed:"Render Failed",mindmapLoading:"Loading Mindmap...",mindmapRenderFailed:"Mindmap Render Failed",imageLoading:"📷 Loading...",imageLoadFailed:"🖼️ Image Load Failed",imageErrorHandlerInitialized:"Image error handler initialized",imageErrorHandlerDestroyed:"Image error handler destroyed",imageLoadSuccess:"Image loaded successfully",imageRetryLocal:"Trying local fallback",localFallbackFailed:"Local fallback failed",imageFinalLoadFailed:"Image final load failed",mindmapViewer:"Mindmap Viewer",clickToEnlarge:"Click to enlarge",renderingChart:"Rendering chart...",wheelZoom:"Wheel Zoom",dragPan:"Drag Pan",escClose:"ESC Close",mindmapExpanded:"Mindmap Expanded • Click anywhere to close"},resume:{personalInfo:"Personal Information",personalStrengths:"Personal Strengths",skills:"Skills",employmentHistory:"Work Experience",projectExperience:"Project Experience",educationHistory:"Education",personalInfluence:"Personal Influence",careerPlanning:"Career Planning",openSourceProjects:"Open Source Projects"},profile:{position:"Position",expectedSalary:"Expected Salary",status:"Status",phone:"Phone",email:"Email",location:"Location",experience:"Experience",education:"Education"},time:{present:"Present",years:" years",months:" months"},skillLevel:{familiar:"Familiar",proficient:"Proficient",expert:"Expert",undefined:"Undefined",familiarDescription:"Familiar with {skill}, currently in technical research or learning phase",proficientDescription:"Proficient in {skill}, with practical project development experience",expertDescription:"Expert in {skill}, with rich practical experience and ability to solve complex problems",undefinedDescription:"{skill}, skill level undefined"}}},ct=a.createContext(void 0),dt=({children:t})=>{const[i,r]=a.useState(()=>{const e=localStorage.getItem("language");return!e||"zh"!==e&&"en"!==e?navigator.language.toLowerCase().startsWith("zh")?"zh":"en":e});a.useEffect(()=>{localStorage.setItem("language",i)},[i]);const n=(e=>t=>{const i=performance.now();e(e=>(setTimeout(()=>{const a=performance.now()-i;((e,t,i)=>{De.recordLanguageChangeTime(e,t,i)})(e,t,a)},0),t))})(r),o={language:i,setLanguage:n,t:lt[i]};return e.jsx(ct.Provider,{value:o,children:t})},pt=()=>{const e=a.useContext(ct);if(!e)throw new Error("useI18n must be used within an I18nProvider");return e},mt=()=>{if("undefined"!=typeof window){const e=localStorage.getItem("language");if(e&&("zh"===e||"en"===e))return e}return"zh"},ht=e=>lt[e];S("NetworkManager");const ut=new Set;let gt={isOnline:navigator.onLine,connectionType:"unknown",effectiveType:"unknown",downlink:0,rtt:0,saveData:!1};function ft(){return{...gt}}const bt=S("error-boundary"),xt=m.div.withConfig({shouldForwardProp:e=>"isDark"!==e&&"level"!==e})`
  ...
  text-align: center;
  transition: all 0.3s ease;
`,yt=m.div.withConfig({shouldForwardProp:e=>"level"!==e})`
  font-size: ${e=>{switch(e.level){case"page":return"48px";case"section":return"36px";default:return"24px"}}};
  margin-bottom: 16px;
  opacity: 0.8;
`,wt=m.h3.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  color: ${e=>e.isDark?"var(--color-text-primary)":"#333"};
  margin: 0 0 12px 0;
  font-size: 18px;
  font-weight: 600;
`,vt=m.p.withConfig({shouldForwardProp:e=>"isDark"!==e})`
...
`,kt=m.div`
  ...
  flex-wrap: wrap;
  justify-content: center;
`,Ct=m.button.withConfig({shouldForwardProp:e=>"isDark"!==e&&"variant"!==e})`
  padding: 10px 20px;
  border: none;
  border-radius: 6px;
  font-size: 14px;
...
`,St=m.details.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  margin-top: 24px;
  max-width: 600px;
  text-align: left;
...
`,Dt=m.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  margin-top: 16px;
  padding: 8px 12px;
...
`,$t=m.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  ...
  border-radius: 4px;
  transition: background 0.3s ease;
`,zt=m($t).withConfig({shouldForwardProp:e=>"isDark"!==e})`
  height: ${e=>e.height||"16px"};
  width: ${e=>e.width||"100%"};
  margin: ${e=>e.margin||"8px 0"};
`,It=m($t).withConfig({shouldForwardProp:e=>"isDark"!==e})`
  ...
  margin: 16px 0;
`,Tt=m($t).withConfig({shouldForwardProp:e=>"isDark"!==e})`
  width: ${e=>e.size||80}px;
  height: ${e=>e.size||80}px;
  border-radius: 50%;
  flex-shrink: 0;
`;m($t).withConfig({shouldForwardProp:e=>"isDark"!==e})`
  height: 36px;
  width: ${e=>e.width||"100px"};
  border-radius: 6px;
`;const Mt=m.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
...
`;m($t)`
  ...
  border-radius: 8px;
`;const Nt=m.div.withConfig({shouldForwardProp:e=>"minWidth"!==e})`
...
`,ai=m.span`
  font-weight: 500;
`,ri=m.div.withConfig({shouldForwardProp:e=>"isOpen"!==e&&"isDark"!==e})`
  position: absolute;
  bottom: 100%;
  right: 0;
  margin-bottom: 4px;
  ...
  transition: all 0.3s ease;
`,ni=m.button.withConfig({shouldForwardProp:e=>"isActive"!==e&&"isDark"!==e})`
  display: flex;
  align-items: center;
  gap: 8px;
  width: 100%;
...
`,pi=m.div.withConfig({shouldForwardProp:e=>"isVisible"!==e})`
  position: absolute;
  top: 50%;
  left: 50%;
...
`,ui=m.div.withConfig({shouldForwardProp:e=>"isDark"!==e&&"isVisible"!==e})`
  position: absolute;
  bottom: 100%;
  left: 50%;
...
`,gi=m.div.withConfig({shouldForwardProp:e=>"isActive"!==e})`
  position: absolute;
  top: 50%;
  left: 50%;
  width: 0;
  ...
  ${e=>e.isActive&&"\n    width: 100px;\n    height: 100px;\n  "}
`,fi=({className:t,showTooltip:i=!0})=>{const{mode:a,toggleMode:n,isDark:o}=Ie(),{t:s}=pt(),[l,c]=r.useState(!1),[d,p]=r.useState(!1),m=o?s.common.lightMode:s.common.darkMode;return e.jsxs(ci,{className:t,"data-theme-switcher":!0,onMouseEnter:()=>c(!0),onMouseLeave:()=>c(!1),children:[e.jsxs(di,{isDark:o,onClick:()=>{p(!0),setTimeout(()=>p(!1),600),n()},title:m,"aria-label":m,children:[e.jsx(gi,{isActive:d}),e.jsx(pi,{isVisible:!o,children:e.jsx(mi,{})}),e.jsx(pi,{isVisible:o,children:e.jsx(hi,{})})]}),i&&e.jsx(ui,{isDark:o,isVisible:l,children:m})]})},bi=m.div`
  position: relative;
  display: inline-block;
`,xi=m.button`
...
`,Ti=m.span`
  font-weight: 500;
`,Mi=m.div.withConfig({shouldForwardProp:e=>"isOpen"!==e&&"isDark"!==e})`
  position: absolute;
  bottom: 100%;
  right: 0;
  margin-bottom: 4px;
  ...
  transform: ${e=>e.isOpen?"translateY(0)":"translateY(10px)"};
  transition: all 0.3s ease;
`,Ni=m.button.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  display: flex;
  align-items: center;
  gap: 8px;
  width: 100%;
...
`,_i=({className:t})=>{const{isDark:i}=Ie();Pi=i;const{t:n}=pt(),[o,s]=a.useState(!1),[l,c]=a.useState(!1);function d(e=!0){const t="dark-filter-override",i=document.getElementById(t);if(i&&i.remove(),e){const e=document.createElement("style");e.id=t,e.type="text/css",e.textContent='\n            [data-theme="dark"] body::before {\n                filter: none !important;\n                -webkit-filter: none !important;\n            }\n        ',document.head.appendChild(e),Fi("已禁用深色模式背景滤镜")}else Fi("已恢复深色模式背景滤镜")}r.useEffect(()=>{const e=e=>{e.target.closest("[data-pdf-downloader]")||s(!1)};if(o)return document.addEventListener("click",e),()=>document.removeEventListener("click",e)},[o]),a.useEffect(()=>{const e=e=>{if(e.ctrlKey&&"p"===e.key){Ei("检测到Ctrl+P快捷键，激活标准打印样式"),Li.activatePrintStyle("standard");const e=()=>{Ei("打印对话框关闭，清理打印样式"),Li.deactivatePrintStyle(),window.removeEventListener("afterprint",e)};window.addEventListener("afterprint",e),setTimeout(()=>{Li.isStyleActivated()&&(Ei("备用清理：5秒后自动清理打印样式"),Li.deactivatePrintStyle())},5e3)}};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[]);const p=async e=>{if(!l){c(!0),s(!1);try{Ei(`开始生成${"color"===e?"彩色":"grayscale"===e?"黑白":"原版"}PDF`),"original"===e?(Li.activatePrintStyle("original"),Ei("原版模式：保持在线显示样式")):(Li.activatePrintStyle("standard"),d(!0),Ei(`${e}模式：激活标准打印样式`));const t=document.body.cloneNode(!0);['[data-testid="control-panel"]',"[data-pdf-downloader]",".control-panel",".floating-panel",'[data-testid="font-performance-monitor"]',".font-performance-monitor"].forEach(e=>{t.querySelectorAll(e).forEach(e=>e.remove())}),Ei("准备在当前页面打印，不创建新窗口");const a="temp-pdf-print-style";let r=document.getElementById(a);r&&r.remove();const n=document.createElement("style");n.id=a,n.type="text/css";const o="original"===e?`\n          @media print {\n            /* 基础打印设置 */\n            @page {\n              size: A4;\n              margin: 1cm;\n              background: ${Pi?"#000":"#fff"};\n              background-color: ${Pi?"#000":"#fff"};\n              /* 隐藏页眉页脚 */\n              @top-left { content: none; }\n              @top-center { content: none; }\n              @top-right { content: none; }\n              @bottom-left { content: none; }\n              @bottom-center { content: none; }\n              @bottom-right { content: none; }\n            }\n \n\n            /* 强制打印背景色 */\n            html, body {\n                -webkit-print-color-adjust: exact !important;\n                color-adjust: exact !important;\n                print-color-adjust: exact !important;\n            }\n\n            /* 强制保持所有原有颜色和样式 - 最高优先级 */\n            * {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保HTML根元素保持主题 */\n            html {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保body保持背景色 */\n            body {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 主题样式统一处理 */\n            [data-theme="dark"] {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            [data-theme="light"] {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 深色模式body样式 */\n            [data-theme="dark"] body {\n              background-color: var(--color-background) !important;\n              color: var(--color-text-primary) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 浅色模式body样式 */\n            [data-theme="light"] body {\n              background-color: var(--color-background) !important;\n              color: var(--color-text-primary) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保深色模式的背景伪元素正确显示 */\n            [data-theme="dark"] body::before {\n              content: "" !important;\n              position: fixed !important;\n              top: 0 !important;\n              left: 0 !important;\n              width: 100% !important;\n              height: 100% !important;\n              background-color: var(--color-background) !important;\n              background-image: var(--background-image) !important;\n              background-repeat: repeat !important;\n              background-size: 180px !important;\n              filter: var(--filter-background-dark) !important;\n              z-index: -1 !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 保持所有元素的原有样式 */\n            [data-theme="dark"] * {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保resume-content保持主题样式 - 使用CSS变量 */\n            [data-theme="dark"] [data-testid="resume-content"] {\n              background: var(--color-card) !important;\n              background-color: var(--color-card) !important;\n              color: var(--color-text-primary) !important;\n              border: var(--border-card) !important;\n              box-shadow: var(--shadow-card) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保浅色模式也使用主题样式 */\n            [data-theme="light"] [data-testid="resume-content"] {\n              background: var(--color-card) !important;\n              background-color: var(--color-card) !important;\n              color: var(--color-text-primary) !important;\n              border: var(--border-card) !important;\n              box-shadow: var(--shadow-card) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保所有主题相关元素使用CSS变量 */\n            * {\n              color: var(--color-text-primary) !important;\n              background-color: var(--color-background) !important;\n              border-color: var(--color-border-light) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 卡片元素使用卡片主题 */\n            .card, .resume-card, [class*="card"], [class*="Card"] {\n              background: var(--color-card) !important;\n              background-color: var(--color-card) !important;\n              color: var(--color-text-primary) !important;\n              border: var(--border-card) !important;\n              box-shadow: var(--shadow-card) !important;\n            }\n\n            /* 表面元素使用表面主题 */\n            .surface, [class*="surface"], [class*="Surface"] {\n              background: var(--color-surface) !important;\n              background-color: var(--color-surface) !important;\n              color: var(--color-text-primary) !important;\n            }\n\n            /* 链接元素使用主题颜色 */\n            a, [class*="link"], [class*="Link"] {\n              color: var(--color-primary) !important;\n            }\n\n            /* 标题元素使用主题颜色 */\n            h1, h2, h3, h4, h5, h6 {\n              color: var(--color-text-primary) !important;\n            }\n\n            /* 只隐藏不需要的元素，不改变任何颜色和样式 */\n            .no-print,\n            .print-hide,\n            .control-panel,\n            .floating-controls,\n            nav,\n            .navigation,\n            .tabs,\n            .tab-container,\n            button:not(.skill-item):not([class*="skill"]),\n            [data-testid="control-panel"],\n            [data-testid="development-notice"],\n            [data-pdf-downloader],\n            .pdf-downloader,\n            .control-button,\n            .floating-button,\n            [class*="control"]:not(.skill-item),\n            [class*="floating"]:not(.skill-item),\n            [class*="button"]:not(.skill-item),\n            .fixed,\n            .absolute {\n              display: none !important;\n            }\n\n            /* 确保技能标签正常显示 */\n            .skill-item,\n            [class*="skill"],\n            [class*="Skill"],\n            span[title*="了解"],\n            span[title*="熟练"],\n            span[title*="精通"],\n            span[title*="Basic"],\n            span[title*="Proficient"],\n            span[title*="Expert"],\n            span[title*="Familiar"],\n            span[title*="Experienced"],\n            span[title*="Advanced"] {\n              display: inline-flex !important;\n              visibility: visible !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n          }\n        `:`\n          @media print {\n            /* 确保激活全局打印样式 */\n            body.print-mode-active {\n              /* 页面设置 */\n              @page {\n                size: A4;\n                margin: 1cm;  \n                /* 隐藏页眉页脚 */\n                @top-left { content: none; }\n                @top-center { content: none; }\n                @top-right { content: none; }\n                @bottom-left { content: none; }\n                @bottom-center { content: none; }\n                @bottom-right { content: none; }\n              }\n\n              /* 强制重置深色模式下的所有滤镜效果 */\n              [data-theme="dark"] body::before { \n                filter: none !important;\n                -webkit-filter: none !important;\n              }\n\n              /* 重置根元素和主要容器的背景 */\n              html, body, #root {\n                background: white !important;\n                background-color: white !important;\n                color: black !important;\n                filter: none !important;\n                -webkit-filter: none !important;    \n              }\n\n              /* 确保简历内容区域有白色背景 */\n              [data-testid="resume-content"],\n              .resume-content,\n              .main-content {\n                background: white !important;\n                background-color: white !important;\n                color: black !important;\n                filter: none !important;\n                -webkit-filter: none !important;    \n              }\n\n\n              /* 重置根元素和body */\n              html, body {\n                width: 100% !important;\n                height: auto !important;\n                margin: 0 !important;\n                padding: 20px !important;\n                background: white !important;\n                background-image: none !important;\n                overflow: visible !important;\n                font-size: 12pt !important;\n                line-height: 1.4 !important;\n                color: black !important;  \n                filter: none !important;\n                -webkit-filter: none !important;                  \n              }\n\n              /* 隐藏深色模式背景伪元素 */\n              [data-theme="dark"] body::before {\n                display: none !important;\n                filter: none !important;\n                -webkit-filter: none !important;    \n              }\n\n              /* 根元素打印优化 */\n              #root {\n                display: block !important;\n                width: 100% !important;\n                max-width: none !important;\n                margin: 0 !important;\n                padding: 0 !important;\n                background: white !important;\n                overflow: visible !important;\n              }\n\n              /* 隐藏不需要打印的元素 - 扩展选择器 */\n              .no-print,\n              .print-hide,\n              button:not(.skill-item):not([class*="skill"]),\n              .control-panel,\n              .floating-controls,\n              .floating-button,\n              .control-button,\n              nav,\n              .navigation,\n              .tabs,\n              .tab-container,\n              [data-testid="control-panel"],\n              [data-testid="development-notice"],\n              [data-pdf-downloader],\n              .pdf-downloader,\n              [class*="control"]:not(.skill-item):not(.category-item),\n              [class*="floating"]:not(.skill-item):not(.category-item),\n              [class*="button"]:not(.skill-item):not(.category-item),\n              [class*="Panel"],\n              [class*="Switcher"],\n              [class*="Downloader"],\n              .fixed,\n              .absolute {\n                display: none !important;\n                visibility: hidden !important;\n              }\n\n              /* 确保文本内容为黑色，但保持透明背景 */\n              p, h1, h2, h3, h4, h5, h6, li, td, th, span:not(.skill-item span), div:not(.skill-item) {\n                color: black !important;\n                /* 不强制设置背景色，保持透明 */\n              }\n\n              /* 保留技能标签的样式和颜色 */\n              .skill-item,\n              [class*="skill"],\n              [class*="Skill"],\n              span[title*="了解"],\n              span[title*="熟练"],\n              span[title*="精通"],\n              span[title*="Basic"],\n              span[title*="Proficient"],\n              span[title*="Expert"],\n              span[title*="Familiar"],\n              span[title*="Experienced"],\n              span[title*="Advanced"] {\n                background: initial !important;\n                color: initial !important;\n                -webkit-print-color-adjust: exact !important;\n                color-adjust: exact !important;\n                print-color-adjust: exact !important;\n              }\n\n              /* 技能标签内的文字保持渐变色 */\n              .skill-item span,\n              [class*="skill"] span,\n              [class*="Skill"] span {\n                background-clip: text !important;\n                -webkit-background-clip: text !important;\n                color: transparent !important;\n                background-image: inherit !important;\n                -webkit-print-color-adjust: exact !important;\n                color-adjust: exact !important;\n                print-color-adjust: exact !important;\n              }\n\n              /* 链接样式 */\n              a {\n                color: black !important;\n                text-decoration: underline !important;\n              }\n\n              /* 分页控制 */\n              .page-break-before {\n                page-break-before: always;\n              }\n\n              .page-break-after {\n                page-break-after: always;\n              }\n\n              .page-break-inside-avoid {\n                page-break-inside: avoid;\n              }\n\n              /* 黑白模式特殊处理 */\n              ${"grayscale"===e?"\n                * {\n                  filter: grayscale(100%) !important;\n                  -webkit-filter: grayscale(100%) !important;\n                }\n              ":""}\n              /* 强制重置深色模式下的所有滤镜效果 */\n                [data-theme="dark"] * {\n                  filter: none !important;\n                  -webkit-filter: none !important;\n                }\n            }\n\n            /* 调试信息 */\n            .pdf-debug-info {\n              position: fixed;\n              top: 10px;\n              right: 10px;\n              background: rgba(255,255,255,0.9) !important;\n              color: blue !important;\n              padding: 5px !important;\n              border: 2px solid blue !important;\n              z-index: 9999 !important;\n              font-size: 14px !important;\n              font-weight: bold !important;\n            }\n          }\n        `;n.textContent=o,document.head.appendChild(n),await new Promise(e=>setTimeout(e,300));const s=navigator.userAgent,l=s.includes("Chrome"),c=s.includes("Firefox"),p=s.includes("Edge")||s.includes("Edg/"),m=s.includes("Safari")&&!l&&!p,h="localhost"!==window.location.hostname&&"127.0.0.1"!==window.location.hostname&&!window.location.hostname.includes("dev");if(Ei(`浏览器检测: Chrome=${l}, Firefox=${c}, Edge=${p}, Safari=${m}, Production=${h}`),"original"===e){if(Ei("原版PDF模式：应用兼容性处理"),h||l||p){if(Ei("生产环境或Chrome/Edge浏览器：强制隐藏控制面板"),['[data-testid="control-panel"]',".control-panel",".floating-panel","[data-pdf-downloader]",".pdf-downloader",'[data-testid="font-performance-monitor"]',".font-performance-monitor",".fixed",".absolute"].forEach(e=>{document.querySelectorAll(e).forEach(e=>{e.style.cssText+="\n              display: none !important;\n              visibility: hidden !important;\n              opacity: 0 !important;\n              position: absolute !important;\n              left: -9999px !important;\n              top: -9999px !important;\n              width: 0 !important;\n              height: 0 !important;\n              overflow: hidden !important;\n              z-index: -9999 !important;\n            "})}),l){Ei("Chrome浏览器：应用Chrome特定兼容性处理");const e=document.createElement("style");e.id="chrome-original-pdf-fix",e.textContent=`\n            @media print {\n              /* Chrome原版PDF特定修复 */\n              body {\n                -webkit-print-color-adjust: exact !important;\n                print-color-adjust: exact !important;\n              }\n\n              /* 确保主题变量在Chrome中正确应用 */\n              :root {\n                color-scheme: ${i?"dark":"light"} !important;\n              }\n\n              /* Chrome中的背景图片处理 */\n              [data-theme="dark"] body::before {\n                -webkit-print-color-adjust: exact !important;\n                print-color-adjust: exact !important;\n              }\n            }\n          `,document.head.appendChild(e)}if(c){Ei("Firefox浏览器：应用Firefox特定兼容性处理");const e=document.createElement("style");e.id="firefox-original-pdf-fix",e.textContent="\n            @media print {\n              /* Firefox原版PDF特定修复 */\n              body {\n                color-adjust: exact !important;\n              }\n\n              /* Firefox中的CSS变量处理 */\n              * {\n                color-adjust: exact !important;\n              }\n            }\n          ",document.head.appendChild(e)}if(p){Ei("Edge浏览器：应用Edge特定兼容性处理");const e=document.createElement("style");e.id="edge-original-pdf-fix",e.textContent="\n            @media print {\n              /* Edge原版PDF特定修复 */\n              body {\n                -webkit-print-color-adjust: exact !important;\n                print-color-adjust: exact !important;\n                color-adjust: exact !important;\n              }\n            }\n          ",document.head.appendChild(e)}if(m){Ei("Safari浏览器：应用Safari特定兼容性处理");const e=document.createElement("style");e.id="safari-original-pdf-fix",e.textContent='\n            @media print {\n              /* Safari原版PDF特定修复 */\n              body {\n                -webkit-print-color-adjust: exact !important;\n              }\n\n              /* Safari中的背景处理 */\n              [data-theme="dark"] body::before {\n                -webkit-print-color-adjust: exact !important;\n              }\n            }\n          ',document.head.appendChild(e)}await new Promise(e=>setTimeout(e,200)),Ei("兼容性处理完成")}else Ei("本地环境或其他浏览器：跳过特殊兼容性处理");const e=document.createElement("style");e.id="universal-print-fix-style",e.type="text/css",e.textContent='\n          @media print {\n            /* 强制隐藏所有控制面板相关元素 */\n            [data-testid="control-panel"],\n            .control-panel,\n            .floating-panel,\n            [data-pdf-downloader],\n            .pdf-downloader,\n            .fixed,\n            .absolute,\n            button:not(.skill-item):not([class*="skill"]),\n            .control-button,\n            .floating-button,\n            [class*="control"]:not(.skill-item):not(.category-item),\n            [class*="floating"]:not(.skill-item):not(.category-item),\n            [class*="button"]:not(.skill-item):not(.category-item),\n            [class*="Panel"],\n            [class*="Switcher"],\n            [class*="Downloader"] {\n              display: none !important;\n              visibility: hidden !important;\n              opacity: 0 !important;\n              position: absolute !important;\n              left: -9999px !important;\n              top: -9999px !important;\n              width: 0 !important;\n              height: 0 !important;\n              overflow: hidden !important;\n              z-index: -9999 !important;\n              pointer-events: none !important;\n            }\n            \n            /* 确保body和html正常显示 */\n            body, html {\n              display: block !important;\n              visibility: visible !important;\n              opacity: 1 !important;\n              position: relative !important;\n              left: auto !important;\n              top: auto !important;\n              width: auto !important;\n              height: auto !important;\n              overflow: visible !important;\n              z-index: auto !important;\n            }\n\n            /* 跨浏览器兼容性：颜色打印支持 */\n            * {\n              -webkit-print-color-adjust: exact !important;\n              print-color-adjust: exact !important;\n              color-adjust: exact !important;\n            }\n\n            /* 确保主题样式在所有浏览器中正确应用 */\n            body {\n              background: var(--color-background) !important;\n              color: var(--color-text-primary) !important;\n            }\n\n            /* 确保卡片样式在所有浏览器中正确应用 */\n            [data-testid="resume-content"] {\n              background: var(--color-card) !important;\n              color: var(--color-text-primary) !important;\n              border: var(--border-card) !important;\n            }\n\n            /* 字体性能监控面板隐藏 */\n            [data-testid="font-performance-monitor"],\n            .font-performance-monitor {\n              display: none !important;\n              visibility: hidden !important;\n              opacity: 0 !important;\n            }\n            \n            /* 确保简历内容正常显示 */\n            [data-testid="resume-content"],\n            .resume-content,\n            .main-content {\n              display: block !important;\n              visibility: visible !important;\n              opacity: 1 !important;\n              position: relative !important;\n              left: auto !important;\n              top: auto !important;\n              width: auto !important;\n              height: auto !important;\n              overflow: visible !important;\n              z-index: auto !important;\n            }\n          }\n        ',document.head.appendChild(e),await new Promise(e=>setTimeout(e,300)),document.body.style.display="none",document.body.offsetHeight,document.body.style.display=""}const u="color"===e?"彩色版":"grayscale"===e?"黑白版":"原版";Ei(`开始打印${u}`),window.print(),d(!1),setTimeout(()=>{const e=document.getElementById(a);e&&e.remove(),Ei("已清理临时打印样式")},1e3),Ei(`${u}PDF生成完成`)}catch(t){Ei("PDF生成失败:",t),alert(`${n.common?.pdfGenerationFailed||"PDF generation failed"}: ${t instanceof Error?t.message:n.common?.unknownError||"Unknown error"}`)}finally{Li.deactivatePrintStyle(),c(!1),d(!1),Ei("PDF生成流程结束，已清理打印样式")}}};return e.jsxs($i,{className:t,"data-testid":"pdf-downloader","data-pdf-downloader":!0,children:[e.jsxs(zi,{isDark:i,onClick:()=>s(!o),disabled:l,title:n.common?.downloadPDF||"Download PDF","aria-label":n.common?.downloadPDF||"Download PDF",children:[e.jsx(Ii,{children:l?e.jsx(Ai,{}):"📄"}),e.jsx(Ti,{children:l?n.common?.generating||"Generating...":"PDF"}),!l&&e.jsx("span",{style:{transform:o?"rotate(0deg)":"rotate(180deg)",transition:"transform 0.3s ease",fontSize:"12px"},children:"▲"})]}),e.jsxs(Mi,{isOpen:o&&!l,isDark:i,children:[e.jsxs(Ni,{isDark:i,onClick:()=>p("original"),disabled:l,children:[e.jsx("span",{children:"📱"}),e.jsx("span",{children:n.common?.originalPDF||"Original PDF"})]}),e.jsxs(Ni,{isDark:i,onClick:()=>p("color"),disabled:l,children:[e.jsx("span",{children:"🎨"}),e.jsx("span",{children:n.common?.colorPDF||"Color PDF"})]}),e.jsxs(Ni,{isDark:i,onClick:()=>p("grayscale"),disabled:l,children:[e.jsx("span",{children:"⚫"}),e.jsx("span",{children:n.common?.grayscalePDF||"Grayscale PDF"})]})]})]})},Ri=m.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 8px 12px;
  ...
  backdrop-filter: blur(10px);
  transition: all 0.3s ease;
`,Oi=m.button.withConfig({shouldForwardProp:e=>"isDark"!==e&&"active"!==e})`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,Bi=m.input.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  width: 60px;
  height: 4px;
...
`,Ui=m.span.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  font-size: 12px;
  color: ${e=>e.isDark?"#e2e8f0":"#2c3e50"};
  white-space: nowrap;
`,Gi=({className:t})=>{const{isDark:i}=Ie(),{t:r}=pt(),[n,o]=a.useState(()=>{try{const e=localStorage.getItem("audioEnabled");return null===e||JSON.parse(e)}catch{return!0}}),[s,l]=a.useState(()=>{try{const e=localStorage.getItem("audioVolume");return null!==e?parseFloat(e):.7}catch{return.7}});return a.useEffect(()=>{Ke.setEnabled(n),Ke.setGlobalVolume(s,s)},[n,s]),a.useEffect(()=>{try{localStorage.setItem("audioEnabled",JSON.stringify(n))}catch(e){}},[n]),a.useEffect(()=>{try{localStorage.setItem("audioVolume",s.toString())}catch(e){}},[s]),e.jsxs(Ri,{isDark:i,className:t,children:[n&&e.jsxs(e.Fragment,{children:[e.jsx(Ui,{isDark:i,children:"音量"}),e.jsx(Bi,{isDark:i,type:"range",min:"0",max:"1",step:"0.1",value:s,onChange:e=>{const t=parseFloat(e.target.value);l(t)},title:`音量: ${Math.round(100*s)}%`})]}),e.jsx(Oi,{isDark:i,active:n,onClick:async()=>{const e=!n;o(e),await Ke.setEnabled(e)},title:n?"关闭音效":"开启音效",children:n?"🔊":"🔇"})]})},Hi=m.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  position: fixed;
  bottom: 20px;
  right: 20px;
  display: flex;
...
`,Ki=m.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  width: 1px;
  height: 24px;
  background: var(--color-border-light);
  transition: background 0.3s ease;
...
`;const Vi=m.div.withConfig({shouldForwardProp:e=>"isCollapsed"!==e&&"isDark"!==e})`
  position: fixed;
  bottom: 20px;
  right: 20px;
  z-index: 1000;
...
`,Wi=m.button.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 48px;
...
`,Zi=m.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  position: absolute;
  bottom: 100%;
  right: 0;
  margin-bottom: 12px;
