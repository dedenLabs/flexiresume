...
`,Se=S("PerformanceMonitor"),De=new class{metrics={};observers=[];constructor(){this.init()}init(){this.observeNavigation(),this.observeWebVitals(),this.observeResources(),this.setupReporting()}observeNavigation(){if("PerformanceObserver"in window){const e=new PerformanceObserver(e=>{for(const t of e.getEntries())if("navigation"===t.entryType){const e=t;this.metrics.TTFB=e.responseStart-e.requestStart,this.metrics.pageLoadTime=e.loadEventEnd-e.navigationStart,Se("Navigation metrics:",{TTFB:this.metrics.TTFB,pageLoadTime:this.metrics.pageLoadTime})}});e.observe({entryTypes:["navigation"]}),this.observers.push(e)}}observeWebVitals(){this.observeLCP(),this.observeFID(),this.observeCLS(),this.observeFCP()}observeLCP(){if("PerformanceObserver"in window){const e=new PerformanceObserver(e=>{const t=e.getEntries(),a=t[t.length-1];this.metrics.LCP=a.startTime,Se("LCP:",this.metrics.LCP)});e.observe({entryTypes:["largest-contentful-paint"]}),this.observers.push(e)}}observeFID(){if("PerformanceObserver"in window){const e=new PerformanceObserver(e=>{for(const t of e.getEntries())if("first-input"===t.entryType){const e=t;this.metrics.FID=e.processingStart-e.startTime,Se("FID:",this.metrics.FID)}});e.observe({entryTypes:["first-input"]}),this.observers.push(e)}}observeCLS(){if("PerformanceObserver"in window){let e=0;const t=new PerformanceObserver(t=>{for(const a of t.getEntries())"layout-shift"!==a.entryType||a.hadRecentInput||(e+=a.value);this.metrics.CLS=e,Se("CLS:",this.metrics.CLS)});t.observe({entryTypes:["layout-shift"]}),this.observers.push(t)}}observeFCP(){if("PerformanceObserver"in window){const e=new PerformanceObserver(e=>{for(const t of e.getEntries())"first-contentful-paint"===t.name&&(this.metrics.FCP=t.startTime,Se("FCP:",this.metrics.FCP))});e.observe({entryTypes:["paint"]}),this.observers.push(e)}}observeResources(){if("PerformanceObserver"in window){const e=new PerformanceObserver(e=>{for(const t of e.getEntries())if("resource"===t.entryType){const e=t,a=e.responseEnd-e.startTime;a>1e3&&Se("Slow resource:",{name:e.name,loadTime:a,size:e.transferSize})}});e.observe({entryTypes:["resource"]}),this.observers.push(e)}}setupReporting(){document.addEventListener("visibilitychange",()=>{"hidden"===document.visibilityState&&this.reportMetrics()}),window.addEventListener("beforeunload",()=>{this.reportMetrics()})}reportMetrics(){Se("Performance Metrics:",this.metrics),navigator.sendBeacon&&JSON.stringify({url:window.location.href,timestamp:Date.now(),metrics:this.metrics,userAgent:navigator.userAgent})}recordCustomMetric(e,t){this.metrics[e]=t,Se(`Custom metric ${e}:`,t)}recordComponentMetric(e,t,a){switch(this.metrics.componentMetrics||(this.metrics.componentMetrics={}),this.metrics.componentMetrics[e]||(this.metrics.componentMetrics[e]={renderTime:0,mountTime:0,updateTime:0}),t){case"render":this.metrics.componentMetrics[e].renderTime=a;break;case"mount":this.metrics.componentMetrics[e].mountTime=a;break;case"update":this.metrics.componentMetrics[e].updateTime=a}Se(`Component ${e} ${t} time:`,a)}recordDataLoadTime(e,t){this.metrics.dataLoadTime=t,Se(`Data load time for ${e}:`,t)}recordSkeletonDisplayTime(e){this.metrics.skeletonDisplayTime=e,Se("Skeleton display time:",e)}recordRouteChangeTime(e,t,a){this.metrics.routeChangeTime=a,Se(`Route change from ${e} to ${t}:`,a)}recordThemeChangeTime(e,t,a){this.metrics.themeChangeTime=a,Se(`Theme change from ${e} to ${t}:`,a)}recordLanguageChangeTime(e,t,a){this.metrics.languageChangeTime=a,Se(`Language change from ${e} to ${t}:`,a)}recordMemoryUsage(){if("memory"in performance){const e=performance.memory;this.metrics.memoryUsage=e.usedJSHeapSize,Se("Memory usage:",{used:e.usedJSHeapSize,total:e.totalJSHeapSize,limit:e.jsHeapSizeLimit})}}getMetrics(){return{...this.metrics}}getPerformanceScore(){const e=this.getMetrics();let t=100;const a={};return e.LCP&&(e.LCP>4e3?(t-=30,a.LCP="Poor"):e.LCP>2500?(t-=15,a.LCP="Needs Improvement"):a.LCP="Good"),e.FID&&(e.FID>300?(t-=25,a.FID="Poor"):e.FID>100?(t-=10,a.FID="Needs Improvement"):a.FID="Good"),e.CLS&&(e.CLS>.25?(t-=20,a.CLS="Poor"):e.CLS>.1?(t-=10,a.CLS="Needs Improvement"):a.CLS="Good"),e.dataLoadTime&&(e.dataLoadTime>2e3?(t-=15,a.dataLoad="Slow"):e.dataLoadTime>1e3?(t-=5,a.dataLoad="Moderate"):a.dataLoad="Fast"),{score:Math.max(0,t),details:a}}cleanup(){this.observers.forEach(e=>e.disconnect()),this.observers=[]}},Fe=(e,t,a)=>{De.recordComponentMetric(e,t,a)},je=(e,t)=>{De.recordDataLoadTime(e,t)},Pe=e=>{De.recordSkeletonDisplayTime(e)},Ee=(e,t,a)=>{De.recordRouteChangeTime(e,t,a)},Le=()=>{const e=getComputedStyle(document.documentElement);return{primary:e.getPropertyValue("--color-primary").trim(),secondary:e.getPropertyValue("--color-secondary").trim(),accent:e.getPropertyValue("--color-accent").trim(),background:e.getPropertyValue("--color-background").trim(),surface:e.getPropertyValue("--color-surface").trim(),card:e.getPropertyValue("--color-card").trim(),text:{primary:e.getPropertyValue("--color-text-primary").trim(),secondary:e.getPropertyValue("--color-text-secondary").trim(),disabled:e.getPropertyValue("--color-text-disabled").trim(),inverse:e.getPropertyValue("--color-text-inverse").trim()},border:{light:e.getPropertyValue("--color-border-light").trim(),medium:e.getPropertyValue("--color-border-medium").trim(),dark:e.getPropertyValue("--color-border-dark").trim()},status:{success:e.getPropertyValue("--color-status-success").trim(),warning:e.getPropertyValue("--color-status-warning").trim(),error:e.getPropertyValue("--color-status-error").trim(),info:e.getPropertyValue("--color-status-info").trim()},shadow:{light:e.getPropertyValue("--color-shadow-light").trim(),medium:e.getPropertyValue("--color-shadow-medium").trim(),dark:e.getPropertyValue("--color-shadow-dark").trim()},filters:{backgroundLight:e.getPropertyValue("--filter-background-light").trim(),backgroundDark:e.getPropertyValue("--filter-background-dark").trim(),linkIconLight:e.getPropertyValue("--filter-link-icon-light").trim(),linkIconDark:e.getPropertyValue("--filter-link-icon-dark").trim()}}},$e=i.createContext(void 0),Ie=({children:t})=>{const[a,r]=i.useState(()=>{const e=localStorage.getItem("theme");return!e||"light"!==e&&"dark"!==e?window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}),[,n]=i.useState({});i.useEffect(()=>{localStorage.setItem("theme",a),document.documentElement.setAttribute("data-theme",a),setTimeout(()=>{n({});const e=document.querySelector('meta[name="theme-color"]');if(e){const t=getComputedStyle(document.documentElement).getPropertyValue("--color-background").trim();e.setAttribute("content",t)}},0)},[a]),i.useEffect(()=>{const e=window.matchMedia("(prefers-color-scheme: dark)"),t=e=>{localStorage.getItem("theme")||r(e.matches?"dark":"light")};return e.addEventListener("change",t),()=>e.removeEventListener("change",t)},[]);const o={mode:a,setMode:r,toggleMode:()=>{const e=performance.now(),t=a;r(a=>{const i="light"===a?"dark":"light";return setTimeout(()=>{const a=performance.now()-e;((e,t,a)=>{De.recordThemeChangeTime(e,t,a)})(t,i,a)},0),i})},colors:Le(),isDark:"dark"===a};return e.jsx($e.Provider,{value:o,children:t})},ze=()=>{const e=i.useContext($e);if(!e)throw new Error("useTheme must be used within a ThemeProvider");return e};let Te=[...Array(4).fill().map((e,t)=>`tangseng-${String(t+1).padStart(2,"0")}`),...Array(10).fill().map((e,t)=>`wukong-${String(t+1).padStart(2,"0")}`),...Array(9).fill().map((e,t)=>`bajie-${String(t+1).padStart(2,"0")}`),...Array(1).fill().map((e,t)=>`wujing-${String(t+1).padStart(2,"0")}`)],Me=[...Array(6).fill().map((e,t)=>`${String(t+1).padStart(2,"0")}`)];var Ne=(e=>(e.BGM="bgm",e.SFX="sfx",e))(Ne||{});const Ae=Te.map(e=>({id:e,name:e.split("-")[0],type:"sfx",file:`./audio/xiyouji/${e}.mp3`,volume:.8,loop:!1,preload:!0,autoplay:!1,description:"角色语音",quote:e})),_e=Me.map(e=>({id:e,name:e.split("-")[0],type:"bgm",file:`./audio/xiyouji/bgm/${e}.mp3`,volume:.8,loop:!1,preload:!1,autoplay:!0,description:"背景音乐",quote:e})),Re=[{tabPath:"/xuanzang",tabName:"唐僧·陈玄奘",bgmList:Me,sfxList:Te.filter(e=>e.startsWith("tangseng")),characterId:"xuanzang"},{tabPath:"/wukong",tabName:"齐天大圣·孙悟空",bgmList:Me,sfxList:Te.filter(e=>e.startsWith("wukong")),characterId:"wukong"},{tabPath:"/bajie",tabName:"天蓬元帅·猪八戒",bgmList:Me,sfxList:Te.filter(e=>e.startsWith("bajie")),characterId:"bajie"},{tabPath:"/wujing",tabName:"卷帘大将·沙悟净",bgmList:Me,sfxList:Te.filter(e=>e.startsWith("wujing")),characterId:"wujing"}],Oe={enabled:!0,bgmVolume:.3,sfxVolume:.7,requireUserInteraction:!0,fadeInDuration:1e3,fadeOutDuration:800,crossfadeDuration:1500};function Be(){return[...Ae,..._e]}function Ue(e){return Be().find(t=>t.id===e)}function Ge(e){return Re.find(t=>t.tabPath===e)}const He=S("EnhancedAudioPlayer"),Ke=new class{audioCache=new Map;playbackStates=new Map;currentBGM=null;bgmPlaylist=[];bgmCurrentIndex=0;settings={...Oe};constructor(){this.initializePlayer()}async initializePlayer(){this.setupUserInteractionListener(),await this.preloadAudio()}setupUserInteractionListener(){this.playCurrentTabAudioRandomly();const e=()=>{this.settings.requireUserInteraction&&(window.userInteracted=!0,He("🎵 用户首次交互，音频播放已启用"),this.playBGM(this.getCurrentBGM()),document.removeEventListener("click",e),document.removeEventListener("keydown",e),document.removeEventListener("touchstart",e))};document.addEventListener("click",e),document.addEventListener("keydown",e),document.addEventListener("touchstart",e)}async preloadAudio(){const e=Be().filter(e=>e.preload);for(const t of e)t.preload&&this.loadAudio(t)}async loadAudio(e){try{const t=new Audio(e.file);t.volume=e.volume,t.loop=e.loop,t.preload="auto",this.setupAudioEventListeners(t,e),this.audioCache.set(e.id,t),this.playbackStates.set(e.id,{isPlaying:!1,currentTime:0,duration:0,volume:e.volume,loop:e.loop})}catch(t){He.extend("warn")(`⚠️ ${e.name} 预加载失败:`,t)}}setupAudioEventListeners(e,t){e.addEventListener("loadedmetadata",()=>{const a=this.playbackStates.get(t.id);a&&(a.duration=e.duration)}),e.addEventListener("timeupdate",()=>{const a=this.playbackStates.get(t.id);a&&(a.currentTime=e.currentTime)}),e.addEventListener("ended",()=>{this.handleAudioEnded(t)}),e.addEventListener("error",e=>{He.extend("warn")(`⚠️ ${t.name} 播放错误:`,e)})}async handleAudioEnded(e){const t=this.playbackStates.get(e.id);t&&(t.isPlaying=!1),e.type===Ne.BGM&&(this.bgmPlaylist.length>1?await this.playNextBGM():1===this.bgmPlaylist.length&&setTimeout(async()=>{await this.playBGM(this.bgmPlaylist[0])},500))}async playNextBGM(){if(0===this.bgmPlaylist.length)return;if(this.currentBGM){const e=this.audioCache.get(this.currentBGM);if(e){e.pause(),e.currentTime=0;const t=this.playbackStates.get(this.currentBGM);t&&(t.isPlaying=!1)}}this.bgmCurrentIndex=(this.bgmCurrentIndex+1)%this.bgmPlaylist.length;const e=this.bgmPlaylist[this.bgmCurrentIndex];setTimeout(async()=>{await this.playBGM(e)},500)}async playBGM(e){if(!this.canPlay())return;const t=Ue(e);if(!t||t.type!==Ne.BGM)return void He.extend("warn")(`⚠️ BGM ${e} 配置不存在或类型错误`);if(this.currentBGM===e){const a=this.audioCache.get(e),i=this.playbackStates.get(e);if(a&&i&&i.isPlaying&&!a.paused)return void He(`🎵 BGM ${t.name} 已在播放，跳过重复播放`)}if(this.currentBGM&&this.currentBGM!==e){const e=this.audioCache.get(this.currentBGM);if(e){e.pause(),e.currentTime=0;const t=this.playbackStates.get(this.currentBGM);t&&(t.isPlaying=!1)}}if(!this.audioCache.get(e)&&(He.extend("warn")(`⚠️ BGM ${e} 音频未加载`),await this.loadAudio(t),!this.audioCache.get(e)))return void He.extend("warn")(`⚠️ BGM ${e} 加载失败`);const a=this.audioCache.get(e);try{a.pause(),a.currentTime=0,a.volume=0,this.currentBGM=e,await a.play(),await this.fadeIn(e);const i=this.playbackStates.get(e);i&&(i.isPlaying=!0),He(`🎵 播放BGM: ${t.name}`)}catch(i){He.extend("warn")(`⚠️ 播放BGM ${e} 失败:`,i)}}async playSFX(e){if(!this.canPlay())return;const t=Ue(e);if(!t||t.type!==Ne.SFX)return;const a=this.audioCache.get(e);a||this.loadAudio(t);try{a.currentTime=0,a.volume=t.volume*this.settings.sfxVolume,await a.play();const i=this.playbackStates.get(e);i&&(i.isPlaying=!0),He(`🎵 播放SFX: ${t.name} - "${t.quote||""}"`)}catch(i){}}async switchToTab(e){const t=Ge(e);if(t){if(this.bgmPlaylist=t.bgmList,this.bgmCurrentIndex=0,this.bgmPlaylist.length>0){const e=this.bgmPlaylist[0];if(this.currentBGM===e){const t=this.audioCache.get(e),a=this.playbackStates.get(e);t&&a&&a.isPlaying&&!t.paused||await this.playBGM(e)}else await this.playBGM(e)}t.sfxList.length>0&&this.canPlay()&&setTimeout(()=>{this.playSFX(t.sfxList[0])},1e3)}else He(`⚠️ 页签 ${e} 没有音频配置`)}async switchToTabRandomly(e){const t=Ge(e);if(t){if(this.bgmPlaylist=t.bgmList,this.bgmPlaylist.length>0){const e=this.getRandomElement(this.bgmPlaylist);e&&(this.bgmCurrentIndex=this.bgmPlaylist.indexOf(e),await this.playBGM(e),He(`🎲 随机选择BGM: ${e}`))}this.playRandomSFXForTab(t)}}playRandomSFXForTab(e){if(e.sfxList.length>0&&this.canPlay()){const t=this.getRandomElement(e.sfxList);t&&setTimeout(()=>{this.playSFX(t)},1e3)}else e.sfxList.length,this.canPlay()}canPlay(){return!!this.settings.enabled||(He("🔇 音频播放已禁用"),!1)}async fadeIn(e){const t=this.audioCache.get(e),a=Ue(e);if(!t||!a)return;const i=a.volume*(a.type===Ne.BGM?this.settings.bgmVolume:this.settings.sfxVolume),r=this.settings.fadeInDuration/20,n=i/20;for(let o=0;o<=20;o++)t.volume=n*o,await new Promise(e=>setTimeout(e,r))}async fadeOut(e){const t=this.audioCache.get(e);if(!t)return;const a=t.volume,i=this.settings.fadeOutDuration/20,r=a/20;if(0===a){t.pause(),t.currentTime=0;const a=this.playbackStates.get(e);return void(a&&(a.isPlaying=!1))}for(let o=20;o>=0;o--)t.volume=r*o,await new Promise(e=>setTimeout(e,i));t.pause(),t.currentTime=0;const n=this.playbackStates.get(e);n&&(n.isPlaying=!1)}stopAll(){this.stopAllBGM(),this.stopAllSFX()}stopAllSFX(){this.stopAudio(Ne.SFX)}stopAllBGM(){this.stopAudio(Ne.BGM)}stopAudio(e){this.audioCache.forEach((t,a)=>{const i=Ue(a);if(i&&i.type===e){t.pause(),t.currentTime=0;const e=this.playbackStates.get(a);e&&(e.isPlaying=!1)}}),e===Ne.BGM?(this.currentBGM=null,He("🔇 停止所有背景音乐播放")):He("🔇 停止所有音效播放")}setGlobalVolume(e,t){this.settings.bgmVolume=Math.max(0,Math.min(1,e)),this.settings.sfxVolume=Math.max(0,Math.min(1,t)),this.audioCache.forEach((e,t)=>{const a=Ue(t);if(a){const t=a.type===Ne.BGM?this.settings.bgmVolume:this.settings.sfxVolume;e.volume=a.volume*t}})}async setEnabled(e){const t=this.settings.enabled;this.settings.enabled=e,e?e&&!t&&await this.playCurrentTabAudioRandomly():this.stopAll(),He("🎵 音频播放"+(e?"启用":"禁用"))}async playCurrentTabAudioRandomly(){const e=window.location.pathname;e&&"/"!==e&&await this.switchToTabRandomly(e)}getRandomElement(e){if(0!==e.length)return e[Math.floor(Math.random()*e.length)]}getPlaybackState(e){return this.playbackStates.get(e)}getCurrentBGM(){return this.currentBGM}cleanup(){this.stopAll(),this.audioCache.forEach((e,t)=>{e.remove()}),this.audioCache.clear(),this.playbackStates.clear(),this.currentBGM=null,this.bgmPlaylist=[],this.bgmCurrentIndex=0,He("🧹 音频播放器已清理")}getDebugInfo(){const e=[];return this.audioCache.forEach((t,a)=>{const i=this.playbackStates.get(a);i&&i.isPlaying&&!t.paused&&e.push(a)}),{currentBGM:this.currentBGM,bgmPlaylist:this.bgmPlaylist,bgmCurrentIndex:this.bgmCurrentIndex,playingAudios:e,totalCachedAudios:this.audioCache.size,enabled:this.settings.enabled}}},Ve=S("Tabs"),We="#aaa",Ze="920px",Ye=p.nav.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  /* 移动端样式 - 修复横向溢出问题 */
...
`,et=()=>{const t=C.data,a=C.tabs,{isDark:r}=ze(),n=h(),o=u(),s=i.useCallback(async e=>{const t=`preload-${e}`;if(!Q.has(t))try{e.replace("/",""),Q.set(t,!0)}catch(a){}},[]),l=i.useCallback(e=>{const t=setTimeout(()=>{s(e)},200);return()=>clearTimeout(t)},[s]),c=i.useCallback(async(e,t)=>{t.preventDefault(),o(e),setTimeout(async()=>{try{Ke.settings.requireUserInteraction=!1,Ke.stopAll(),await Ke.switchToTabRandomly(e)}catch(t){}},0)},[o]);return i.useEffect(()=>{if(!a.length)return void(document.title=t?.header_info?.position||"My Resume");const e=function(e){const t=C.data,a=C.tabs,i=e.pathname,r=a.find(([,e])=>e===i);return r?r[0]:t?.header_info?.position||""}(n),i=Object.assign({},t?.header_info),r=function(e,t){if(!t)return t?.position||"My Resume";const a=e.replace(/{(position|name|age|location)}/g,(e,a)=>t[a]||""),i=a.replace(/[-\s]+/g," ").trim();return i&&"-"!==i&&"--"!==i&&"---"!==i?a:t?.position||t?.name||"My Resume"}(t?.header_info?.resume_name_format||"{position}-{name}-{age}-{location}",i),o=r&&r.trim()?r:e||t?.header_info?.position||"My Resume";document.title=o},[n,t,a.length]),a.length?e.jsx(Ye,{"data-testid":"navigation-tabs",isDark:r,children:a.map(([a,i,n,o],s)=>{const d=(e=>{const a=e.replace("/",""),i=t?.expected_positions?.[a];return i?.header_info})(i),m=d?.name||a,p=d?.avatar||o;return e.jsx(Xe,{className:"no-link-icon",to:i,isDark:r,onMouseEnter:()=>l(i),onClick:e=>{c(i,e)},children:e.jsxs(Qe,{children:[p&&e.jsx(Je,{src:p,alt:m,onError:e=>{Ve.extend("error")("Avatar load error:",p,e),e.currentTarget.style.display="none"},onLoad:()=>{Ve("Avatar loaded successfully:",p)}}),e.jsx(qe,{children:a})]})},i)})}):null};function tt(e){return w({attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0z"},child:[]},{tag:"path",attr:{d:"M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"},child:[]}]})(e)}const at=p.div`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
...
`,Dt=p.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  ...
  font-size: 12px;
  color: ${e=>e.isDark?"var(--color-text-secondary)":"#666"};
`;class Ft extends i.Component{networkStatusUnsubscribe;constructor(e){super(e),this.state={hasError:!1,retryCount:0,isRetrying:!1}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,t){const a=function(e){const t=e.message.toLowerCase();return t.includes("network")||t.includes("fetch")||t.includes("timeout")||"TypeError"===e.name&&t.includes("failed to fetch")?"network":t.includes("chunk")||t.includes("loading")||t.includes("import")?"chunk":"runtime"}(e),i=ft(),r={type:a,message:e.message,stack:e.stack,componentStack:t.componentStack,timestamp:Date.now(),userAgent:navigator.userAgent,url:window.location.href,networkStatus:i,retryCount:this.state.retryCount};var n;this.setState({error:e,errorInfo:t,errorDetails:r}),this.props.onError?.(r),B()&&(bt("EnhancedErrorBoundary caught an error:",e,t),bt("Error details:",r)),this.networkStatusUnsubscribe=(n=e=>{e.isOnline&&this.state.hasError&&bt("Network recovered, user can retry")},ut.add(n),n(gt),()=>{ut.delete(n)})}componentWillUnmount(){this.networkStatusUnsubscribe?.()}handleRetry=async()=>{const e=this.props.maxRetries||3;this.state.retryCount>=e||(this.setState({isRetrying:!0}),await new Promise(e=>setTimeout(e,1e3)),this.setState({hasError:!1,error:void 0,errorInfo:void 0,errorDetails:void 0,retryCount:this.state.retryCount+1,isRetrying:!1}))};handleReload=()=>{window.location.reload()};render(){if(this.state.hasError){if(this.props.fallback)return this.props.fallback;const{level:t="component",showErrorDetails:a=!1}=this.props,{errorDetails:i,retryCount:r,isRetrying:n}=this.state,o=this.props.maxRetries||3,s=ft(),l=i?.type||"unknown",c=function(e,t){if(!t)return"网络连接已断开，请检查您的网络连接后重试。";switch(e){case"network":return"网络请求失败，请检查网络连接或稍后重试。";case"chunk":return"页面资源加载失败，可能是网络问题，请尝试刷新页面。";case"runtime":return"页面运行时出现错误，请尝试刷新页面或联系技术支持。";default:return"页面遇到了一些问题，请尝试刷新页面或稍后再试。"}}(l,s.isOnline);return e.jsxs(xt,{level:t,isDark:this.props.isDark,children:[e.jsx(yt,{level:t,children:"network"===l?"🌐":"chunk"===l?"📦":"runtime"===l?"⚠️":"❌"}),e.jsx(wt,{isDark:this.props.isDark,children:"network"===l?this.props.t?.common?.networkError||"网络连接问题":"chunk"===l?this.props.t?.common?.resourceLoadError||"资源加载失败":"runtime"===l?this.props.t?.common?.runtimeError||"运行时错误":this.props.t?.common?.pageLoadError||"页面加载出错了"}),e.jsxs(vt,{isDark:this.props.isDark,children:[c,r>0&&e.jsxs(e.Fragment,{children:[e.jsx("br",{}),"已重试 ",r," 次"]})]}),e.jsxs(kt,{children:[e.jsx(Ct,{variant:"primary",isDark:this.props.isDark,onClick:this.handleRetry,disabled:n||r>=o,children:n?this.props.t?.common?.retrying||"重试中...":r>=o?this.props.t?.common?.maxRetriesReached||"已达最大重试次数":this.props.t?.common?.reload||"重新加载"}),e.jsx(Ct,{variant:"secondary",isDark:this.props.isDark,onClick:this.handleReload,children:"刷新页面"})]}),!s.isOnline&&e.jsx(Dt,{isDark:this.props.isDark,children:"🔴 网络连接已断开"}),a&&i&&e.jsxs(St,{isDark:this.props.isDark,children:[e.jsx("summary",{children:"错误详情 (开发模式)"}),e.jsxs("pre",{children:["错误类型: ",i.type,"\n","错误消息: ",i.message,"\n","时间戳: ",new Date(i.timestamp).toLocaleString(),"\n","网络状态: ",JSON.stringify(i.networkStatus,null,2),i.stack&&`\n\n堆栈跟踪:\n${i.stack}`,i.componentStack&&`\n\n组件堆栈:\n${i.componentStack}`]})]})]})}return this.props.children}}const jt=t=>{const{isDark:a}=ze(),{t:i}=mt();return e.jsx(Ft,{...t,isDark:a,t:i,showErrorDetails:t.showErrorDetails??!1})},Pt=()=>(()=>{if("undefined"==typeof window)return!1;const e=document.documentElement.getAttribute("data-theme"),t=document.body.getAttribute("data-theme"),a=document.documentElement.className,i=document.body.className,r=localStorage.getItem("theme");return!("dark"!==e&&"dark"!==t&&("light"===e||"light"===t||!a.includes("dark")&&!i.includes("dark")&&(a.includes("light")||i.includes("light")||"dark"!==r&&("light"===r||!window.matchMedia||!window.matchMedia("(prefers-color-scheme: dark)").matches))))})(),Et=()=>{const[e,t]=i.useState(()=>Pt());i.useEffect(()=>{if("undefined"==typeof window)return;t(Pt());const e=e=>{"theme"===e.key&&t(Pt())},a=new MutationObserver(()=>{t(Pt())});a.observe(document.body,{attributes:!0,attributeFilter:["data-theme","class"]}),a.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme","class"]}),window.addEventListener("storage",e);const i=window.matchMedia("(prefers-color-scheme: dark)"),r=()=>{t(Pt())};return i.addEventListener("change",r),()=>{a.disconnect(),window.removeEventListener("storage",e),i.removeEventListener("change",r)}},[]);try{const e=ze();return{isDark:e.isDark,mode:e.mode,colors:e.colors,toggleMode:e.toggleMode,setMode:e.setMode}}catch(a){return{isDark:e,mode:e?"dark":"light",colors:null,toggleMode:()=>{const t=e?"light":"dark";localStorage.setItem("theme",t),document.documentElement.setAttribute("data-theme",t)},setMode:e=>{localStorage.setItem("theme",e),document.documentElement.setAttribute("data-theme",e)}}}},Lt=d`
  0% {
    background-position: -200px 0;
  }
  100% {
...
`,$t=p.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  ...
  animation: ${Lt} 1.5s infinite linear;
  border-radius: 4px;
  transition: background 0.3s ease;
...
`,ia=p.span`
  font-weight: 500;
`,ra=p.div.withConfig({shouldForwardProp:e=>"isOpen"!==e&&"isDark"!==e})`
  position: absolute;
  bottom: 100%;
  right: 0;
  margin-bottom: 4px;
  ...
  transition: all 0.3s ease;
`,na=p.button.withConfig({shouldForwardProp:e=>"isActive"!==e&&"isDark"!==e})`
  display: flex;
  align-items: center;
  gap: 8px;
  width: 100%;
...
`,oa=p.span.withConfig({shouldForwardProp:e=>"visible"!==e&&"isDark"!==e})`
  opacity: ${e=>e.visible?1:0};
  color: var(--color-status-success);
  font-weight: bold;
  margin-left: auto;
`,sa=[{code:"zh",name:"Chinese",icon:"🇨🇳",nativeName:"中文"},{code:"en",name:"English",icon:"🇺🇸",nativeName:"English"}],la=({className:t})=>{const{language:a,setLanguage:i,t:n}=mt(),{isDark:o}=ze(),[s,l]=r.useState(!1),c=sa.find(e=>e.code===a);r.useEffect(()=>{const e=L();e!==a&&i(e)},[a,i]);const d=r.useCallback(e=>{e.target.closest("[data-language-switcher]")||l(!1)},[]);return r.useEffect(()=>{if(s)return document.addEventListener("click",d),()=>document.removeEventListener("click",d)},[s,d]),e.jsxs(ea,{className:t,"data-testid":"language-switcher","data-language-switcher":!0,children:[e.jsxs(ta,{isDark:o,onClick:()=>l(!s),title:n.common.switchLanguage,"aria-label":n.common.switchLanguage,children:[e.jsx(aa,{children:c?.icon}),e.jsx(ia,{children:c?.nativeName}),e.jsx("span",{style:{transform:s?"rotate(0deg)":"rotate(180deg)",transition:"transform 0.3s ease",fontSize:"12px"},children:"▲"})]}),e.jsx(ra,{isOpen:s,isDark:o,children:sa.map(t=>e.jsxs(na,{isActive:a===t.code,isDark:o,onClick:()=>(async e=>{try{const t=e;$(t),(e=>{try{localStorage.setItem("flexiresume-language",e)}catch(t){D("Failed to save language preference to localStorage",t)}})(t),q.clear(),i(e),l(!1)}catch(t){}})(t.code),children:[e.jsx("span",{children:t.icon}),e.jsx("span",{children:t.nativeName}),e.jsx(oa,{visible:a===t.code,isDark:o,children:"✓"})]},t.code))})]})},ca=p.div`
  position: relative;
  display: inline-block;
`,da=p.button.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 44px;
...
`,ma=p.div.withConfig({shouldForwardProp:e=>"isVisible"!==e})`
  position: absolute;
  top: 50%;
  left: 50%;
...
`,ua=p.div.withConfig({shouldForwardProp:e=>"isDark"!==e&&"isVisible"!==e})`
  position: absolute;
  bottom: 100%;
  left: 50%;
...
`,ga=p.div.withConfig({shouldForwardProp:e=>"isActive"!==e})`
  position: absolute;
  top: 50%;
  left: 50%;
  width: 0;
  ...
  ${e=>e.isActive&&"\n    width: 100px;\n    height: 100px;\n  "}
`,fa=({className:t,showTooltip:a=!0})=>{const{mode:i,toggleMode:n,isDark:o}=ze(),{t:s}=mt(),[l,c]=r.useState(!1),[d,m]=r.useState(!1),p=o?s.common.lightMode:s.common.darkMode;return e.jsxs(ca,{className:t,"data-theme-switcher":!0,onMouseEnter:()=>c(!0),onMouseLeave:()=>c(!1),children:[e.jsxs(da,{isDark:o,onClick:()=>{m(!0),setTimeout(()=>m(!1),600),n()},title:p,"aria-label":p,children:[e.jsx(ga,{isActive:d}),e.jsx(ma,{isVisible:!o,children:e.jsx(pa,{})}),e.jsx(ma,{isVisible:o,children:e.jsx(ha,{})})]}),a&&e.jsx(ua,{isDark:o,isVisible:l,children:p})]})},ba=p.div`
  position: relative;
  display: inline-block;
`,xa=p.button`
...
`,Ca=p.div`
  ...
  color: var(--color-text-secondary);
  font-size: 12px;
`,Sa={[Ot.ANCIENT_CHINESE]:"古典中文",[Ot.MODERN_CHINESE]:"现代中文",[Ot.ENGLISH]:"英文字体",[Ot.MIXED]:"混合字体"},Da=()=>{const{isDark:t}=ze(),{currentFont:a,setFontByName:n,availableFonts:o,isLoading:s,loadedFonts:l}=i.useContext(qt)||(Xt.extend("warn")("useFontContext must be used within a FontProvider, using default font context"),{currentFont:Kt,setFont:()=>{},setFontByName:()=>{},setFontByType:()=>{},availableFonts:Gt,fontCSS:Vt(Kt),isLoading:!1,loadedFonts:new Set}),[c,d]=i.useState(!1);return r.useEffect(()=>{const e=()=>{d(!1)};if(c)return document.addEventListener("click",e),()=>{document.removeEventListener("click",e)}},[c]),e.jsxs(ba,{onClick:e=>{e.stopPropagation()},children:[e.jsxs(xa,{$isDark:t,className:c?"open":"",onClick:e=>{e.stopPropagation(),d(!c)},disabled:s,children:[e.jsx("span",{children:a.primary.displayName}),e.jsx("span",{className:"icon",children:"▼"})]}),e.jsxs(ya,{$isOpen:c,$isDark:t,children:[s&&e.jsx(Ca,{children:"正在加载字体..."}),!s&&Object.entries(o).map(([t,i])=>e.jsxs(wa,{children:[e.jsx(va,{children:Sa[t]}),i.map(t=>e.jsxs(ka,{$isSelected:a.primary.name===t.name,$fontFamily:`"${t.fontFamily}", ${t.fallbacks.join(", ")}`,onClick:()=>{return e=t.name,n(e),void d(!1);var e},children:[e.jsxs("div",{className:"font-name",children:[t.displayName,l.has(t.fontFamily)&&" ✓"]}),e.jsx("div",{className:"font-description",children:t.description})]},t.name))]},t))]})]})},Fa=S("PDFDownloader"),ja=S("pdf");var Pa=!1;class Ea{static instance;isActivated=!1;static getInstance(){return Ea.instance||(Ea.instance=new Ea),Ea.instance}activatePrintStyle(e="standard"){ja(`激活打印样式，模式: ${e}`),"standard"===e?(document.body.classList.add("print-mode-active"),this.isActivated=!0,ja("已激活标准打印样式")):(document.body.classList.remove("print-mode-active"),this.isActivated=!1,ja("原版模式：未激活全局打印样式"))}deactivatePrintStyle(){ja("取消激活打印样式"),document.body.classList.remove("print-mode-active"),this.isActivated=!1}isStyleActivated(){return this.isActivated}}const La=Ea.getInstance(),$a=p.div`
  position: relative;
  display: inline-block;
...
`,Ta=p.span`
  font-weight: 500;
`,Ma=p.div.withConfig({shouldForwardProp:e=>"isOpen"!==e&&"isDark"!==e})`
  position: absolute;
  bottom: 100%;
  right: 0;
  margin-bottom: 4px;
  ...
  transform: ${e=>e.isOpen?"translateY(0)":"translateY(10px)"};
  transition: all 0.3s ease;
`,Na=p.button.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  display: flex;
  align-items: center;
  gap: 8px;
  width: 100%;
...
`,_a=({className:t})=>{const{isDark:a}=ze();Pa=a;const{t:n}=mt(),[o,s]=i.useState(!1),[l,c]=i.useState(!1);function d(e=!0){const t="dark-filter-override",a=document.getElementById(t);if(a&&a.remove(),e){const e=document.createElement("style");e.id=t,e.type="text/css",e.textContent='\n            [data-theme="dark"] body::before {\n                filter: none !important;\n                -webkit-filter: none !important;\n            }\n        ',document.head.appendChild(e),Fa("已禁用深色模式背景滤镜")}else Fa("已恢复深色模式背景滤镜")}r.useEffect(()=>{const e=e=>{e.target.closest("[data-pdf-downloader]")||s(!1)};if(o)return document.addEventListener("click",e),()=>document.removeEventListener("click",e)},[o]),i.useEffect(()=>{const e=e=>{if(e.ctrlKey&&"p"===e.key){ja("检测到Ctrl+P快捷键，激活标准打印样式"),La.activatePrintStyle("standard");const e=()=>{ja("打印对话框关闭，清理打印样式"),La.deactivatePrintStyle(),window.removeEventListener("afterprint",e)};window.addEventListener("afterprint",e),setTimeout(()=>{La.isStyleActivated()&&(ja("备用清理：5秒后自动清理打印样式"),La.deactivatePrintStyle())},5e3)}};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[]);const m=async e=>{if(!l){c(!0),s(!1);try{ja(`开始生成${"color"===e?"彩色":"grayscale"===e?"黑白":"原版"}PDF`),"original"===e?(La.activatePrintStyle("original"),ja("原版模式：保持在线显示样式")):(La.activatePrintStyle("standard"),d(!0),ja(`${e}模式：激活标准打印样式`));const t=document.body.cloneNode(!0);['[data-testid="control-panel"]',"[data-pdf-downloader]",".control-panel",".floating-panel",'[data-testid="font-performance-monitor"]',".font-performance-monitor"].forEach(e=>{t.querySelectorAll(e).forEach(e=>e.remove())}),ja("准备在当前页面打印，不创建新窗口");const a="temp-pdf-print-style";let i=document.getElementById(a);i&&i.remove();const r=document.createElement("style");r.id=a,r.type="text/css";const n="original"===e?`\n          @media print {\n            /* 基础打印设置 */\n            @page {\n              size: A4;\n              margin: 1cm;\n              background: ${Pa?"#000":"#fff"};\n              background-color: ${Pa?"#000":"#fff"};\n              /* 隐藏页眉页脚 */\n              @top-left { content: none; }\n              @top-center { content: none; }\n              @top-right { content: none; }\n              @bottom-left { content: none; }\n              @bottom-center { content: none; }\n              @bottom-right { content: none; }\n            }\n \n\n            /* 强制打印背景色 */\n            html, body {\n                -webkit-print-color-adjust: exact !important;\n                color-adjust: exact !important;\n                print-color-adjust: exact !important;\n            }\n\n            /* 强制保持所有原有颜色和样式 - 最高优先级 */\n            * {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保HTML根元素保持主题 */\n            html {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保body保持背景色 */\n            body {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 主题样式统一处理 */\n            [data-theme="dark"] {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            [data-theme="light"] {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 深色模式body样式 */\n            [data-theme="dark"] body {\n              background-color: var(--color-background) !important;\n              color: var(--color-text-primary) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 浅色模式body样式 */\n            [data-theme="light"] body {\n              background-color: var(--color-background) !important;\n              color: var(--color-text-primary) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保深色模式的背景伪元素正确显示 */\n            [data-theme="dark"] body::before {\n              content: "" !important;\n              position: fixed !important;\n              top: 0 !important;\n              left: 0 !important;\n              width: 100% !important;\n              height: 100% !important;\n              background-color: var(--color-background) !important;\n              background-image: var(--background-image) !important;\n              background-repeat: repeat !important;\n              background-size: 180px !important;\n              filter: var(--filter-background-dark) !important;\n              z-index: -1 !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 保持所有元素的原有样式 */\n            [data-theme="dark"] * {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保resume-content保持主题样式 - 使用CSS变量 */\n            [data-theme="dark"] [data-testid="resume-content"] {\n              background: var(--color-card) !important;\n              background-color: var(--color-card) !important;\n              color: var(--color-text-primary) !important;\n              border: var(--border-card) !important;\n              box-shadow: var(--shadow-card) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保浅色模式也使用主题样式 */\n            [data-theme="light"] [data-testid="resume-content"] {\n              background: var(--color-card) !important;\n              background-color: var(--color-card) !important;\n              color: var(--color-text-primary) !important;\n              border: var(--border-card) !important;\n              box-shadow: var(--shadow-card) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 确保所有主题相关元素使用CSS变量 */\n            * {\n              color: var(--color-text-primary) !important;\n              background-color: var(--color-background) !important;\n              border-color: var(--color-border-light) !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 卡片元素使用卡片主题 */\n            .card, .resume-card, [class*="card"], [class*="Card"] {\n              background: var(--color-card) !important;\n              background-color: var(--color-card) !important;\n              color: var(--color-text-primary) !important;\n              border: var(--border-card) !important;\n              box-shadow: var(--shadow-card) !important;\n            }\n\n            /* 表面元素使用表面主题 */\n            .surface, [class*="surface"], [class*="Surface"] {\n              background: var(--color-surface) !important;\n              background-color: var(--color-surface) !important;\n              color: var(--color-text-primary) !important;\n            }\n\n            /* 链接元素使用主题颜色 */\n            a, [class*="link"], [class*="Link"] {\n              color: var(--color-primary) !important;\n            }\n\n            /* 标题元素使用主题颜色 */\n            h1, h2, h3, h4, h5, h6 {\n              color: var(--color-text-primary) !important;\n            }\n\n            /* 只隐藏不需要的元素，不改变任何颜色和样式 */\n            .no-print,\n            .print-hide,\n            .control-panel,\n            .floating-controls,\n            nav,\n            .navigation,\n            .tabs,\n            .tab-container,\n            button:not(.skill-item):not([class*="skill"]),\n            [data-testid="control-panel"],\n            [data-testid="development-notice"],\n            [data-pdf-downloader],\n            .pdf-downloader,\n            .control-button,\n            .floating-button,\n            [class*="control"]:not(.skill-item),\n            [class*="floating"]:not(.skill-item),\n            [class*="button"]:not(.skill-item),\n            .fixed,\n            .absolute {\n              display: none !important;\n            }\n\n            /* 确保技能标签正常显示 */\n            .skill-item,\n            [class*="skill"],\n            [class*="Skill"],\n            span[title*="了解"],\n            span[title*="熟练"],\n            span[title*="精通"],\n            span[title*="Basic"],\n            span[title*="Proficient"],\n            span[title*="Expert"],\n            span[title*="Familiar"],\n            span[title*="Experienced"],\n            span[title*="Advanced"] {\n              display: inline-flex !important;\n              visibility: visible !important;\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n          }\n        `:`\n          @media print {\n            /* 页面设置 */\n            @page {\n              size: A4;\n              margin: 1cm;  \n              /* 隐藏页眉页脚 */\n              @top-left { content: none; }\n              @top-center { content: none; }\n              @top-right { content: none; }\n              @bottom-left { content: none; }\n              @bottom-center { content: none; }\n              @bottom-right { content: none; }\n            }\n\n            /* 强制启用颜色调整，确保背景色和图像正确打印 */\n            * {\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 强制重置所有元素的背景为白色 */\n            html, body, #root {\n              background: white !important;\n              background-color: white !important;\n              background-image: none !important;\n              color: black !important;\n              filter: none !important;\n              -webkit-filter: none !important;\n            }\n\n            /* 确保页面所有区域都是白色背景，覆盖深色主题的镂空效果 */\n            * {\n              background-color: white !important;\n              background-image: none !important;\n              background: white !important;\n            }\n\n            /* 隐藏深色模式背景伪元素，防止镂空部位显示深色 */\n            [data-theme="dark"] body::before,\n            [data-theme="dark"] body::after,\n            body::before,\n            body::after {\n              display: none !important;\n              content: none !important;\n              background: none !important;\n              background-image: none !important;\n              filter: none !important;\n              -webkit-filter: none !important;\n            }\n\n            /* 确保简历内容区域正确显示 */\n            [data-testid="resume-content"],\n            .resume-content,\n            .main-content {\n              background: white !important;\n              background-color: white !important;\n              color: black !important;\n              border: 1px solid #ccc !important;\n              box-shadow: none !important;\n            }\n\n            /* 重置根元素和body样式 */\n            html, body {\n              width: 100% !important;\n              height: auto !important;\n              margin: 0 !important;\n              padding: 20px !important;\n              overflow: visible !important;\n              font-size: 12pt !important;\n              line-height: 1.4 !important;\n              min-height: auto !important;\n            }\n\n            /* 根元素打印优化 */\n            #root {\n              display: block !important;\n              width: 100% !important;\n              max-width: none !important;\n              margin: 0 !important;\n              padding: 0 !important;\n              background: white !important;\n              overflow: visible !important;\n            }\n\n            /* 隐藏不需要打印的元素 */\n            .no-print,\n            .print-hide,\n            button:not(.skill-item):not([class*="skill"]),\n            .control-panel,\n            .floating-controls,\n            .floating-button,\n            .control-button,\n            nav,\n            .navigation,\n            .tabs,\n            .tab-container,\n            [data-testid="control-panel"],\n            [data-testid="development-notice"],\n            [data-testid="font-performance-monitor"],\n            [data-pdf-downloader],\n            .pdf-downloader,\n            [class*="control"]:not(.skill-item):not(.category-item),\n            [class*="floating"]:not(.skill-item):not(.category-item),\n            [class*="button"]:not(.skill-item):not(.category-item),\n            [class*="Panel"],\n            [class*="Switcher"],\n            [class*="Downloader"],\n            .font-performance-monitor,\n            .fixed,\n            .absolute {\n              display: none !important;\n              visibility: hidden !important;\n            }\n\n            /* 确保文本内容为黑色 */\n            p, h1, h2, h3, h4, h5, h6, li, td, th, span:not(.skill-item span), div:not(.skill-item) {\n              color: black !important;\n              background: white !important;\n              background-color: white !important;\n            }\n\n            /* 技能标签保持原有样式，但在黑白模式下转为灰色 */\n            .skill-item,\n            [class*="skill"],\n            [class*="Skill"],\n            span[title*="了解"],\n            span[title*="熟练"],\n            span[title*="精通"],\n            span[title*="Basic"],\n            span[title*="Proficient"],\n            span[title*="Expert"],\n            span[title*="Familiar"],\n            span[title*="Experienced"],\n            span[title*="Advanced"] {\n              ${"grayscale"===e?"\n                background: #f0f0f0 !important;\n                color: #333 !important;\n                border: 1px solid #ccc !important;\n              ":"\n                background: initial !important;\n                color: initial !important;\n              "}\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 技能标签内的文字处理 */\n            .skill-item span,\n            [class*="skill"] span,\n            [class*="Skill"] span {\n              ${"grayscale"===e?"\n                background-clip: border-box !important;\n                -webkit-background-clip: border-box !important;\n                color: #333 !important;\n                background-image: none !important;\n              ":"\n                background-clip: text !important;\n                -webkit-background-clip: text !important;\n                color: transparent !important;\n                background-image: inherit !important;\n              "}\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 链接样式 */\n            a {\n              color: black !important;\n              text-decoration: underline !important;\n            }\n\n            /* 图片处理 */\n            img {\n              ${"grayscale"===e?"\n                filter: grayscale(100%) !important;\n                -webkit-filter: grayscale(100%) !important;\n              ":"\n                filter: none !important;\n                -webkit-filter: none !important;\n              "}\n              -webkit-print-color-adjust: exact !important;\n              color-adjust: exact !important;\n              print-color-adjust: exact !important;\n            }\n\n            /* 分页控制 */\n            .page-break-before {\n              page-break-before: always;\n            }\n\n            .page-break-after {\n              page-break-after: always;\n            }\n\n            .page-break-inside-avoid {\n              page-break-inside: avoid;\n            }\n\n            /* 强制重置所有滤镜效果 */\n            * {\n              filter: none !important;\n              -webkit-filter: none !important;\n            }\n\n            /* 黑白模式全局滤镜 */\n            ${"grayscale"===e?"\n              * {\n                filter: grayscale(100%) !important;\n                -webkit-filter: grayscale(100%) !important;\n              }\n            ":""}\n          }\n        `;r.textContent=n,document.head.appendChild(r),await new Promise(e=>setTimeout(e,300));const o="color"===e?"彩色版":"grayscale"===e?"黑白版":"原版";ja(`开始打印${o}`),window.print(),d(!1),setTimeout(()=>{const e=document.getElementById(a);e&&e.remove(),ja("已清理临时打印样式")},1e3),ja(`${o}PDF生成完成`)}catch(t){ja("PDF生成失败:",t),alert(`${n.common?.pdfGenerationFailed||"PDF generation failed"}: ${t instanceof Error?t.message:n.common?.unknownError||"Unknown error"}`)}finally{La.deactivatePrintStyle(),c(!1),d(!1),ja("PDF生成流程结束，已清理打印样式")}}};return e.jsxs($a,{className:t,"data-testid":"pdf-downloader","data-pdf-downloader":!0,children:[e.jsxs(Ia,{isDark:a,onClick:()=>s(!o),disabled:l,title:n.common?.downloadPDF||"Download PDF","aria-label":n.common?.downloadPDF||"Download PDF",children:[e.jsx(za,{children:l?e.jsx(Aa,{}):"📄"}),e.jsx(Ta,{children:l?n.common?.generating||"Generating...":"PDF"}),!l&&e.jsx("span",{style:{transform:o?"rotate(0deg)":"rotate(180deg)",transition:"transform 0.3s ease",fontSize:"12px"},children:"▲"})]}),e.jsxs(Ma,{isOpen:o&&!l,isDark:a,children:[e.jsxs(Na,{isDark:a,onClick:()=>m("original"),disabled:l,children:[e.jsx("span",{children:"📱"}),e.jsx("span",{children:n.common?.originalPDF||"Original PDF"})]}),e.jsxs(Na,{isDark:a,onClick:()=>m("color"),disabled:l,children:[e.jsx("span",{children:"🎨"}),e.jsx("span",{children:n.common?.colorPDF||"Color PDF"})]}),e.jsxs(Na,{isDark:a,onClick:()=>m("grayscale"),disabled:l,children:[e.jsx("span",{children:"⚫"}),e.jsx("span",{children:n.common?.grayscalePDF||"Grayscale PDF"})]})]})]})},Ra=p.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 8px 12px;
  ...
  backdrop-filter: blur(10px);
  transition: all 0.3s ease;
`,Oa=p.button.withConfig({shouldForwardProp:e=>"isDark"!==e&&"active"!==e})`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 32px;
...
`,Ba=p.input.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  width: 60px;
  height: 4px;
...
`,Ua=p.span.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  font-size: 12px;
  color: ${e=>e.isDark?"#e2e8f0":"#2c3e50"};
  white-space: nowrap;
`,Ga=({className:t})=>{const{isDark:a}=ze(),{t:r}=mt(),[n,o]=i.useState(()=>{try{const e=localStorage.getItem("audioEnabled");return null===e||JSON.parse(e)}catch{return!0}}),[s,l]=i.useState(()=>{try{const e=localStorage.getItem("audioVolume");return null!==e?parseFloat(e):.7}catch{return.7}});return i.useEffect(()=>{Ke.setEnabled(n),Ke.setGlobalVolume(s,s)},[n,s]),i.useEffect(()=>{try{localStorage.setItem("audioEnabled",JSON.stringify(n))}catch(e){}},[n]),i.useEffect(()=>{try{localStorage.setItem("audioVolume",s.toString())}catch(e){}},[s]),e.jsxs(Ra,{isDark:a,className:t,children:[n&&e.jsxs(e.Fragment,{children:[e.jsx(Ua,{isDark:a,children:"音量"}),e.jsx(Ba,{isDark:a,type:"range",min:"0",max:"1",step:"0.1",value:s,onChange:e=>{const t=parseFloat(e.target.value);l(t)},title:`音量: ${Math.round(100*s)}%`})]}),e.jsx(Oa,{isDark:a,active:n,onClick:async()=>{const e=!n;o(e),await Ke.setEnabled(e)},title:n?"关闭音效":"开启音效",children:n?"🔊":"🔇"})]})},Ha=p.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  position: fixed;
  bottom: 20px;
  right: 20px;
  display: flex;
...
`,Ka=p.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  width: 1px;
  height: 24px;
  background: var(--color-border-light);
  transition: background 0.3s ease;
...
`;const Va=p.div.withConfig({shouldForwardProp:e=>"isCollapsed"!==e&&"isDark"!==e})`
  position: fixed;
  bottom: 20px;
  right: 20px;
  z-index: 1000;
...
`,Wa=p.button.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 48px;
...
`,Za=p.div.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  position: absolute;
  bottom: 100%;
  right: 0;
  margin-bottom: 12px;
...
`,Ya=p.div`
  ...
  justify-content: space-between;
  gap: 12px;
`,Xa=p.span.withConfig({shouldForwardProp:e=>"isDark"!==e})`
  font-size: 14px;
  font-weight: 500;
  color: ${e=>e.isDark?"#e2e8f0":"#2c3e50"};
`,Ja=({className:t,collapsible:a=!1,defaultCollapsed:i=!1})=>{const{isDark:n}=ze(),{t:o}=mt(),s=((e=768)=>{const[t,a]=r.useState(()=>"undefined"==typeof window||window.innerWidth>e);return r.useEffect(()=>{let t;const i=()=>{clearTimeout(t),t=setTimeout(()=>{a(window.innerWidth>e)},100)};return window.addEventListener("resize",i),i(),()=>{window.removeEventListener("resize",i),clearTimeout(t)}},[e]),t})(768),l=r.useMemo(()=>!1!==i?i:!s,[s,i]),[c,d]=r.useState(()=>{try{const e=localStorage.getItem("controlPanelCollapsed");if(null!==e)return JSON.parse(e)}catch{}return l}),[m,p]=r.useState(()=>{try{return null!==localStorage.getItem("controlPanelCollapsed")}catch{return!1}});r.useEffect(()=>{m||d(l)},[l,m]),r.useEffect(()=>{if(m)try{localStorage.setItem("controlPanelCollapsed",JSON.stringify(c))}catch(e){}},[c,m]);return a?e.jsxs(Va,{isCollapsed:c,isDark:n,className:t,"data-testid":"control-panel",children:[e.jsx(Wa,{isDark:n,onClick:()=>{p(!0),d(!c)},title:o.common.controlPanel,"aria-label":o.common.controlPanel,children:c?"⚙️":"✕"}),!c&&e.jsxs(Za,{isDark:n,children:[e.jsxs(Ya,{children:[e.jsx(Xa,{isDark:n,children:o.common.theme}),e.jsx(fa,{showTooltip:!1})]}),e.jsx(Ka,{isDark:n}),e.jsxs(Ya,{children:[e.jsx(Xa,{isDark:n,children:o.common.language}),e.jsx(la,{})]}),e.jsx(Ka,{isDark:n}),e.jsxs(Ya,{children:[e.jsx(Xa,{isDark:n,children:o.common.font}),e.jsx(Da,{})]}),e.jsx(Ka,{isDark:n}),e.jsxs(Ya,{children:[e.jsx(Xa,{isDark:n,children:o.common.music}),e.jsx(Ga,{})]}),e.jsx(Ka,{isDark:n}),e.jsxs(Ya,{children:[e.jsx(Xa,{isDark:n,children:o.common.downloadPDF}),e.jsx(_a,{})]})]})]}):e.jsxs(Ha,{isDark:n,className:t,"data-testid":"control-panel",children:[e.jsx(fa,{}),e.jsx(Ka,{isDark:n}),e.jsx(la,{}),e.jsx(Ka,{isDark:n}),e.jsx(Da,{}),e.jsx(Ka,{isDark:n}),e.jsx(Ga,{}),e.jsx(Ka,{isDark:n}),e.jsx(_a,{})]})},qa=()=>null,Qa=S("LibraryPreloader"),ei=S("preloader"),ti=new class{libraries=new Map;preloadPromises=new Map;constructor(){this.initializeLibraryStates()}initializeLibraryStates(){["mermaid","svgPanZoom","katex","cytoscape"].forEach(e=>{this.libraries.set(e,{loading:!1,loaded:!1,error:null,module:null})})}async startPreloading(){const e=R(),{preloadLibraries:t}=e.performance;B()&&ei("[LibraryPreloader] 开始预加载库:",t);const a=[];t.mermaid&&a.push(this.preloadMermaid()),t.svgPanZoom&&a.push(this.preloadSvgPanZoom()),t.katex&&a.push(this.preloadKatex()),t.cytoscape&&a.push(this.preloadCytoscape()),Promise.allSettled(a).then(e=>{if(B()){const t=e.filter(e=>"fulfilled"===e.status).length,a=e.filter(e=>"rejected"===e.status).length;ei(`[LibraryPreloader] 预加载完成: ${t}个成功, ${a}个失败`)}})}async preloadMermaid(){return this.preloadLibrary("mermaid",()=>o(()=>import("./mermaid-core-BSOLjsMK.js").then(e=>e.b8),__vite__mapDeps([1,2,3]),import.meta.url))}async preloadSvgPanZoom(){return this.preloadLibrary("svgPanZoom",()=>o(()=>import("./utils-CEXnc-BX.js").then(e=>e.s),__vite__mapDeps([5,2]),import.meta.url))}async preloadKatex(){return this.preloadLibrary("katex",()=>o(()=>import("./katex-CgY2OwR7.js"),[],import.meta.url))}async preloadCytoscape(){return this.preloadLibrary("cytoscape",()=>o(()=>import("./cytoscape-BKktfreJ.js").then(e=>e.b),__vite__mapDeps([6,2]),import.meta.url))}async preloadLibrary(e,t){const a=this.libraries.get(e);if(!a||a.loaded||a.loading)return;if(this.preloadPromises.has(e))return this.preloadPromises.get(e);a.loading=!0,a.error=null;const i=performance.now(),r=t().then(t=>{const r=performance.now()-i;return a.loaded=!0,a.loading=!1,a.module=t,B()&&ei(`[LibraryPreloader] ${e} 预加载成功 (${r.toFixed(2)}ms)`),t}).catch(t=>{throw a.loading=!1,a.error=t.message,B()&&Qa.extend("warn")(`[LibraryPreloader] ${e} 预加载失败:`,t),t}).finally(()=>{this.preloadPromises.delete(e)});return this.preloadPromises.set(e,r),r}async getLibrary(e){const t=this.libraries.get(e);if(!t)throw new Error(`Unknown library: ${e}`);if(t.loaded&&t.module)return t.module;if(t.loading&&this.preloadPromises.has(e))return this.preloadPromises.get(e);switch(e){case"mermaid":return this.preloadMermaid();case"svgPanZoom":return this.preloadSvgPanZoom();case"katex":return this.preloadKatex();case"cytoscape":return this.preloadCytoscape();default:throw new Error(`Unknown library: ${e}`)}}getLibraryState(e){return this.libraries.get(e)||null}getAllLibraryStates(){return new Map(this.libraries)}cleanup(){this.libraries.clear(),this.preloadPromises.clear()}},ai=S("analytics-config"),ii={baidu:{enabled:!1,siteId:"",domain:"",autoTrack:!0,debug:!1},google:{enabled:!1,measurementId:"",debug:!1,customDimensions:{},customMetrics:{},useFirebase:!0,dynamicLoading:!0},elk:{enabled:!1,endpoint:"http://localhost:5000",batchSize:10,flushInterval:5e3,debug:!1},enablePerformanceMonitoring:!0,enableErrorTracking:!0,enableUserBehaviorTracking:!0};class ri{static instance;config;constructor(){this.config=this.loadConfig()}static getInstance(){return ri.instance||(ri.instance=new ri),ri.instance}loadConfig(){const e={...ii};e.baidu={enabled:!0,siteId:"",domain:"deden.web.app",autoTrack:!0,debug:!1},e.google={enabled:!1,measurementId:"G-7LG0G58765",debug:!1,customDimensions:{},customMetrics:{},useFirebase:!1,dynamicLoading:!0},e.elk={enabled:!1,endpoint:"http://localhost:5001",batchSize:parseInt("10"),flushInterval:parseInt("5000"),debug:!1};try{const t=localStorage.getItem("analytics_config");if(t){const a=JSON.parse(t);Object.assign(e,a)}}catch(t){ai("Failed to load user analytics config: %O",t)}return e}getConfig(){return{...this.config}}getBaiduConfig(){return{...this.config.baidu}}getGoogleConfig(){return{...this.config.google}}getELKConfig(){return{...this.config.elk}}updateConfig(e){this.config={...this.config,...e};try{localStorage.setItem("analytics_config",JSON.stringify(this.config))}catch(t){ai("Failed to save analytics config: %O",t)}}setBaiduEnabled(e){this.config.baidu.enabled=e,this.updateConfig({baidu:this.config.baidu})}setGoogleEnabled(e){this.config.google.enabled=e,this.updateConfig({google:this.config.google})}setELKEnabled(e){this.config.elk.enabled=e,this.updateConfig({elk:this.config.elk})}isAnyAnalyticsEnabled(){return this.config.baidu.enabled||this.config.google.enabled||this.config.elk.enabled}getConfigSummary(){return{baiduEnabled:this.config.baidu.enabled,googleEnabled:this.config.google.enabled,elkEnabled:this.config.elk.enabled,performanceMonitoring:this.config.enablePerformanceMonitoring,errorTracking:this.config.enableErrorTracking,userBehaviorTracking:this.config.enableUserBehaviorTracking}}}const ni=ri.getInstance(),oi=S("BaiduAnalytics");class si{static instance;isInitialized=!1;siteId="fd188b066e21a8e15d579e5f0b7633a9";constructor(){}static getInstance(){return si.instance||(si.instance=new si),si.instance}async initialize(){const e=ni.getBaiduConfig();if(e.enabled)if(this.isInitialized)oi("[BaiduAnalytics] Already initialized");else try{window._hmt=window._hmt||[];const t=document.createElement("script");t.src=`https://hm.baidu.com/hm.js?${this.siteId}`,t.async=!0;const a=document.getElementsByTagName("script")[0];a&&a.parentNode?a.parentNode.insertBefore(t,a):document.head.appendChild(t),this.isInitialized=!0,e.debug&&oi("[BaiduAnalytics] Initialized successfully with site ID:",this.siteId),e.autoTrack&&this.trackPageView()}catch(t){oi.extend("error")("[BaiduAnalytics] Initialization failed:",t)}else oi("[BaiduAnalytics] Disabled by configuration")}trackPageView(e,t){if(!this.isReady())return;const a=e||location.pathname+location.search;window._hmt.push(["_trackPageview",a]),ni.getBaiduConfig().debug&&oi("[BaiduAnalytics] Page view tracked:",{pagePath:a,title:t})}trackEvent(e){if(!this.isReady())return;const{category:t,action:a,label:i,value:r}=e;if(!t||!a)return void oi.extend("warn")("[BaiduAnalytics] Category and action are required for event tracking");const n=["_trackEvent",t,a];i&&n.push(i),void 0!==r&&n.push(r),window._hmt.push(n),ni.getBaiduConfig().debug&&oi("[BaiduAnalytics] Event tracked:",e)}trackSkillClick(e,t){this.trackEvent({category:"skill",action:"click",label:e,value:1})}trackProjectView(e,t){this.trackEvent({category:"project",action:"view",label:e,value:1})}trackContactClick(e){this.trackEvent({category:"contact",action:"click",label:e,value:1})}trackLanguageSwitch(e,t){this.trackEvent({category:"language",action:"switch",label:`${e}_to_${t}`,value:1})}trackThemeSwitch(e,t){this.trackEvent({category:"theme",action:"switch",label:`${e}_to_${t}`,value:1})}trackDownload(e,t){this.trackEvent({category:"download",action:"click",label:t||e,value:1})}trackError(e,t){this.trackEvent({category:"error",action:e,label:t,value:1})}setCustomVar(e,t,a,i=3){this.isReady()&&(e<1||e>5?oi.extend("warn")("[BaiduAnalytics] Custom variable index must be between 1 and 5"):(window._hmt.push(["_setCustomVar",e,t,a,i]),ni.getBaiduConfig().debug&&oi("[BaiduAnalytics] Custom variable set:",{index:e,name:t,value:a,scope:i})))}isReady(){const e=ni.getBaiduConfig();return this.isInitialized&&e.enabled?!!window._hmt||(oi.extend("warn")("[BaiduAnalytics] _hmt object not available"),!1):(e.debug&&oi("[BaiduAnalytics] Not ready:",{initialized:this.isInitialized,enabled:e.enabled}),!1)}getStatus(){const e=ni.getBaiduConfig();return{initialized:this.isInitialized,enabled:e.enabled,siteId:this.siteId.substring(0,8)+"..."}}}const li=si.getInstance();"undefined"!=typeof window&&setTimeout(()=>{li.initialize()},1e3);const ci=S("FirebaseAnalyticsLoader");class di{static instance;firebaseSDK=null;analytics=null;app=null;isLoading=!1;isLoaded=!1;loadPromise=null;constructor(){}static getInstance(){return di.instance||(di.instance=new di),di.instance}async loadFirebaseSDK(){try{if("undefined"==typeof window)return ci.extend("warn")("[FirebaseLoader] Not in browser environment"),null;if(this.firebaseSDK)return this.firebaseSDK;ci("[FirebaseLoader] Loading Firebase SDK from CDN...");const e=document.createElement("script");e.type="module",e.innerHTML="\n        import { initializeApp } from 'https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js';\n        import { \n          getAnalytics, \n          isSupported, \n          logEvent, \n          setUserProperties, \n          setUserId,\n          setCurrentScreen \n        } from 'https://www.gstatic.com/firebasejs/10.7.1/firebase-analytics.js';\n        \n        window.__firebaseSDK = {\n          initializeApp,\n          getAnalytics,\n          isSupported,\n          logEvent,\n          setUserProperties,\n          setUserId,\n          setCurrentScreen\n        };\n        \n        window.dispatchEvent(new CustomEvent('firebaseSDKLoaded'));\n      ";const t=new Promise(t=>{const a=()=>{window.removeEventListener("firebaseSDKLoaded",a);const e=window.__firebaseSDK;e?(this.firebaseSDK=e,ci("[FirebaseLoader] Firebase SDK loaded successfully"),t(e)):(ci.extend("error")("[FirebaseLoader] Firebase SDK not found on window"),t(null))};window.addEventListener("firebaseSDKLoaded",a),e.addEventListener("error",()=>{ci.extend("error")("[FirebaseLoader] Failed to load Firebase SDK"),t(null)}),setTimeout(()=>{window.removeEventListener("firebaseSDKLoaded",a),ci.extend("error")("[FirebaseLoader] Firebase SDK load timeout"),t(null)},1e4)});return document.head.appendChild(e),await t}catch(e){return ci.extend("error")("[FirebaseLoader] Error loading Firebase SDK:",e),null}}getFirebaseConfig(){const e=ni.getGoogleConfig();if(!e.enabled)return ci("[FirebaseLoader] Firebase Analytics disabled in config"),null;const t={apiKey:"",authDomain:"",projectId:"",storageBucket:"",messagingSenderId:"",appId:"",measurementId:e.measurementId||"G-7LG0G58765"};return t.apiKey&&t.projectId&&t.measurementId?t:(ci.extend("warn")("[FirebaseLoader] Firebase configuration incomplete:",{hasApiKey:!!t.apiKey,hasProjectId:!!t.projectId,hasMeasurementId:!!t.measurementId}),null)}async initialize(){if(this.isLoading&&this.loadPromise)return await this.loadPromise;if(this.isLoaded&&this.analytics)return!0;this.isLoading=!0,this.loadPromise=this._doInitialize();const e=await this.loadPromise;return this.isLoading=!1,this.isLoaded=e,e}async _doInitialize(){try{ci("[FirebaseLoader] Initializing Firebase Analytics...");const e=this.getFirebaseConfig();if(!e)return!1;const t=await this.loadFirebaseSDK();return!!t&&(await t.isSupported()?(this.app=t.initializeApp(e),ci("[FirebaseLoader] Firebase App initialized"),this.analytics=t.getAnalytics(this.app),ci("[FirebaseLoader] Firebase Analytics initialized"),!0):(ci.extend("warn")("[FirebaseLoader] Firebase Analytics not supported in this browser"),!1))}catch(e){return ci.extend("error")("[FirebaseLoader] Firebase initialization failed:",e),!1}}async logEvent(e,t){if(await this.initialize())try{this.firebaseSDK&&this.analytics&&(this.firebaseSDK.logEvent(this.analytics,e,t),ni.getGoogleConfig().debug&&ci("[FirebaseLoader] Event logged:",{eventName:e,eventParams:t}))}catch(a){ci.extend("error")("[FirebaseLoader] Failed to log event:",a)}else ci.extend("warn")("[FirebaseLoader] Firebase not initialized, skipping event:",e)}async setUserProperties(e){if(await this.initialize())try{this.firebaseSDK&&this.analytics&&(this.firebaseSDK.setUserProperties(this.analytics,e),ni.getGoogleConfig().debug&&ci("[FirebaseLoader] User properties set:",e))}catch(t){ci.extend("error")("[FirebaseLoader] Failed to set user properties:",t)}else ci.extend("warn")("[FirebaseLoader] Firebase not initialized, skipping user properties")}async setUserId(e){if(await this.initialize())try{this.firebaseSDK&&this.analytics&&(this.firebaseSDK.setUserId(this.analytics,e),ni.getGoogleConfig().debug&&ci("[FirebaseLoader] User ID set:",e))}catch(t){ci.extend("error")("[FirebaseLoader] Failed to set user ID:",t)}else ci.extend("warn")("[FirebaseLoader] Firebase not initialized, skipping user ID")}async setCurrentScreen(e){if(await this.initialize())try{this.firebaseSDK&&this.analytics&&(this.firebaseSDK.setCurrentScreen(this.analytics,e),ni.getGoogleConfig().debug&&ci("[FirebaseLoader] Current screen set:",e))}catch(t){ci.extend("error")("[FirebaseLoader] Failed to set current screen:",t)}else ci.extend("warn")("[FirebaseLoader] Firebase not initialized, skipping screen tracking")}getStatus(){const e=this.getFirebaseConfig();return{isLoaded:this.isLoaded,isLoading:this.isLoading,hasAnalytics:!!this.analytics,hasApp:!!this.app,configValid:!!e}}reset(){this.firebaseSDK=null,this.analytics=null,this.app=null,this.isLoading=!1,this.isLoaded=!1,this.loadPromise=null,"undefined"!=typeof window&&delete window.__firebaseSDK}}const mi=di.getInstance(),pi=S("GoogleAnalytics");class hi{static instance;isInitialized=!1;analytics=null;measurementId="";constructor(){}static getInstance(){return hi.instance||(hi.instance=new hi),hi.instance}async initialize(){const e=ni.getGoogleConfig();if(e.enabled)if(e.measurementId)if(this.isInitialized)pi("[GoogleAnalytics] Already initialized");else{this.measurementId=e.measurementId;try{if(await this.initializeWithFirebase())return this.isInitialized=!0,void(e.debug&&pi("[GoogleAnalytics] Initialized with Firebase Analytics"));if(await this.initializeWithGtag())return this.isInitialized=!0,void(e.debug&&pi("[GoogleAnalytics] Initialized with gtag.js"));throw new Error("Failed to initialize with any method")}catch(t){pi.extend("error")("[GoogleAnalytics] Initialization failed:",t)}}else pi.extend("warn")("[GoogleAnalytics] Measurement ID not provided");else pi("[GoogleAnalytics] Disabled by configuration")}async initializeWithFirebase(){try{return pi("[GoogleAnalytics] Initializing with Firebase Analytics Loader..."),await mi.initialize()?(this.analytics={},pi("[GoogleAnalytics] Firebase Analytics initialized via dynamic loader"),!0):(pi.extend("warn")("[GoogleAnalytics] Firebase Analytics initialization failed"),!1)}catch(e){return pi.extend("warn")("[GoogleAnalytics] Firebase initialization failed:",e),!1}}async initializeWithGtag(){try{window.dataLayer=window.dataLayer||[],window.gtag=function(){window.dataLayer.push(arguments)},window.gtag("js",new Date),window.gtag("config",this.measurementId,{debug_mode:ni.getGoogleConfig().debug});const e=document.createElement("script");return e.async=!0,e.src=`https://www.googletagmanager.com/gtag/js?id=${this.measurementId}`,new Promise(t=>{e.onload=()=>t(!0),e.onerror=()=>t(!1),document.head.appendChild(e)})}catch(e){return pi.extend("warn")("[GoogleAnalytics] gtag.js initialization failed:",e),!1}}trackPageView(e){if(!this.isReady())return;const t=ni.getGoogleConfig(),a={page_title:e?.page_title||document.title,page_location:e?.page_location||window.location.href,page_path:e?.page_path||window.location.pathname,...e};try{this.analytics?import("firebase/analytics").then(({logEvent:e})=>{e(this.analytics,"page_view",a)}).catch(e=>{pi.extend("warn")("[GoogleAnalytics] Firebase analytics import failed:",e)}):window.gtag&&window.gtag("event","page_view",a),t.debug&&pi("[GoogleAnalytics] Page view tracked:",a)}catch(i){pi.extend("error")("[GoogleAnalytics] Page view tracking failed:",i)}}trackEvent(e){if(!this.isReady())return;const t=ni.getGoogleConfig(),{action:a,category:i,label:r,value:n,custom_parameters:o}=e;if(!a)return void pi.extend("warn")("[GoogleAnalytics] Event action is required");const s={event_category:i||"engagement",event_label:r,value:n,...o};Object.keys(s).forEach(e=>{void 0===s[e]&&delete s[e]});try{this.analytics?mi.logEvent(a,s).catch(e=>{pi.extend("warn")("[GoogleAnalytics] Firebase analytics event failed:",e)}):window.gtag&&window.gtag("event",a,s),t.debug&&pi("[GoogleAnalytics] Event tracked:",{action:a,...s})}catch(l){pi.extend("error")("[GoogleAnalytics] Event tracking failed:",l)}}trackSkillClick(e,t){this.trackEvent({action:"skill_click",category:"user_interaction",label:e,custom_parameters:{skill_category:t,interaction_type:"click"}})}trackProjectView(e,t){this.trackEvent({action:"project_view",category:"content",label:e,custom_parameters:{project_type:t,content_type:"project"}})}trackContactClick(e,t){this.trackEvent({action:"contact_click",category:"user_interaction",label:e,custom_parameters:{contact_method:e,contact_value:t}})}trackLanguageSwitch(e,t){this.trackEvent({action:"language_change",category:"user_preference",label:`${e}_to_${t}`,custom_parameters:{previous_language:e,new_language:t}})}trackThemeSwitch(e,t){this.trackEvent({action:"theme_change",category:"user_preference",label:`${e}_to_${t}`,custom_parameters:{previous_theme:e,new_theme:t}})}trackDownload(e,t){this.trackEvent({action:"file_download",category:"engagement",label:t||e,custom_parameters:{file_type:e,file_name:t}})}trackError(e,t,a=!1){this.trackEvent({action:"exception",category:"error",label:e,custom_parameters:{description:t,fatal:a}})}setUserProperty(e,t){if(!this.isReady())return;const a=ni.getGoogleConfig();try{this.analytics?mi.setUserProperties({[e]:t}).catch(e=>{pi.extend("warn")("[GoogleAnalytics] Firebase analytics user property failed:",e)}):window.gtag&&window.gtag("config",this.measurementId,{user_properties:{[e]:t}}),a.debug&&pi("[GoogleAnalytics] User property set:",{propertyName:e,propertyValue:t})}catch(i){pi.extend("error")("[GoogleAnalytics] Set user property failed:",i)}}isReady(){const e=ni.getGoogleConfig();return this.isInitialized&&e.enabled?!(!this.analytics&&!window.gtag&&(pi.extend("warn")("[GoogleAnalytics] No analytics instance available"),1)):(e.debug&&pi("[GoogleAnalytics] Not ready:",{initialized:this.isInitialized,enabled:e.enabled}),!1)}getStatus(){const e=ni.getGoogleConfig();let t="none";this.analytics?t="firebase":window.gtag&&(t="gtag");const a={initialized:this.isInitialized,enabled:e.enabled,measurementId:this.measurementId.substring(0,8)+"...",method:t};return"firebase"===t&&(a.firebaseLoader=mi.getStatus()),a}}const ui=hi.getInstance(),gi=S("elk");class fi{static instance;eventQueue=[];flushTimer=null;sessionId;constructor(){this.sessionId=this.generateSessionId(),this.setupAutoFlush(),this.setupPageUnloadHandler()}static getInstance(){return fi.instance||(fi.instance=new fi),fi.instance}generateSessionId(){return Date.now().toString(36)+Math.random().toString(36).substr(2)}setupAutoFlush(){const e=ni.getELKConfig();e.enabled&&(this.flushTimer=setInterval(()=>{this.flushEvents()},e.flushInterval||5e3))}setupPageUnloadHandler(){window.addEventListener("beforeunload",()=>{this.flushEvents(!0)})}createBaseEvent(e,t){return{timestamp:(new Date).toISOString(),event_type:e,page:window.location.pathname,source:"flexiresume",user_agent:navigator.userAgent,referrer:document.referrer,data:{session_id:this.sessionId,...t}}}addEvent(e){const t=ni.getELKConfig();t.enabled?(this.eventQueue.push(e),this.eventQueue.length>=(t.batchSize||10)&&this.flushEvents(),t.debug&&gi("Event added to queue: %O",e)):t.debug&&gi("Disabled, event not added: %O",e)}async flushEvents(e=!1){const t=ni.getELKConfig();if(!t.enabled||0===this.eventQueue.length)return;const a=[...this.eventQueue];this.eventQueue=[];try{const i={events:a,source:"flexiresume",timestamp:(new Date).toISOString()};if(e&&navigator.sendBeacon)navigator.sendBeacon(t.endpoint,JSON.stringify(i));else{const e=await fetch(t.endpoint,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});e.ok?t.debug&&gi("Events sent successfully: %d",a.length):(gi("Failed to send events: %s",e.statusText),a.length<(t.batchSize||10)&&this.eventQueue.unshift(...a))}}catch(i){gi("Error sending events: %O",i),a.length<(t.batchSize||10)&&this.eventQueue.unshift(...a)}}trackPageView(e,t){const a=this.createBaseEvent("page_view",{title:e||document.title,url:t||window.location.href,timestamp:Date.now()});this.addEvent(a)}trackUserInteraction(e,t,a,i){const r=this.createBaseEvent("user_interaction",{action:e,element:t,element_text:a,value:i,timestamp:Date.now()});this.addEvent(r)}trackPerformance(e,t,a,i){const r=this.createBaseEvent("performance",{metric_name:e,metric_value:t,metric_unit:a,additional_data:i,timestamp:Date.now()});this.addEvent(r)}trackError(e,t,a,i,r="medium"){const n=this.createBaseEvent("error",{error_type:e,error_message:t,error_stack:a,component:i,severity:r,timestamp:Date.now()});this.addEvent(n)}trackSkillClick(e,t){this.trackUserInteraction("skill_click","skill_tag",e,t)}trackProjectView(e,t){this.trackUserInteraction("project_view","project_card",e,t)}trackContactClick(e,t){this.trackUserInteraction("contact_click","contact_info",e,t)}trackLanguageSwitch(e,t){this.trackUserInteraction("language_switch","language_toggle",`${e}_to_${t}`)}trackThemeSwitch(e,t){this.trackUserInteraction("theme_switch","theme_toggle",`${e}_to_${t}`)}trackDownload(e,t){this.trackUserInteraction("download","download_button",e,t)}getStatus(){const e=ni.getELKConfig();return{enabled:e.enabled,sessionId:this.sessionId,queueSize:this.eventQueue.length,endpoint:e.endpoint}}setEnabled(e){ni.setELKEnabled(e),e?this.setupAutoFlush():(this.flushTimer&&(clearInterval(this.flushTimer),this.flushTimer=null),this.eventQueue=[])}}const bi=fi.getInstance();function xi(e){const{labelFormat:t}=function(){const e=R();return{labelFormat:e.tabs.labelFormat,labelSeparator:e.tabs.labelSeparator}}();return function(e,t){if(!t)return t?.position||"";let a=e;return Object.keys(t).forEach(e=>{const i=t[e];if(null!=i){const t=`{${e}}`;a=a.replace(new RegExp(t.replace(/[{}]/g,"\\$&"),"g"),String(i))}}),a=a.replace(/\{[^}]*\}/g,""),a=a.replace(/\s*\/\s*$/,"").replace(/^\s*\/\s*/,"").trim(),a||t.position||""}(t,e)}"undefined"!=typeof window&&(window.addEventListener("load",()=>{const e=performance.getEntriesByType("navigation")[0];e&&(bi.trackPerformance("page_load_time",e.loadEventEnd-e.loadEventStart,"ms"),bi.trackPerformance("dom_content_loaded",e.domContentLoadedEventEnd-e.domContentLoadedEventStart,"ms"),bi.trackPerformance("first_contentful_paint",performance.getEntriesByType("paint")[1]?.startTime||0,"ms"))}),window.addEventListener("error",e=>{bi.trackError("javascript_error",e.message,e.error?.stack,void 0,"high")}),window.addEventListener("unhandledrejection",e=>{bi.trackError("unhandled_promise_rejection",e.reason?.message||"Unhandled promise rejection",e.reason?.stack,void 0,"high")}));const yi=S("FontPerformanceMonitorLazy"),wi=i.lazy(()=>o(()=>import("./FontPerformanceMonitor-BwSA1Ldz.js"),__vite__mapDeps([7,8,2,1,3,9,10]),import.meta.url).then(e=>({default:e.FontPerformanceMonitor}))),vi=({visible:t,position:a="bottom-right",enableHotkey:r=!0,hotkey:n="ctrl+shift+f"})=>{const[o,s]=i.useState(!1),[l,c]=i.useState(t??!1);return i.useEffect(()=>{yi("🚫 生产环境，跳过FontPerformanceMonitor加载")},[]),i.useEffect(()=>{},[r,n]),o&&l?e.jsx(i.Suspense,{fallback:e.jsx("div",{"data-testid":"font-performance-monitor",className:"font-performance-monitor",style:{position:"fixed",bottom:"20px",right:"20px",backgroundColor:"rgba(0, 0, 0, 0.6)",color:"white",padding:"8px 12px",borderRadius:"6px",fontSize:"12px",fontFamily:"monospace",zIndex:9999,opacity:.7,"@media print":{display:"none"}},children:"🎨 加载中..."}),children:e.jsx(wi,{visible:l,position:a})}):null},ki=S("ImageErrorHandler"),Ci=new class{retryMap=new Map;isInitialized=!1;maxRetries=3;initialize(){if(this.isInitialized)return;this.setupGlobalErrorHandler(),this.setupMutationObserver(),this.isInitialized=!0;const e=ht(pt());ki(e.common.imageErrorHandlerInitialized)}setupGlobalErrorHandler(){document.addEventListener("error",this.handleImageError.bind(this),!0),this.processExistingImages()}setupMutationObserver(){new MutationObserver(e=>{e.forEach(e=>{e.addedNodes.forEach(e=>{if(e.nodeType===Node.ELEMENT_NODE){const t=e;"IMG"===t.tagName&&this.setupImageErrorHandling(t),t.querySelectorAll("img").forEach(e=>{this.setupImageErrorHandling(e)})}})})}).observe(document.body,{childList:!0,subtree:!0})}processExistingImages(){document.querySelectorAll("img").forEach(e=>{this.setupImageErrorHandling(e)})}setupImageErrorHandling(e){this.retryMap.has(e)||e.closest(".smart-image-loading, .smart-image-error")||e.src.startsWith("data:")||e.src.startsWith("blob:")||this.retryMap.set(e,{element:e,originalSrc:e.src,retryCount:0,cdnIndex:0,maxRetries:this.maxRetries})}handleImageError(e){const t=e.target;if("IMG"!==t.tagName)return;const a=this.retryMap.get(t);if(!a)return;const i=ht(pt());ki.extend("warn")(`${i.common.imageLoadFailed}: ${t.src}`),this.tryNextCDN(a)}tryNextCDN(e){const{element:t,originalSrc:a,retryCount:i,cdnIndex:r}=e,n=O();if(n.enabled&&0!==n.baseUrls.length)if(r<n.baseUrls.length-1){const i=r+1,o=this.buildCDNUrl(n.baseUrls[i],a);e.cdnIndex=i,t.src=o,ki(`尝试CDN ${i+1}/${n.baseUrls.length}: ${o}`)}else if(i<e.maxRetries){const r=i+1;e.retryCount=r,e.cdnIndex=0,setTimeout(()=>{const i=this.buildCDNUrl(n.baseUrls[0],a);t.src=i,ki(`重试 ${r}/${e.maxRetries}: ${i}`)},1e3*r)}else this.tryLocalFallback(e);else this.handleFinalFailure(e)}tryLocalFallback(e){const{element:t,originalSrc:a}=e;try{const e=Y.getResourceUrl(a,{enableFallback:!0,cacheUrls:!1});if(e!==t.src)return t.src=e,void ki(`尝试本地回退: ${e}`)}catch(i){ki.extend("error")("本地回退失败:",i)}this.handleFinalFailure(e)}handleFinalFailure(e){const{element:t,originalSrc:a}=e,i=ht(pt());ki.extend("error")(i.common.imageFinalLoadFailed+`: ${a}`);const r=document.createElement("div");r.className="image-error-placeholder",r.style.cssText="\n      display: inline-flex;\n      align-items: center;\n      justify-content: center;\n      min-height: 100px;\n      min-width: 150px;\n      background-color: #f5f5f5;\n      color: #999;\n      font-size: 14px;\n      border: 1px dashed #ddd;\n      border-radius: 4px;\n    ",r.textContent=i.common.imageLoadFailed,t.style.width&&(r.style.width=t.style.width),t.style.height&&(r.style.height=t.style.height),t.className&&(r.className+=` ${t.className}`),t.parentNode?.replaceChild(r,t),this.retryMap.delete(t)}buildCDNUrl(e,t){let a=t;try{const e=new URL(t);a=e.pathname}catch{}O().baseUrls.forEach(e=>{a.startsWith(e)&&(a=a.substring(e.length));const t=e.endsWith("/")?e:e+"/";a.startsWith(t)&&(a=a.substring(t.length))});const i=e.endsWith("/")?e.slice(0,-1):e;return a=a.startsWith("/")?a.slice(1):a,`${i}/${a}`}destroy(){if(!this.isInitialized)return;document.removeEventListener("error",this.handleImageError.bind(this),!0),this.retryMap.clear(),this.isInitialized=!1;const e=ht(pt());ki(e.common.imageErrorHandlerDestroyed)}setMaxRetries(e){this.maxRetries=Math.max(0,e)}getRetryStats(){const e=this.retryMap.size;let t=0,a=0;return this.retryMap.forEach(e=>{e.retryCount>=e.maxRetries?t++:a++}),{total:e,failed:t,retrying:a}}};"undefined"!=typeof window&&("loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{Ci.initialize()}):Ci.initialize());const Si=S("main"),Di=i.lazy(()=>o(()=>import("./FlexiResume-D2gcFWA6.js"),__vite__mapDeps([11,8,2,9,1,3,10,5,12]),import.meta.url)),Fi=()=>{const[t,a]=i.useState(null),[r,n]=i.useState([]),[o,s]=i.useState([]),[l,c]=i.useState("/"),[d,m]=i.useState(!0),[p,h]=i.useState("checking"),u=async()=>{try{h("checking");const e=R(),t=[];e.cdn.enabled&&e.cdn.healthCheck.enabled&&(Si("Initializing CDN health check..."),t.push(Y.initialize())),Si("Starting library preloading..."),t.push(ti.startPreloading()),await Promise.allSettled(t),e.performance.enablePreloading&&e.performance.preloadResources.length>0&&Y.preloadResources(e.performance.preloadResources).catch(e=>{Si("Resource preloading failed: %O",e)}),Ci.initialize(),Si("Image error handler initialized"),h("ready")}catch(e){Si("CDN initialization failed: %O",e),h("error")}},g=async()=>{try{m(!0);const e=await z();a(e),await(async()=>{try{re=await z()}catch(e){ae("Failed to update data cache: %O",e)}})();const t=(e=>Object.keys(e.expected_positions).filter(t=>!e.expected_positions[t].hidden).map(t=>{const a=e.expected_positions[t],i=a.header_info;return[xi({name:i?.name,position:i?.position}),"/"+t,!!a.is_home_page,i?.avatar]}))(e),i=(e=>Object.keys(e.expected_positions).map(t=>({key:t,title:e.expected_positions[t].header_info?.position||t,path:"/"+t,isHomePage:!!e.expected_positions[t].is_home_page,hidden:!!e.expected_positions[t].hidden})))(e);n(t),s(i),c((e=>e.find(([,,e])=>e)?.[1]||e[0][1]||"/")(t)),C.tabs=t}catch(e){Si("Failed to load language data: %O",e)}finally{m(!1)}},w=async()=>{try{Si("Initializing analytics..."),await li.initialize(),await ui.initialize();const e=li.getStatus(),t=ui.getStatus(),a=bi.getStatus();Si("Analytics status: %O",{baidu:e,google:t,elk:a,config:ni.getConfigSummary()}),bi.trackPageView("App Initialized",window.location.href)}catch(e){Si("Analytics initialization failed: %O",e)}};return i.useEffect(()=>{var e;return(async()=>{await Promise.all([u(),g(),w()])})(),e=()=>{g()},E.push(e),()=>{const t=E.indexOf(e);t>-1&&E.splice(t,1)}},[]),function(){const e=()=>{document.querySelectorAll(".lazy-video").forEach(e=>{const t=e.getBoundingClientRect();t.top<window.innerHeight+200&&t.bottom>0&&(e=>{const t=JSON.parse(e.dataset.sources),a=O().baseUrls.slice(0,3);let i="";a.forEach((e,a)=>{const r=t.original.startsWith("/")?`${e.endsWith("/")?e.slice(0,-1):e}${t.original}`:`${e.endsWith("/")?e:e+"/"}${t.original}`;i+=`<source src="${r}" type="video/mp4">\n        `});let r=t.original;try{r=Y.getResourceUrl(t.original,{enableFallback:!0,localBasePath:"",cacheUrls:!1})}catch(o){ie("Failed to build local fallback URL: %O",o)}i+=`<source src="${t.original}" type="video/mp4">`,e.innerHTML=i,e.classList.remove("lazy-video"),e.removeAttribute("data-sources");const n=e.parentNode.querySelector(".loading-indicator");n?.remove()})(e)})};let t;window.addEventListener("scroll",()=>{t&&clearTimeout(t),t=setTimeout(e,100)}),window.addEventListener("resize",e),window.addEventListener("mouseup",()=>setTimeout(e,0)),e()}(),d||!t?e.jsx(Ie,{children:e.jsx(dt,{children:e.jsxs(jt,{level:"page",maxRetries:3,children:[e.jsx(Ce,{}),e.jsx(Ja,{collapsible:!0}),e.jsxs("div",{style:{position:"fixed",top:"20px",right:"20px",background:"rgba(0,0,0,0.8)",color:"white",padding:"8px 12px",borderRadius:"4px",fontSize:"12px",zIndex:9999},children:["checking"===p&&"🔄 检测CDN...","ready"===p&&"✅ CDN就绪","error"===p&&"⚠️ CDN检测失败"]}),e.jsx(At,{})]})})}):e.jsx(Ie,{children:e.jsx(Qt,{children:e.jsx(dt,{children:e.jsx(jt,{level:"page",maxRetries:3,children:e.jsxs(st,{children:[e.jsx(Ce,{}),e.jsx(Ja,{collapsible:!0}),e.jsxs(f,{basename:t.header_info.route_base_name,children:[e.jsx(et,{})," ",e.jsxs(b,{children:[o.map((t,a)=>e.jsx(x,{path:t.path,element:e.jsx(jt,{level:"section",maxRetries:2,children:e.jsx(i.Suspense,{fallback:e.jsx(At,{}),children:e.jsx(Di,{path:t.path})})})},a)),o.map((t,a)=>{const i=t.path+".html";return e.jsx(x,{path:i,element:e.jsx(y,{to:t.path,replace:!0})},`html-${a}`)}),e.jsx(x,{path:"/",element:e.jsx(y,{to:l})}),e.jsx(x,{path:"*",element:e.jsx(y,{to:l})})]})]}),e.jsx(qa,{}),e.jsx(vi,{position:"bottom-left",enableHotkey:!0})]})})})})})};v(document.getElementById("root")).render(e.jsx(i.StrictMode,{children:e.jsx(Fi,{})}));export{dt as I,At as S,C as a,Et as b,mt as c,q as d,pe as e,Zt as f,S as g,ti as h,v as i,ue as j,he as k,se as l,te as m,Fe as n,Ee as o,Ke as p,ce as q,ge as r,je as s,Pe as t,ze as u,me as w};
