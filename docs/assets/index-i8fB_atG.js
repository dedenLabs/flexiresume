...
`,N={light:{primary:"#3498db",secondary:"#2c3e50",accent:"#e74c3c",background:"#ffffff",surface:"#f8f9fa",card:"#ffffff",text:{primary:"#2c3e50",secondary:"#7f8c8d",disabled:"#bdc3c7",inverse:"#ffffff"},border:{light:"#ecf0f1",medium:"#bdc3c7",dark:"#95a5a6"},status:{success:"#27ae60",warning:"#f39c12",error:"#e74c3c",info:"#3498db"},shadow:{light:"rgba(0, 0, 0, 0.05)",medium:"rgba(0, 0, 0, 0.1)",dark:"rgba(0, 0, 0, 0.2)"}},dark:{primary:"#4a9eff",secondary:"#e2e8f0",accent:"#ff6b6b",background:"#0f1419",surface:"#1a202c",card:"#2d3748",text:{primary:"#e2e8f0",secondary:"#a0aec0",disabled:"#718096",inverse:"#1a202c"},border:{light:"#2d3748",medium:"#4a5568",dark:"#718096"},status:{success:"#48bb78",warning:"#ed8936",error:"#f56565",info:"#4299e1"},shadow:{light:"rgba(0, 0, 0, 0.1)",medium:"rgba(0, 0, 0, 0.25)",dark:"rgba(0, 0, 0, 0.4)"}}},I=d.createContext(void 0),O=({children:e})=>{const[r,t]=d.useState(()=>{const e=localStorage.getItem("theme");return!e||"light"!==e&&"dark"!==e?window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e});d.useEffect(()=>{localStorage.setItem("theme",r),document.documentElement.setAttribute("data-theme",r);const e=document.querySelector('meta[name="theme-color"]');e&&e.setAttribute("content",N[r].background)},[r]),d.useEffect(()=>{const e=window.matchMedia("(prefers-color-scheme: dark)"),r=e=>{localStorage.getItem("theme")||t(e.matches?"dark":"light")};return e.addEventListener("change",r),()=>e.removeEventListener("change",r)},[]);const o={mode:r,setMode:t,toggleMode:()=>{t(e=>"light"===e?"dark":"light")},colors:N[r],isDark:"dark"===r};return a.jsx(I.Provider,{value:o,children:e})},R=()=>{const e=d.useContext(I);if(!e)throw new Error("useTheme must be used within a ThemeProvider");return e},W="#aaa",F="920px",H=s.nav`
  /* 移动端样式 - 修复横向溢出问题 */
...
`,V=s(m)`
  ...
  border-radius: 8px 8px 0 0;
  border-top: 1px solid ${e=>e.isDark?"var(--color-border-medium)":W};
  border-right: 1px solid ${e=>e.isDark?"var(--color-border-medium)":W};
  border-bottom: 0px solid ${e=>e.isDark?"var(--color-border-medium)":W};
  border-left: 1px solid ${e=>e.isDark?"var(--color-border-medium)":W};
  transition: background-color 0.3s, border 0.3s, color 0.3s;
  box-shadow: 0 0 15px ${e=>e.isDark?"var(--color-shadow-medium)":"rgba(0, 0, 0, 0.1)"};
  ...
  &:hover, &.active {
    ...
    border-top: 2px solid ${e=>e.isDark?"var(--color-primary)":"#333"}; /* 激活状态显示右侧边框 */
  ...
  @media (min-width: ${F}) {
    ...
    border-top: 1px solid ${e=>e.isDark?"var(--color-border-medium)":W};
    border-right: 1px solid ${e=>e.isDark?"var(--color-border-medium)":W};
    border-bottom: 1px solid ${e=>e.isDark?"var(--color-border-medium)":W};
    border-left: 0px solid ${e=>e.isDark?"var(--color-border-medium)":W};
...
`,B=()=>{var e;const r=j.data,t=j.tabs,{isDark:o}=R();if(!t.length)return document.title=(null==(e=null==r?void 0:r.header_info)?void 0:e.position)||"My Resume",null;const s=p();return d.useEffect(()=>{var e;const t=function(e){var r;const t=j.data,o=j.tabs,a=e.pathname,s=o.find(([,e])=>e===a);return s?s[0]:(null==(r=null==t?void 0:t.header_info)?void 0:r.position)||""}(s),o=(a=(null==(e=null==r?void 0:r.header_info)?void 0:e.resume_name_format)||"{position}-{name}-{age}-{location}",i=Object.assign({},r.header_info,{position:t}),a.replace(/{(position|name|age|location)}/g,(e,r)=>i[r]||""));var a,i;document.title=o},[s]),a.jsx(H,{isDark:o,children:t.map(([e,r],t)=>a.jsx(V,{className:"no-link-icon",to:r,isDark:o,children:e},r))})};function U(e){return k({attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0z"},child:[]},{tag:"path",attr:{d:"M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"},child:[]}]})(e)}const G=s.div`
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
...
`,K=s.div`
  ...
  cursor: pointer;
  z-index: 1100;  
`,q=({imageUrl:e,onClose:r})=>a.jsxs(G,{onClick:r,children:[a.jsx(J,{src:e,onClick:e=>e.stopPropagation()}),a.jsx(K,{onClick:r,children:a.jsx(U,{size:30,color:"white"})})]}),Q=d.createContext(void 0),Y=({children:e})=>{const[r,t]=d.useState(!1),[o,s]=d.useState(""),n=e=>{s(e),t(!0)};return window.$handleImageClick=n,a.jsxs(Q.Provider,{value:{handleImageClick:n},children:[e,r&&a.jsx(i.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:a.jsx(q,{imageUrl:o,onClose:()=>{t(!1)}})})]})},X=s.div`
  max-width: 800px;
  padding: 40px 20px;
  background: #fff;
  border-radius: 8px;
...
`;class oe extends d.Component{constructor(e){super(e),t(this,"handleRetry",()=>{this.setState({hasError:!1,error:void 0,errorInfo:void 0})}),this.state={hasError:!1}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,r){this.setState({error:e,errorInfo:r})}render(){return this.state.hasError?this.props.fallback?this.props.fallback:a.jsxs(X,{children:[a.jsx(Z,{children:"⚠️"}),a.jsx(ee,{children:"页面加载出错了"}),a.jsxs(re,{children:["抱歉，页面遇到了一些问题。请尝试刷新页面或稍后再试。",a.jsx("br",{}),"如果问题持续存在，请联系技术支持。"]}),a.jsx(te,{onClick:this.handleRetry,children:"重新加载"}),!1]}):this.props.children}}const ae=n`
  0% {
...
`,se=s.div`
  ...
  animation: ${ae} 1.5s infinite linear;
  border-radius: 4px;
`,ie=s(se)`
...
`,ye=s.span`
  ...
  font-weight: bold;
  margin-left: auto;
`,we=[{code:"zh",name:"Chinese",icon:"🇨🇳",nativeName:"中文"},{code:"en",name:"English",icon:"🇺🇸",nativeName:"English"}],je=({className:e})=>{const{language:r,setLanguage:t,t:o}=ue(),{isDark:s}=R(),[i,n]=c.useState(!1),d=we.find(e=>e.code===r),l=c.useCallback(e=>{e.target.closest("[data-language-switcher]")||n(!1)},[]);return c.useEffect(()=>{if(i)return document.addEventListener("click",l),()=>document.removeEventListener("click",l)},[i,l]),a.jsxs(ge,{className:e,"data-language-switcher":!0,children:[a.jsxs(fe,{isDark:s,onClick:()=>n(!i),title:o.common.switchLanguage,"aria-label":o.common.switchLanguage,children:[a.jsx(be,{children:null==d?void 0:d.icon}),a.jsx(xe,{children:null==d?void 0:d.nativeName}),a.jsx("span",{style:{transform:i?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.3s ease",fontSize:"12px"},children:"▼"})]}),a.jsx(ve,{isOpen:i,isDark:s,children:we.map(e=>a.jsxs(ke,{isActive:r===e.code,isDark:s,onClick:()=>{return r=e.code,t(r),void n(!1);var r},children:[a.jsx("span",{children:e.icon}),a.jsx("span",{children:e.nativeName}),a.jsx(ye,{visible:r===e.code,isDark:s,children:"✓"})]},e.code))})]})},De=s.div`
  position: relative;
  display: inline-block;
`,Se=s.button`
  display: flex;
...
`,$e=s.div`
  ...
  ${e=>e.isActive&&"\n    width: 100px;\n    height: 100px;\n  "}
`,Le=({className:e,showTooltip:r=!0})=>{const{mode:t,toggleMode:o,isDark:s}=R(),{t:i}=ue(),[n,d]=c.useState(!1),[l,p]=c.useState(!1),m=s?i.common.lightMode:i.common.darkMode;return a.jsxs(De,{className:e,onMouseEnter:()=>d(!0),onMouseLeave:()=>d(!1),children:[a.jsxs(Se,{isDark:s,onClick:()=>{p(!0),setTimeout(()=>p(!1),600),o()},title:m,"aria-label":m,children:[a.jsx($e,{isActive:l}),a.jsx(Ce,{isVisible:!s,children:a.jsx(_e,{})}),a.jsx(Ce,{isVisible:s,children:a.jsx(Ee,{})})]}),r&&a.jsx(Pe,{isDark:s,isVisible:n,children:m})]})},ze=s.div`
  position: fixed;
  top: 20px;
  right: 20px;
  display: flex;
