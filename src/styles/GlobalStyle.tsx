...
import { replaceCDNBaseURLSync } from '../utils/Tools';
...
const bg = replaceCDNBaseURLSync('images/flexi-resume.jpg');
  ...
  * {
  ...
  a:not(.no-link-icon) {
    ...
    &::before {
      ...
      background: url(${replaceCDNBaseURLSync("images/url.svg")}) no-repeat center;
